...
function refreshStaleBootstrapSessionTokens(mergedEnv, options = {}) {
  if (
    isLocalBootstrapAccessTokenCompliant(mergedEnv.SDKWORK_ACCESS_TOKEN)
    && isLocalBootstrapAuthTokenCompliant(mergedEnv.SDKWORK_AUTH_TOKEN)
  ) {
    return mergedEnv;
  }
  return {
    ...mergedEnv,
    ...buildClawRouterBootstrapSessionTokenEnv(options),
  };
}
...
export function buildClawRouterBootstrapSessionTokenEnv({
  ...
  return {
    SDKWORK_AUTH_TOKEN: signLocalAppSessionAuthToken(tokenParams),
