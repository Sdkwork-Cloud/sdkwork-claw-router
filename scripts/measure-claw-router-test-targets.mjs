...
const DEFAULT_TARGETS = Object.freeze([
  ...
  ['sdkwork-claw-gateway', 'provider_adapter_invocation'],
  ['sdkwork-claw-product', 'openai_compatible_http_relay'],
  ['sdkwork-claw-product', 'openai_compatible_chat_stream_http_relay'],
  ['sdkwork-claw-product', 'openai_compatible_embeddings_http_relay'],
  ['sdkwork-claw-product', 'openai_compatible_responses_http_relay'],
  ['sdkwork-claw-product', 'openai_chat_adapter_api'],
  ['sdkwork-claw-product', 'openai_embeddings_adapter_api'],
  ['sdkwork-claw-product', 'openai_responses_adapter_api'],
  ['sdkwork-claw-product', 'sqlite_pricing_catalog_loader'],
