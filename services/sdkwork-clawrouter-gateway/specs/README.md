# SDKWork Claw Gateway Component Specs

This directory is the local standards index for `sdkwork-clawrouter-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/services/sdkwork-clawrouter-gateway` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/services/sdkwork-clawrouter-gateway/Cargo.toml`
