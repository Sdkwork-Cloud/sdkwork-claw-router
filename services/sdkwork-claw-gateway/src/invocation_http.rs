...
fn classify_request(
    ...
    (
        sdkwork_claw_product::application::InvocationClassification,
        String,
    ),
    InvocationError,
> {
...
fn normalized_response_to_http(
    normalized: sdkwork_claw_product::application::InvocationNormalizedResponse,
) -> Response {
    let sdkwork_claw_product::application::InvocationNormalizedResponse {
        status_code,
        body,
        body_bytes,
        content_type,
