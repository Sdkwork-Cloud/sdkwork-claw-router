# SDKWork Claw Installer Component Specs

This directory is the local standards index for `sdkwork-claw-installer`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-installer` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/services/sdkwork-claw-installer` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/services/sdkwork-claw-installer/Cargo.toml`
