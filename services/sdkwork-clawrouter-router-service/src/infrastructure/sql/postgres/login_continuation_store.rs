...
#[derive(Clone)]
pub struct PostgresLoginContinuationStore {
    pool: PgPool,
}

impl PostgresLoginContinuationStore {
...
impl LoginContinuationStore for PostgresLoginContinuationStore {
    ...
    fn take_login_continuation<'a>(
        ...
        Box::pin(async move {
            ...
            sqlx::query("DELETE FROM iam_login_continuation WHERE token_hash = $1")
                .bind(token_hash)
                .execute(&self.pool)
                .await
