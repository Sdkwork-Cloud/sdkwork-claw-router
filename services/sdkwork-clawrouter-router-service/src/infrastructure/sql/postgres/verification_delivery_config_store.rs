...
#[derive(Debug, Clone)]
pub struct PostgresVerificationDeliveryConfigStore {
    pool: PgPool,
}

impl PostgresVerificationDeliveryConfigStore {
    pub fn new(pool: PgPool) -> Self {
        Self { pool }
    }
}

impl VerificationDeliveryConfigStore for PostgresVerificationDeliveryConfigStore {
