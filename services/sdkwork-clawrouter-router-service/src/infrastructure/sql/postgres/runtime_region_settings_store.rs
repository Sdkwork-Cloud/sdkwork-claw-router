...
async fn resolve_runtime_region_scope(
    ...
    .map_err(|error| store_error("failed to load runtime region IAM tenant", error))?;
    ...
    .map_err(|error| store_error("failed to load runtime region IAM organization", error))?;
...
async fn insert_audit_log(
    ...
    sqlx::query(
        ...
        VALUES
            ($1, $2, $3, 'update_runtime_region_settings', $4, 0, $5, $6, $7, $8::jsonb)
        "#,
    )
