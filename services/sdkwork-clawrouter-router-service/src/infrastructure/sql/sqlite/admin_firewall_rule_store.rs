...
#[derive(Debug, Clone)]
pub struct SqliteAdminFirewallRuleStore {
    pool: SqlitePool,
}

impl SqliteAdminFirewallRuleStore {
    pub fn new(pool: SqlitePool) -> Self {
        Self { pool }
    }
}

impl AdminFirewallRuleStore for SqliteAdminFirewallRuleStore {
...
fn item_from_row(row: sqlx::sqlite::SqliteRow) -> DomainResult<AdminFirewallRuleItem> {
