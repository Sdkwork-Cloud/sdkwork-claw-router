...
use sdkwork_clawrouter_router_service_test_support::{repair_sqlite_pool, schema_sqlite_pool};
...
use sdkwork_clawrouter_router_service::infrastructure::sql::sqlite::SqliteForumStore;
...
async fn router_with_public_forum_fixture_and_links(
    community_links: Vec<sdkwork_clawrouter_router_service::ports::ForumCommunityLink>,
) -> (axum::Router, i64, i64, ExpectedForumOverviewStats) {
