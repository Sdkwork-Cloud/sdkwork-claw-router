...
SELECT
    ...
    COALESCE(vr.point_amount, o.paid_points_amount, 0) AS points,
...
#[derive(Debug, Clone)]
pub struct SqliteCheckoutStore {
    pool: SqlitePool,
}

impl SqliteCheckoutStore {
    pub fn new(pool: SqlitePool) -> Self {
        Self { pool }
    }
}

impl CheckoutStore for SqliteCheckoutStore {
