...
async fn load_history(
    ...
    search: Option<&str>,
    limit: i64,
) -> Result<Vec<crate::ports::ModelRankingHistoryPoint>, DomainError> {
...
async fn load_source_metadata(
    ...
    Option<crate::infrastructure::sql::sql_model_rankings::RankingSnapshotMetadata>,
    DomainError,
> {
...
async fn load_latest_refresh_job(
    ...
    subject: ModelRankingsSubject,
    rank_scope: &str,
) -> Result<Option<crate::ports::ModelRankingRefreshJobItem>, DomainError> {
...
) -> crate::infrastructure::sql::sql_model_rankings::RankingSnapshotMetadata {
    metadata_from_json(
...
fn refresh_job_item_from_row(
    row: &sqlx::sqlite::SqliteRow,
) -> crate::ports::ModelRankingRefreshJobItem {
