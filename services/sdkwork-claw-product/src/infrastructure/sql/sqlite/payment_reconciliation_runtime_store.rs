...
#[derive(Debug, Clone)]
pub struct SqlitePaymentReconciliationRuntimeStore {
    pool: SqlitePool,
}

impl SqlitePaymentReconciliationRuntimeStore {
    pub fn new(pool: SqlitePool) -> Self {
        Self { pool }
    }
}

impl PaymentReconciliationRuntimeStore for SqlitePaymentReconciliationRuntimeStore {
...
fn statement_from_row(row: &sqlx::sqlite::SqliteRow) -> DomainResult<PaymentStatementRecord> {
