...
impl SqliteDashboardOverviewReadStore {
    pub fn new(pool: SqlitePool) -> Self {
        Self { pool }
    }
}

impl DashboardOverviewReadStore for SqliteDashboardOverviewReadStore {
...
fn chart_period_length(keyword: Option<&str>) -> i64 {
