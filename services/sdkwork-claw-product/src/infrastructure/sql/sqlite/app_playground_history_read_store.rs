...
#[derive(Debug, Clone)]
pub struct SqliteAppPlaygroundHistoryReadStore {
    pool: SqlitePool,
}

impl SqliteAppPlaygroundHistoryReadStore {
    pub fn new(pool: SqlitePool) -> Self {
        Self { pool }
    }
}

impl AppPlaygroundHistoryReadStore for SqliteAppPlaygroundHistoryReadStore {
...
fn row_to_history_item(row: sqlx::sqlite::SqliteRow) -> DomainResult<AppPlaygroundHistoryItem> {
