...
async fn begin_webhook_event(
    ...
    let id: i64 = sqlx::query_scalar(
        ...
        VALUES
            ($1, 0, 0, 1, $2::timestamp AT TIME ZONE 'UTC', $2::timestamp AT TIME ZONE 'UTC', 0, $3, $4, $5, $6, $7, $8, $9, $10, 'RECEIVED', 'received webhook event')
        RETURNING id
        "#,
    )
...
async fn fulfill_recharge_once(
    ...
    let recharge = sqlx::query(
        ...
        SELECT CAST(id AS TEXT) AS id,
               ...
               CAST(COALESCE(point_amount, 0) AS TEXT) AS point_amount
        FROM plus_vip_recharge
        WHERE tenant_id = $1
          AND organization_id = $2
          AND user_id = $3
          AND transaction_no = $4
        LIMIT 1
        FOR UPDATE
        "#,
    )
...
async fn insert_account_history(
    ...
    sqlx::query(
        ...
        VALUES
            ($1, $2, $3, 1, $4::timestamp AT TIME ZONE 'UTC', $4::timestamp AT TIME ZONE 'UTC', 0, 2, 2, $5, $6, 21, $7, $8, $9, 1, $10, 2, $11, $12)
        "#,
    )
...
async fn insert_point_change(
    ...
    sqlx::query(
        ...
        VALUES
            ($1, $2, $3, 1, $4::timestamp AT TIME ZONE 'UTC', $4::timestamp AT TIME ZONE 'UTC', 0, $5, 1, $6, $7, $8, $9, 'PURCHASE', $10)
        "#,
    )
