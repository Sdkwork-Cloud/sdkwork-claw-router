...
fn row_to_organization(row: &sqlx::postgres::PgRow) -> DomainResult<AppIamOrganizationItem> {
...
fn row_to_department(row: &sqlx::postgres::PgRow) -> DomainResult<AppIamDepartmentItem> {
...
fn row_to_position(row: &sqlx::postgres::PgRow) -> DomainResult<AppIamPositionItem> {
...
fn row_to_role_binding(row: &sqlx::postgres::PgRow) -> DomainResult<AppIamRoleBindingItem> {
...
async fn table_exists(pool: &PgPool, table_name: &str) -> DomainResult<bool> {
