...
async fn update_account(
    ...
    sqlx::query(
        ...
        SET updated_at = CURRENT_TIMESTAMP,
            last_used_at = CASE WHEN $1 = 1 THEN CURRENT_TIMESTAMP ELSE last_used_at END,
    ...
    .map_err(|error| {
        store_error(
            "failed to update OpenAI invocation account telemetry",
            error,
        )
    })?;
    Ok(())
...
async fn insert_snapshot(
    ...
    sqlx::query(
        ...
        SELECT
            $1, c.tenant_id, c.organization_id, $2, $3, $4, 1, CURRENT_TIMESTAMP, $5::jsonb, c.provider_id, c.id, c.account_id, $6, $7, $8, $9, $10, $11, CURRENT_TIMESTAMP
