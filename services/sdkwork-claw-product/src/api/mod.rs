...
pub use app_commerce::{
    app_commerce_foundation_router, app_commerce_foundation_router_with_exchange_store,
};
...
pub use app_generation_agent::app_generation_agent_router;
pub use app_generation_agent::app_generation_agent_router_with_store;
pub use app_generation_agent::app_generation_agent_router_with_store_and_uuid_generator;
