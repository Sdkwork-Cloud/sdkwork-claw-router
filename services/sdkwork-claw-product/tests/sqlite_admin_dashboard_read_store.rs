use sdkwork_claw_product::infrastructure::sql::sqlite::SqliteAdminDashboardReadStore;
...
async fn seed_users(pool: &SqlitePool) {
    sqlx::query(
        ...
        VALUES
            ('1', '10', 'alice', 'Alice', 'alice@example.com', '', 'active', '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
            ('2', '10', 'bob', 'Bob', 'bob@example.com', '', 'active', '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
            ('3', '10', 'disabled', 'Disabled', 'disabled@example.com', '', 'disabled', '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
            ('4', '10', 'other-org', 'Other Org', 'other-org@example.com', '', 'active', '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
    ...
    sqlx::query(
        ...
        VALUES
            ('member-1', '10', '20', '1', 'member', 'Alice', 1, 'active', '2026-06-01 00:00:00', NULL, '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
            ('member-2', '10', '20', '2', 'member', 'Bob', 1, '1', '2026-06-01 00:00:00', NULL, '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
            ('member-3', '10', '20', '3', 'member', 'Disabled', 1, 'active', '2026-06-01 00:00:00', NULL, '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
            ('member-4', '10', '21', '4', 'member', 'Other Org', 1, 'active', '2026-06-01 00:00:00', NULL, '2026-06-01 00:00:00', '2026-06-01 00:00:00'),
            ('member-5', '99', '20', '5', 'member', 'Other Tenant', 1, 'active', '2026-06-01 00:00:00', NULL, '2026-06-01 00:00:00', '2026-06-01 00:00:00')
        "#,
    )
    .execute(pool)
    .await
