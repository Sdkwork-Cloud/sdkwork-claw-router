...
async fn admin_payment_runtime_route_returns_latest_provider_snapshot() {
    ...
    service
        ...
        .await;
    let router = sdkwork_claw_product::api::admin_payment_runtime_router_with_snapshot_store(store);
...
async fn admin_payment_runtime_route_reports_missing_snapshot_as_not_found() {
    let router = sdkwork_claw_product::api::admin_payment_runtime_router_with_snapshot_store(
