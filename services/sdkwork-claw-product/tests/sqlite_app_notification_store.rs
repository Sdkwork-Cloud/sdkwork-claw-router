use sdkwork_claw_product::infrastructure::sql::sqlite::SqliteAppNotificationStore;
...
async fn sqlite_app_notification_store_targets_messages_and_persists_user_state() {
    ...
    let row: (i64, Option<String>, Option<String>) = sqlx::query_as(
        ...
        WHERE tenant_id = 10 AND organization_id = 20 AND message_id = 1 AND user_id = 30 AND app_id = 'claw-router' AND delivery_channel = 1
        "#,
    )
    .fetch_one(&pool)
    .await
...
async fn sqlite_app_notification_store_lists_announcements_written_as_standard_notifications() {
    ...
    let row: (i64, Option<String>, Option<String>) = sqlx::query_as(
        ...
        SELECT COUNT(*), MAX(CAST(read_at AS TEXT)), MAX(CAST(popup_seen_at AS TEXT))
        FROM ops_notification_delivery
        WHERE tenant_id = 10 AND organization_id = 20 AND message_id = 100 AND user_id = 30 AND app_id = 'default' AND delivery_channel = 1
        "#,
    )
    .fetch_one(&pool)
    .await
...
async fn sqlite_app_notification_store_deduplicates_delivery_rows_before_repairing_upsert_index() {
    ...
    sqlx::query(
        ...
        VALUES
            (92, 'duplicate-read', 10, 20, 30, 1, 'claw-router', 1, 1, 2, '2026-05-17 10:40:00', NULL, '2026-05-17 10:00:00', '2026-05-17 10:00:00', '2026-05-17 10:40:00'),
            (93, 'duplicate-popup', 10, 20, 30, 1, 'claw-router', 1, 1, 2, NULL, '2026-05-17 10:41:00', '2026-05-17 10:00:00', '2026-05-17 10:00:00', '2026-05-17 10:41:00')
        "#,
    )
    .execute(&pool)
    .await
...
async fn seed_notifications(pool: &sqlx::SqlitePool) {
    ...
    sqlx::query(
        ...
        VALUES
            (1, 'msg-1', 10, 20, 1, 'claw-router', 1, 'launch', 1, 'Platform launch', 'Launch summary', 'Launch content', 1, 90, 1, '2026-05-17 10:00:00', '2099-01-01 00:00:00', '2026-05-17 10:00:00', '2026-05-17 10:00:00'),
            (2, 'msg-2', 10, 20, 1, 'claw-router', 1, 'single-user', 2, 'Billing user notice', 'User summary', 'User content', 2, 80, 0, '2026-05-17 11:00:00', '2099-01-01 00:00:00', '2026-05-17 11:00:00', '2026-05-17 11:00:00'),
            (3, 'msg-3', 10, 20, 1, 'claw-router', 1, 'role-admin', 3, 'Admin role notice', 'Role summary', 'Role content', 3, 70, 0, '2026-05-17 12:00:00', '2099-01-01 00:00:00', '2026-05-17 12:00:00', '2026-05-17 12:00:00'),
            (4, 'msg-4', 10, 20, 1, NULL, 2, 'global-all-app', 4, 'Global service notice', 'Global summary', 'Global content', 4, 60, 1, '2026-05-17 13:00:00', '2099-01-01 00:00:00', '2026-05-17 13:00:00', '2026-05-17 13:00:00'),
            (5, 'msg-5', 10, 20, 1, 'desktop-shell', 1, 'desktop-only', 1, 'Desktop notice', 'Desktop summary', 'Desktop content', 1, 50, 0, '2026-05-17 14:00:00', '2099-01-01 00:00:00', '2026-05-17 14:00:00', '2026-05-17 14:00:00'),
            (6, 'msg-6', 10, 20, 1, 'claw-router', 1, 'expired', 1, 'Expired notice', 'Expired summary', 'Expired content', 1, 40, 0, '2026-05-17 15:00:00', '2026-05-18 00:00:00', '2026-05-17 15:00:00', '2026-05-17 15:00:00'),
            (7, 'msg-7', 10, 20, 0, 'claw-router', 1, 'inactive', 1, 'Inactive notice', 'Inactive summary', 'Inactive content', 1, 30, 0, '2026-05-17 16:00:00', '2099-01-01 00:00:00', '2026-05-17 16:00:00', '2026-05-17 16:00:00'),
            (9, 'msg-9', 10, 20, 1, 'claw-router', 1, 'read', 1, 'Read notice', 'Read summary', 'Read content', 1, 20, 1, '2026-05-17 09:00:00', '2099-01-01 00:00:00', '2026-05-17 09:00:00', '2026-05-17 09:00:00')
        "#,
    )
    .execute(pool)
    .await
    ...
    sqlx::query(
        ...
        VALUES
            (1, 'recipient-1', 10, 20, 1, 1, 'claw-router', 1, 'all', NULL, NULL),
            (2, 'recipient-2', 10, 20, 1, 2, 'claw-router', 2, '30', 30, NULL),
            (3, 'recipient-3', 10, 20, 1, 3, 'claw-router', 3, 'admin', NULL, 'admin'),
            (4, 'recipient-4', 10, 20, 1, 4, NULL, 1, 'all', NULL, NULL),
            (5, 'recipient-5', 10, 20, 1, 5, 'desktop-shell', 1, 'all', NULL, NULL),
            (6, 'recipient-6', 10, 20, 1, 6, 'claw-router', 1, 'all', NULL, NULL),
            (7, 'recipient-7', 10, 20, 1, 7, 'claw-router', 1, 'all', NULL, NULL),
            (9, 'recipient-9', 10, 20, 1, 9, 'claw-router', 1, 'all', NULL, NULL)
        "#,
    )
    .execute(pool)
    .await
    ...
    sqlx::query(
        ...
        INSERT INTO ops_notification_delivery
            (id, uuid, tenant_id, organization_id, user_id, status, app_id, message_id, delivery_channel, delivery_status, read_at, popup_seen_at, delivered_at, created_at, updated_at)
        VALUES
            (90, 'delivery-other-user', 10, 20, 999, 1, 'claw-router', 1, 1, 2, '2026-05-17 10:30:00', '2026-05-17 10:31:00', '2026-05-17 10:00:00', '2026-05-17 10:00:00', '2026-05-17 10:00:00'),
            (91, 'delivery-read-user', 10, 20, 30, 1, 'claw-router', 9, 1, 2, '2026-05-17 09:30:00', '2026-05-17 09:31:00', '2026-05-17 09:00:00', '2026-05-17 09:00:00', '2026-05-17 09:00:00')
        "#,
    )
    .execute(pool)
    .await
...
async fn seed_announcements(pool: &sqlx::SqlitePool) {
    sqlx::query(
        ...
        VALUES
            (100, 'announcement-100', 10, 20, 1, 'System maintenance', 'Maintenance starts tonight.', 1, '{"target":"all","showAsPopup":true}', 3, 0, '2026-05-17 16:00:00', '2026-05-17 00:00:00', '2099-01-01 00:00:00', '2026-05-17 16:00:00', '2026-05-17 16:00:00'),
            (101, 'announcement-101', 10, 20, 1, 'Feature update', 'New console features are available.', 1, '{"target":"all","showAsPopup":false}', 1, 0, '2026-05-17 17:00:00', '2026-05-17 00:00:00', '2099-01-01 00:00:00', '2026-05-17 17:00:00', '2026-05-17 17:00:00'),
            (102, 'announcement-102', 10, 20, 0, 'Draft announcement', 'Drafts stay hidden.', 1, '{"target":"all","showAsPopup":true}', 4, 0, '2026-05-17 18:00:00', '2026-05-17 00:00:00', '2099-01-01 00:00:00', '2026-05-17 18:00:00', '2026-05-17 18:00:00'),
            (103, 'announcement-103', 10, 20, 1, 'VIP announcement', 'VIP-only content stays targeted.', 2, '{"target":"vip","showAsPopup":true}', 1, 0, '2026-05-17 19:00:00', '2026-05-17 00:00:00', '2099-01-01 00:00:00', '2026-05-17 19:00:00', '2026-05-17 19:00:00')
        "#,
    )
    .execute(pool)
    .await
...
async fn seed_standard_announcements(pool: &sqlx::SqlitePool) {
    sqlx::query(
        ...
        INSERT INTO ops_notification_message
            (id, uuid, tenant_id, organization_id, status, app_id, scope_type, message_code, message_type, title, summary, content, severity, priority, show_as_popup, published_at, expire_at, created_at, updated_at)
        VALUES
            (100, 'announcement-msg-100', 10, 20, 1, NULL, 2, 'announcement:100', 1, 'System maintenance', 'Maintenance starts tonight.', 'Maintenance starts tonight.', 3, 100, 1, '2026-05-17 16:00:00', '2099-01-01 00:00:00', '2026-05-17 16:00:00', '2026-05-17 16:00:00'),
            (101, 'announcement-msg-101', 10, 20, 1, NULL, 2, 'announcement:101', 1, 'Feature update', 'New console features are available.', 'New console features are available.', 1, 0, 0, '2026-05-17 17:00:00', '2099-01-01 00:00:00', '2026-05-17 17:00:00', '2026-05-17 17:00:00')
        "#,
    )
    .execute(pool)
    .await
    ...
    sqlx::query(
        ...
        INSERT INTO ops_notification_recipient
            (id, uuid, tenant_id, organization_id, status, message_id, app_id, recipient_type, recipient_value, recipient_user_id, recipient_role_code)
        VALUES
            (100, 'announcement-recipient-100', 10, 20, 1, 100, NULL, 1, 'all', NULL, NULL),
            (101, 'announcement-recipient-101', 10, 20, 1, 101, NULL, 1, 'all', NULL, NULL)
        "#,
    )
    .execute(pool)
    .await
