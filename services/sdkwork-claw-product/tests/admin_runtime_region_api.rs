...
use sdkwork_claw_product::infrastructure::sql::sqlite::SqliteRuntimeRegionSettingsStore;
...
async fn admin_runtime_region_settings_default_to_china_and_persist_updates() {
    ...
    let router = sdkwork_claw_product::api::admin_runtime_region_settings_router_with_store(
