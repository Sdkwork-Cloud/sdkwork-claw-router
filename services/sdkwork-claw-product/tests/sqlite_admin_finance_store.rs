use sdkwork_claw_product::infrastructure::sql::sqlite::SqliteAdminFinanceStore;
...
async fn sqlite_admin_finance_fails_closed_when_declared_commerce_source_is_missing() {
    ...
    sqlx::query(
        ...
        VALUES
            ('ledger-missing-payment', '10', '20', 'account-30', '30', 'points', 'credit', '50.00', '100.00', 'recharge', 'ORDER-MISSING', 'req-missing', 'idem-missing', 'commerce_payment_attempt', 'payment-missing', 'Payment source missing', '2026-05-20 09:05:00')
        "#,
    )
    .execute(&pool)
    .await
...
async fn seed_transactions(pool: &sqlx::SqlitePool) {
    sqlx::query(
        ...
        VALUES
            ('order-failed', '10', '20', '30', 'ORDER-FAILED', 'closed', 'points_recharge', 'CNY', 'req-order-failed', 'idem-order-failed', '2026-05-20 09:00:00', NULL, '2026-05-20 09:03:00', NULL, '2026-05-20 09:03:00')
        "#,
    )
    .execute(pool)
    .await
    ...
    sqlx::query(
        ...
        VALUES
            ('payment-failed', '10', '20', '30', 'intent-failed', 'order-failed', 'wechat', 'ORDER-FAILED', '50.00', 'CNY', 'failed', NULL, '2026-05-20 09:01:00', NULL, '2026-05-20 09:03:00')
        "#,
    )
    .execute(pool)
    .await
    ...
    sqlx::query(
        ...
        INSERT INTO commerce_account_ledger_entry
            (id, tenant_id, organization_id, account_id, owner_user_id, asset_type, direction, amount, balance_after, business_type, transaction_no, request_no, idempotency_key, source_type, source_id, remark, created_at)
        VALUES
            ('ledger-refund-pending', '10', '20', 'account-30', '30', 'cash', 'debit', '10.00', '90.00', 'refund', 'REFUND-PENDING', 'req-refund', 'idem-refund', 'commerce_refund', 'refund-processing', 'Refund processing', '2026-05-20 09:04:00'),
            ('ledger-payment-failed', '10', '20', 'account-30', '30', 'points', 'credit', '50.00', '100.00', 'recharge', 'ORDER-FAILED', 'req-payment', 'idem-payment', 'commerce_payment_attempt', 'payment-failed', 'Payment failed', '2026-05-20 09:03:00'),
            ('ledger-manual-success', '10', '20', 'account-30', '30', 'cash', 'credit', '5.00', '105.00', 'recharge', 'ADMIN-SUCCESS', 'req-admin', 'idem-admin', 'admin_user_balance_adjustment', 'admin-recharge', 'Manual adjustment', '2026-05-20 09:02:00')
        "#,
    )
    .execute(pool)
    .await
