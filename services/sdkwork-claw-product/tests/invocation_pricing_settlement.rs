...
use sdkwork_claw_product::ports::GatewayUsageQuantity;
use serde_json::json;
use std::sync::Arc;
...
async fn pricing_preflight_uses_route_key_for_model_ignored_api_resources_even_with_body_model() {
    ...
    invocation.resource.model_requirement =
        sdkwork_claw_product::domain::AiRouteModelRequirement::Ignored;
...
async fn settlement_produces_usage_commands_for_each_usage_line() {
    ...
    invocation
        .usage
        .add_line(sdkwork_claw_product::application::InvocationUsageLine::new(
            BillingMeter::LlmInputToken,
...
async fn settlement_uses_line_level_adapter_quotes() {
    ...
    invocation.usage.add_line(
        sdkwork_claw_product::application::InvocationUsageLine::new(
            BillingMeter::ApiResult,
