...
use sdkwork_claw_product::infrastructure::provider::SecretRefOpenAiCompatibleChatCompletionStreamRelay;
...
impl ProviderSecretResolver for MapSecretResolver {
    fn resolve_secret_value(
        ...
        self.secrets
            .get(secret_ref)
            .cloned()
            .ok_or_else(|| sdkwork_claw_product::domain::DomainError::new("secret ref not found"))
    }
}
