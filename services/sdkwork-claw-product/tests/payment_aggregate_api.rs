...
use sdkwork_claw_product::application::{EntityUuidGenerator, InMemoryPaymentIntentRuntimeStore};
...
async fn payment_aggregate_api_creates_payment_intent_and_records_route_decision() {
    ...
    let router = sdkwork_claw_product::api::payment_aggregate_router_with_runtime_store(
        store.clone(),
