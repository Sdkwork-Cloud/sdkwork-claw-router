...
use sdkwork_claw_product::application::AuthenticatedApiKeyContext;
use sdkwork_claw_product::domain::ProviderAuthProfile;
use sdkwork_claw_product::infrastructure::sql::sqlite::SqliteOpenAiInvocationTelemetryPlugin;
