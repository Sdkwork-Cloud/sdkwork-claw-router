# SDKWork Claw Admin API Component Specs

This directory is the local standards index for `sdkwork-claw-admin-api`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-admin-api` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/services/sdkwork-claw-admin-api` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/services/sdkwork-claw-admin-api/Cargo.toml`
