# SDKWork Claw App API Component Specs

This directory is the local standards index for `sdkwork-claw-app-api`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-app-api` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/services/sdkwork-claw-app-api` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/services/sdkwork-claw-app-api/Cargo.toml`
