...
| --- | --- | --- | --- | --- |
| L0 存量主数据层 | `spring-ai-plus-business-entity` | `plus_user`、`plus_account`、`plus_vip_*`、`plus_order`、`plus_payment` 等 | 既有 Java service/repository | 表结构完全保持一致；claw-router 只通过标准 service/API/SDK 接入 |
