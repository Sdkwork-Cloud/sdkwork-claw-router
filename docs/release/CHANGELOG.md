...
- Local development materializes dependencies under `.sdkwork/dependencies/<dependency-id>`; the GitHub release workflow checks out pinned GitHub refs to the same dependency root for release packaging.
...
- GitHub release `v0.3.0` is published at `https://github.com/Sdkwork-Cloud/sdkwork-claw-router/releases/tag/v0.3.0` from commit `ddec86eb884a2b9e2a33f1a9cf608520b5ae5ec2`.
