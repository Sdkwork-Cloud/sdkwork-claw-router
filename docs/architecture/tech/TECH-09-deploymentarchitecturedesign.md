...
Desktop Shell / local launcher
  ...
  -> sdkwork-clawrouter-router-service
      ...
      -> sdkwork-clawrouter-admin-api-server    127.0.0.1:18081
      -> sdkwork-clawrouter-app-api-server      127.0.0.1:18082
      -> SQLite
      -> memory/moka cache
...
| `sdkwork-clawrouter-app-api-server` | console/public 请求量 |
| `sdkwork-clawrouter-admin-api-server` | admin 请求量、后台任务触发 |
