...
**Files:**
- Modify: `services/sdkwork-claw-product/tests/openai_chat_api.rs`
- Modify: `services/sdkwork-claw-product/tests/sql_pricing_catalog_contract.rs`
...
**Files:**
- Create: `services/sdkwork-claw-product/src/domain/routing.rs`
- Modify: `services/sdkwork-claw-product/src/domain/mod.rs`
- Modify: `services/sdkwork-claw-product/src/ports/pricing_catalog.rs`
- Modify: `services/sdkwork-claw-product/src/infrastructure/in_memory_pricing_catalog.rs`
...
- Modify: `services/sdkwork-claw-product/src/infrastructure/sql/catalog.rs`
- Modify: `services/sdkwork-claw-product/src/infrastructure/sql/sqlite/row_mapping.rs`
- Modify: `services/sdkwork-claw-product/src/infrastructure/sql/postgres/row_mapping.rs`
- Modify: `services/sdkwork-claw-product/src/infrastructure/sql/sqlite/loader.rs`
- Modify: `services/sdkwork-claw-product/src/infrastructure/sql/postgres/loader.rs`
...
**Files:**
- Create: `services/sdkwork-claw-product/src/application/provider_route_selector.rs`
- Modify: `services/sdkwork-claw-product/src/application/mod.rs`
- Modify: `services/sdkwork-claw-product/src/api/openai_runtime.rs`
...
- [ ] Run `cargo test -p sdkwork-claw-product --test openai_chat_api --offline`.
- [ ] Run `cargo test -p sdkwork-claw-product --test sql_pricing_catalog_contract --offline`.
