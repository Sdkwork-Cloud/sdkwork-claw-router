...
- Modify: `services/sdkwork-clawrouter-router-service/src/application/invocation/mod.rs`
- Replace: `services/sdkwork-clawrouter-gateway/src/openai_route_taxonomy.rs` usage with product-layer classifier
...
- Move logic from: `services/sdkwork-clawrouter-gateway/src/route_scoped_openai_passthrough.rs`
...
**Files:**
- Create: `services/sdkwork-clawrouter-gateway/src/invocation_http.rs`
- Create: `services/sdkwork-clawrouter-gateway/src/invocation_router.rs`
- Modify: `services/sdkwork-clawrouter-gateway/src/lib.rs`
- Modify: `services/sdkwork-clawrouter-gateway/src/runtime.rs`
- Test: `services/sdkwork-clawrouter-gateway/tests/invocation_router.rs`
...
- [ ] Run `cargo test -p sdkwork-clawrouter-gateway --test invocation_router`.
...
- Delete or replace: `services/sdkwork-clawrouter-gateway/src/passthrough.rs`
- Delete or replace: `services/sdkwork-clawrouter-gateway/src/route_scoped_openai_passthrough.rs`
...
**Files:**
- Modify/add gateway tests under `services/sdkwork-clawrouter-gateway/tests/`
...
- [ ] Run `cargo test -p sdkwork-clawrouter-gateway`.
