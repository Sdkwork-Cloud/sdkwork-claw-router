...
```powershell
git add services/sdkwork-clawrouter-router-service services/sdkwork-claw-installer services/sdkwork-clawrouter-cloud-gateway services/sdkwork-clawrouter-admin-api-server services/sdkwork-clawrouter-app-api-server
