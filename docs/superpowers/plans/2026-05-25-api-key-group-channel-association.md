...
**Files:**
- Modify: `services/sdkwork-claw-product/tests/admin_access_group_api.rs`
- Modify: `services/sdkwork-claw-product/src/ports/admin_access_group_store.rs`
- Modify: `services/sdkwork-claw-product/src/api/admin_access_group.rs`

- [ ] Write failing API tests for listing and replacing group channel bindings.
- [ ] Run `cargo test -p sdkwork-claw-product --test admin_access_group_api admin_access_group_route_lists_and_replaces_channel_bindings`.
- [ ] Add port DTOs and trait methods for group channel bindings.
- [ ] Add Axum routes under `/backend/v3/api/router/access_groups/{group_id}/channel_bindings`.
...
- Modify: `services/sdkwork-claw-product/src/infrastructure/sql/postgres/admin_access_group_store.rs`
- Modify: `services/sdkwork-claw-product/src/infrastructure/sql/sqlite/admin_access_group_store.rs`
...
- [ ] Verify generated SDK exposes `iam.accessGroups.channelBindings` or the closest generator naming.
...
- [ ] Run focused Rust tests for admin access group API/store and route selector.
