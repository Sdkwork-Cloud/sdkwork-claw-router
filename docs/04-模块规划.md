...
| `sdkwork-clawrouter-pc-api-reference` | API 文档、在线请求 | gateway + app public |
| `sdkwork-clawrouter-pc-sdk-reference` | SDK 文档、SDK 生成 | app public |
| `sdkwork-clawrouter-pc-playground` | 多模态调试 | gateway + app |
| `sdkwork-clawrouter-pc-forum` | 论坛 | app |
| `sdkwork-clawrouter-pc-courses` | 课程 | app |
