# Schema Compiler PostgreSQL DDL 生成标准

## 目标

`tools.schema_compiler` 将 `docs/schema-registry/sdkwork-claw-router.tables.yaml` 编译为可落库的 PostgreSQL DDL，形成从“数据契约”到“物理表结构”的标准生成链路。
