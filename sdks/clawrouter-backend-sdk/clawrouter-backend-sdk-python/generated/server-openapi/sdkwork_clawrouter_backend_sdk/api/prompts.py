...
from ..models import AdminPromptBindingCreateRequest, AdminPromptBindingUpdateRequest, AdminPromptCreateRequest, AdminPromptRenderRequest, AdminPromptVersionCreateRequest, DefinitionBindingsCreateResult, DefinitionBindingsListResult, DefinitionBindingsUpdateResult, DefinitionsCreateResult, DefinitionsListResult, VersionRendersCreateResult, VersionsCreateResult, VersionsListResult, VersionsPublishResult
...
class PromptsApi:
    ...
    def __init__(self, client: HttpClient):
        self._client = client
        self.definitions = PromptsDefinitionsApi(client)
        self.definition_bindings = PromptsDefinitionBindingsApi(client)
        self.versions = PromptsVersionsApi(client)
        self.version_renders = PromptsVersionRendersApi(client)


class PromptsDefinitionsApi:
    """prompts prompts.definitions API client."""
    ...
    def list(self, page: Optional[int] = None, page_size: Optional[int] = None, q: Optional[str] = None, prompt_type: Optional[str] = None, visibility: Optional[str] = None, status: Optional[str] = None, category_id: Optional[str] = None) -> DefinitionsListResult:
        ...
        query = build_query_string([
            ...
            {'name': 'prompt_type', 'value': prompt_type, 'style': 'form', 'explode': True, 'allow_reserved': False},
    ...
    def create(self, body: AdminPromptCreateRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> DefinitionsCreateResult:
        ...
        return self._client.post(f"/backend/v3/api/prompts", json=body, headers=request_headers)

class PromptsDefinitionBindingsApi:
    """prompts prompts.definition_bindings API client."""
    ...
    def create(self, prompt_id: str, body: AdminPromptBindingCreateRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> DefinitionBindingsCreateResult:
        ...
        return self._client.post(f"/backend/v3/api/prompts/{serialize_path_parameter(prompt_id, {'name': 'promptId', 'style': 'simple', 'explode': False})}/bindings", json=body, headers=request_headers)

class PromptsVersionsApi:
    """prompts prompts.versions API client."""
    ...
    def create(self, prompt_id: str, body: AdminPromptVersionCreateRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> VersionsCreateResult:
        ...
        return self._client.post(f"/backend/v3/api/prompts/{serialize_path_parameter(prompt_id, {'name': 'promptId', 'style': 'simple', 'explode': False})}/versions", json=body, headers=request_headers)

class PromptsVersionRendersApi:
    """prompts prompts.version_renders API client."""
