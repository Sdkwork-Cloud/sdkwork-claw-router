...
public class ServiceProvidersApi {
    ...
    public func adjustmentsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> AdjustmentsListResult? {
        let query = buildQueryString([
            ...
            QueryParameterSpec(name: "provider_id", value: providerId, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "seller_provider_id", value: sellerProviderId, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "buyer_provider_id", value: buyerProviderId, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "edge_id", value: edgeId, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/adjustments"), query), responseType: AdjustmentsListResult.self)
    }
    ...
    public func auditEventsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> AuditEventsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/audit/events"), query), responseType: AuditEventsListResult.self)
    }
    ...
    public func bindingsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> BindingsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/bindings"), query), responseType: BindingsListResult.self)
    }
    ...
    public func contractsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> ContractsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/contracts"), query), responseType: ContractsListResult.self)
    }
    ...
    public func dashboardRetrieve(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> DashboardRetrieveResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/dashboard"), query), responseType: DashboardRetrieveResult.self)
    }
    ...
    public func downstreamsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> DownstreamsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/downstreams"), query), responseType: DownstreamsListResult.self)
    }
    ...
    public func downstreamsCreate(body: ServiceProviderDownstreamCreateRequest, idempotencyKey: String, xRequestId: String? = nil) async throws -> DownstreamsCreateResult? {
        ...
        return try await client.post(ApiPaths.backendPath("/service_providers/downstreams"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: DownstreamsCreateResult.self)
    }
    ...
    public func membersList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> MembersListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/members"), query), responseType: MembersListResult.self)
    }
    ...
    public func pricingRulesList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> PricingRulesListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/pricing/rules"), query), responseType: PricingRulesListResult.self)
    }
    ...
    public func pricingRulesCreate(body: ServiceProviderPricingRuleCreateRequest, idempotencyKey: String, xRequestId: String? = nil) async throws -> PricingRulesCreateResult? {
        ...
        return try await client.post(ApiPaths.backendPath("/service_providers/pricing/rules"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: PricingRulesCreateResult.self)
    }
    ...
    public func pricingRulesUpdate(ruleId: String, body: ServiceProviderPricingRuleUpdateRequest, idempotencyKey: String, xRequestId: String? = nil) async throws -> PricingRulesUpdateResult? {
        ...
        return try await client.patch(ApiPaths.backendPath("/service_providers/pricing/rules/\(serializePathParameter(ruleId, PathParameterSpec(name: "ruleId", style: "simple", explode: false)))"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: PricingRulesUpdateResult.self)
    }
    ...
    public func priceSimulationCreate(body: ServiceProviderPriceSimulationRequest, idempotencyKey: String, xRequestId: String? = nil) async throws -> PriceSimulationCreateResult? {
        ...
        return try await client.post(ApiPaths.backendPath("/service_providers/pricing/simulations"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: PriceSimulationCreateResult.self)
    }
    ...
    public func providerRegistryList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> ProviderRegistryListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/providers"), query), responseType: ProviderRegistryListResult.self)
    }
    ...
    public func reconciliationRunsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> ReconciliationRunsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/reconciliation_runs"), query), responseType: ReconciliationRunsListResult.self)
    }
    ...
    public func relationsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> RelationsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/relations"), query), responseType: RelationsListResult.self)
    }
    ...
    public func riskEventsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> RiskEventsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/risk/events"), query), responseType: RiskEventsListResult.self)
    }
    ...
    public func statementsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> StatementsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/statements"), query), responseType: StatementsListResult.self)
    }
    ...
    public func usageList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> UsageListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/usage"), query), responseType: UsageListResult.self)
    }
    ...
    public func providerWalletAccountsList(page: Int? = nil, pageSize: Int? = nil, status: String? = nil, providerId: String? = nil, sellerProviderId: String? = nil, buyerProviderId: String? = nil, edgeId: String? = nil) async throws -> ProviderWalletAccountsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/service_providers/wallet/accounts"), query), responseType: ProviderWalletAccountsListResult.self)
    }
