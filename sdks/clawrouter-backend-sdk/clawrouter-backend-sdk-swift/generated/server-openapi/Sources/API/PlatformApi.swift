...
public class PlatformApi {
    ...
    /// List apps
    public func appsList(q: String? = nil, status: String? = nil, marketStatus: String? = nil, appType: String? = nil, page: Int? = nil, pageSize: Int? = nil, xRequestId: String? = nil) async throws -> AppsListResult? {
