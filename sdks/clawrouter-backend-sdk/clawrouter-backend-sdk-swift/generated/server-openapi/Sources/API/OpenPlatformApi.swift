...
public class OpenPlatformApi {
    ...
    public func accountsList(provider: String? = nil, type: String? = nil, status: String? = nil, page: Int? = nil, pageSize: Int? = nil) async throws -> AccountsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/open_platform/accounts"), query), responseType: AccountsListResult.self)
    }
    ...
    public func accountsRetrieve(accountId: String) async throws -> AccountsRetrieveResult? {
        return try await client.get(ApiPaths.backendPath("/open_platform/accounts/\(serializePathParameter(accountId, PathParameterSpec(name: "accountId", style: "simple", explode: false)))"), responseType: AccountsRetrieveResult.self)
    }
    ...
    public func accountsEntriesList(accountId: String) async throws -> AccountsEntriesListResult? {
        return try await client.get(ApiPaths.backendPath("/open_platform/accounts/\(serializePathParameter(accountId, PathParameterSpec(name: "accountId", style: "simple", explode: false)))/entries"), responseType: AccountsEntriesListResult.self)
    }
    ...
    public func accountsPayBindingsList(accountId: String) async throws -> AccountsPayBindingsListResult? {
        return try await client.get(ApiPaths.backendPath("/open_platform/accounts/\(serializePathParameter(accountId, PathParameterSpec(name: "accountId", style: "simple", explode: false)))/pay_bindings"), responseType: AccountsPayBindingsListResult.self)
    }
    ...
    public func manifestsList(provider: String? = nil, type: String? = nil) async throws -> ManifestsListResult? {
        let query = buildQueryString([
            QueryParameterSpec(name: "provider", value: provider, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "type", value: type, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/open_platform/manifests"), query), responseType: ManifestsListResult.self)
    }

    /// List open platform providers
    public func providersList(status: String? = nil) async throws -> ProvidersListResult? {
        let query = buildQueryString([
            QueryParameterSpec(name: "status", value: status, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/open_platform/providers"), query), responseType: ProvidersListResult.self)
    }
