...
namespace Sdkwork.ClawRouter.Backend.Api
{
    public class PromptsApi
    {
        ...
        public PromptsApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        public async Task<Sdkwork.ClawRouter.Backend.Models.DefinitionsListResult?> DefinitionsListAsync(int? page = null, int? pageSize = null, string? q = null, string? promptType = null, string? visibility = null, string? status = null, string? categoryId = null)
        {
            var queryString = BuildQueryString(new[]
            {
                ...
                new QueryParameterSpec("prompt_type", promptType, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Backend.Models.DefinitionsListResult>(ApiPaths.AppendQueryString(ApiPaths.BackendPath("/prompts"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.Backend.Models.DefinitionsCreateResult?> DefinitionsCreateAsync(Sdkwork.ClawRouter.Backend.Models.AdminPromptCreateRequest body, string idempotencyKey, string? xRequestId = null)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.Backend.Models.DefinitionsCreateResult>(ApiPaths.BackendPath("/prompts"), body, null, requestHeaders, "application/json");
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.DefinitionBindingsListResult?> DefinitionBindingsListAsync(string promptId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Backend.Models.DefinitionBindingsListResult>(ApiPaths.BackendPath($"/prompts/{SerializePathParameter(promptId, new PathParameterSpec("promptId", "simple", false))}/bindings"));
        }
        ...
        public async Task<Sdkwork.ClawRouter.Backend.Models.DefinitionBindingsCreateResult?> DefinitionBindingsCreateAsync(string promptId, Sdkwork.ClawRouter.Backend.Models.AdminPromptBindingCreateRequest body, string idempotencyKey, string? xRequestId = null)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.Backend.Models.DefinitionBindingsCreateResult>(ApiPaths.BackendPath($"/prompts/{SerializePathParameter(promptId, new PathParameterSpec("promptId", "simple", false))}/bindings"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// List prompt versions
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.VersionsListResult?> VersionsListAsync(string promptId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Backend.Models.VersionsListResult>(ApiPaths.BackendPath($"/prompts/{SerializePathParameter(promptId, new PathParameterSpec("promptId", "simple", false))}/versions"));
        }
        ...
        public async Task<Sdkwork.ClawRouter.Backend.Models.VersionsCreateResult?> VersionsCreateAsync(string promptId, Sdkwork.ClawRouter.Backend.Models.AdminPromptVersionCreateRequest body, string idempotencyKey, string? xRequestId = null)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.Backend.Models.VersionsCreateResult>(ApiPaths.BackendPath($"/prompts/{SerializePathParameter(promptId, new PathParameterSpec("promptId", "simple", false))}/versions"), body, null, requestHeaders, "application/json");
        }
