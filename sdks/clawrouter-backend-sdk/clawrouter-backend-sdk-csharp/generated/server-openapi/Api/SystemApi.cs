...
namespace Sdkwork.ClawRouter.Backend.Api
{
    public class SystemApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.PromotionsCodesListResult?> PromotionsCodesListAsync(string? page = null, string? pageSize = null, string? status = null)
        {
            var queryString = BuildQueryString(new[]
            {
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.PromotionsCodesRedemptionsListResult?> PromotionsCodesRedemptionsListAsync(string? page = null, string? pageSize = null, string? codeStatus = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page", page, "form", true, false, null),
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.PromotionsCouponStocksListResult?> PromotionsCouponStocksListAsync(string? page = null, string? pageSize = null, string? status = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page", page, "form", true, false, null),
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.PromotionsDiscountApplicationsListResult?> PromotionsDiscountApplicationsListAsync(string? page = null, string? pageSize = null, string? status = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page", page, "form", true, false, null),
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.PromotionsOffersManagementListResult?> PromotionsOffersManagementListAsync(string? page = null, string? pageSize = null, string? status = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page", page, "form", true, false, null),
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Backend.Models.PromotionsUserCouponsManagementListResult?> PromotionsUserCouponsManagementListAsync(string? page = null, string? pageSize = null, string? status = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page", page, "form", true, false, null),
