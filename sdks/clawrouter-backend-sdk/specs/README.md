# SDKWork Claw Router backend API SDK Component Specs

This directory is the local standards index for `clawrouter-backend-sdk`.
...
| Field | Value |
| --- | --- |
| Name | `clawrouter-backend-sdk` |
| Type | `sdk-family` |
| Root | `sdkwork-claw-router/sdks/clawrouter-backend-sdk` |
| Domain | `platform` |
| Capability | `router` |
