...
use crate::models::{AdminAiModelCreateRequest, AdminAiModelUpdateRequest, AdminModelCatalogSyncRequest, AdminModelVendorCreateRequest, ModelRankingRefreshTriggerRequest, ModelRankingsJobsListResult, ModelRankingsListResult, ModelRankingsRefreshResult, ModelRankingsStatusRetrieveResult, ModelVendorsCreateResult, ModelVendorsListResult, ModelsCreateResult, ModelsDeleteResult, ModelsListResult, ModelsRefreshResult, ModelsUpdateResult};
...
impl AiApi {
    ...
    pub async fn model_rankings_refresh(&self, body: &ModelRankingRefreshTriggerRequest, x_request_id: Option<&str>) -> Result<ModelRankingsRefreshResult, SdkworkError> {
    ...
    /// Create vendor
    pub async fn model_vendors_create(&self, body: &AdminModelVendorCreateRequest, x_request_id: Option<&str>) -> Result<ModelVendorsCreateResult, SdkworkError> {
        let path = backend_path(&"/ai/model_vendors".to_string());
        let headers = build_request_headers(
            &[
                ("X-Request-Id", HeaderParameterSpec::new(x_request_id, "simple", false, None)),
    ...
    /// Create model
    pub async fn models_create(&self, body: &AdminAiModelCreateRequest, x_request_id: Option<&str>) -> Result<ModelsCreateResult, SdkworkError> {
        let path = backend_path(&"/ai/models".to_string());
        let headers = build_request_headers(
            &[
                ("X-Request-Id", HeaderParameterSpec::new(x_request_id, "simple", false, None)),
    ...
    pub async fn models_refresh(&self, body: &AdminModelCatalogSyncRequest, x_request_id: Option<&str>) -> Result<ModelsRefreshResult, SdkworkError> {
    ...
    /// Update model
    pub async fn models_update(&self, model_id: &str, body: &AdminAiModelUpdateRequest, x_request_id: Option<&str>) -> Result<ModelsUpdateResult, SdkworkError> {
        let path = backend_path(&format!("/ai/models/{}", serialize_path_parameter(model_id, PathParameterSpec::new("modelId", "simple", false))));
        let headers = build_request_headers(
            &[
                ("X-Request-Id", HeaderParameterSpec::new(x_request_id, "simple", false, None)),
