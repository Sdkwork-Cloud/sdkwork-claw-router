...
impl CommerceApi {
    ...
    pub async fn audit_commerce_events_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<AuditCommerceEventsListResult, SdkworkError> {
    ...
    pub async fn reports_order_revenue_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<CommerceReportsOrderRevenueListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn reports_refunds_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<CommerceReportsRefundsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    /// Fulfillments List
    pub async fn fulfillments_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<FulfillmentsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn inventory_ledger_entries_list(&self, sku_id: Option<&str>, warehouse_id: Option<&str>, source_type: Option<&str>, source_id: Option<&str>, page: Option<&str>, page_size: Option<&str>) -> Result<InventoryLedgerEntriesListResult, SdkworkError> {
        let query = build_query_string(&[
    ...
    pub async fn inventory_reservations_list(&self, sku_id: Option<&str>, order_id: Option<&str>, checkout_session_id: Option<&str>, status: Option<&str>, page: Option<&str>, page_size: Option<&str>) -> Result<InventoryReservationsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("sku_id", sku_id, "form", true, false, None),
    ...
    pub async fn inventory_stocks_list(&self, sku_id: Option<&str>, warehouse_id: Option<&str>, status: Option<&str>, page: Option<&str>, page_size: Option<&str>) -> Result<InventoryStocksListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("sku_id", sku_id, "form", true, false, None),
            QueryParameterSpec::new("warehouse_id", warehouse_id, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    /// Invoices List
    pub async fn invoices_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<InvoicesListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn invoices_titles_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<InvoicesTitlesListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn memberships_entitlements_list(&self, page: Option<&str>, page_size: Option<&str>, plan_id: Option<&str>, membership_id: Option<&str>, status: Option<&str>) -> Result<MembershipsEntitlementsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
    ...
    pub async fn memberships_members_list(&self, page: Option<&str>, page_size: Option<&str>, cursor: Option<&str>, user_id: Option<&str>, plan_id: Option<&str>, status: Option<&str>) -> Result<MembershipsMembersListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
    ...
    pub async fn memberships_package_groups_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<MembershipsPackageGroupsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn memberships_packages_list(&self, page: Option<&str>, page_size: Option<&str>, package_group_id: Option<&str>, plan_id: Option<&str>, status: Option<&str>) -> Result<MembershipsPackagesListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
    ...
    pub async fn memberships_plans_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<MembershipsPlansListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    /// Orders List
    pub async fn orders_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<OrdersListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    /// Orders Events List
    pub async fn orders_events_list(&self, order_id: &str, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<OrdersEventsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn payments_attempts_list(&self, intent_id: Option<&str>, provider_code: Option<&str>, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsAttemptsListResult, SdkworkError> {
        let query = build_query_string(&[
    ...
    pub async fn payments_channels_list(&self, provider_account_id: Option<&str>, method_code: Option<&str>, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsChannelsListResult, SdkworkError> {
        let query = build_query_string(&[
    ...
    pub async fn payments_intents_list(&self, order_id: Option<&str>, provider_code: Option<&str>, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsIntentsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("order_id", order_id, "form", true, false, None),
            QueryParameterSpec::new("provider_code", provider_code, "form", true, false, None),
            QueryParameterSpec::new("page", page, "form", true, false, None),
    ...
    pub async fn payments_methods_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsMethodsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn payments_provider_accounts_list(&self, provider_code: Option<&str>, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsProviderAccountsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("provider_code", provider_code, "form", true, false, None),
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
    ...
    pub async fn payments_reconciliation_runs_list(&self, provider_code: Option<&str>, business_date: Option<&str>, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsReconciliationRunsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("provider_code", provider_code, "form", true, false, None),
    ...
    pub async fn payments_route_rules_list(&self, method_code: Option<&str>, country_code: Option<&str>, currency_code: Option<&str>, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsRouteRulesListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("method_code", method_code, "form", true, false, None),
    ...
    pub async fn payments_webhook_events_list(&self, provider_code: Option<&str>, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<PaymentsWebhookEventsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("provider_code", provider_code, "form", true, false, None),
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
    ...
    pub async fn recharges_orders_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<RechargesOrdersListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn recharges_packages_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<RechargesPackagesListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    /// Refunds List
    pub async fn refunds_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<RefundsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    /// Shipments List
    pub async fn shipments_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<ShipmentsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn wallet_accounts_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<WalletAccountsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn wallet_exchange_rules_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<WalletExchangeRulesListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
    ...
    pub async fn wallet_ledger_entries_list(&self, page: Option<&str>, page_size: Option<&str>, status: Option<&str>) -> Result<WalletLedgerEntriesListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("status", status, "form", true, false, None),
