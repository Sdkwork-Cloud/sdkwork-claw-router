...
impl PromptsApi {
    ...
    pub async fn definition_bindings_list(&self, prompt_id: &str) -> Result<DefinitionBindingsListResult, SdkworkError> {
    ...
    pub async fn versions_list(&self, prompt_id: &str) -> Result<VersionsListResult, SdkworkError> {
