...
impl BillingApi {
    ...
    /// Generate batch
    pub async fn coupon_batches_create(&self, body: &AdminCouponBatchGenerateRequest, x_request_id: Option<&str>) -> Result<CouponBatchesCreateResult, SdkworkError> {
        let path = backend_path(&"/billing/coupon_batches".to_string());
    ...
    /// Create coupon
    pub async fn coupons_create(&self, body: &AdminCouponCreateRequest, x_request_id: Option<&str>) -> Result<CouponsCreateResult, SdkworkError> {
        let path = backend_path(&"/billing/coupons".to_string());
        let headers = build_request_headers(
            &[
                ("X-Request-Id", HeaderParameterSpec::new(x_request_id, "simple", false, None)),
    ...
    /// Delete coupon
    pub async fn coupons_delete(&self, coupon_id: &str) -> Result<CouponsDeleteResult, SdkworkError> {
    ...
    /// List billing
    pub async fn finance_usage_statements_list(&self, page: Option<i64>, page_size: Option<i64>, q: Option<&str>, status: Option<&str>, start_time: Option<&str>, end_time: Option<&str>) -> Result<FinanceUsageStatementsListResult, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("page", page, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
            QueryParameterSpec::new("q", q, "form", true, false, None),
        ...
        let path = append_query_string(backend_path(&"/billing/finance/usage_statements".to_string()), &query);
        self.client.get(&path, None, None).await
    }
    ...
    /// Update balance
    pub async fn users_balance_adjustments_create(&self, user_id: &str, body: &AdminUserBalanceAdjustmentRequest, x_request_id: Option<&str>) -> Result<UsersBalanceAdjustmentsCreateResult, SdkworkError> {
        let path = backend_path(&format!("/billing/users/{}/balance_adjustments", serialize_path_parameter(user_id, PathParameterSpec::new("userId", "simple", false))));
        let headers = build_request_headers(
            &[
                ("X-Request-Id", HeaderParameterSpec::new(x_request_id, "simple", false, None)),
            ],
