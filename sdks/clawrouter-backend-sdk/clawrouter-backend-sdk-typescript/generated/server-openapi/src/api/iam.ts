...
/** Create API key */
  async create(body: AdminApiKeyCreateRequest, params: IamApiKeysCreateParams): Promise<ApiKeysCreateResult> {
    ...
    return this.client.post<ApiKeysCreateResult>(backendApiPath(`/iam/api_keys`), body, undefined, requestHeaders, 'application/json');
  }

/** Delete API key */
  async delete(apiKeyId: string): Promise<ApiKeysDeleteResult> {
    return this.client.delete<ApiKeysDeleteResult>(backendApiPath(`/iam/api_keys/${serializePathParameter(apiKeyId, { name: 'apiKeyId', style: 'simple', explode: false })}`));
  }
}
