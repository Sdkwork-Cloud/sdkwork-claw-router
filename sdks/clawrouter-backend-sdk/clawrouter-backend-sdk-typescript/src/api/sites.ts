...
/** Health check site */
  async create(siteId: string, body: AdminSiteActionRequest): Promise<HealthCheckCreateResult> {
    return this.client.post<HealthCheckCreateResult>(backendApiPath(`/sites/${serializePathParameter(siteId, { name: 'siteId', style: 'simple', explode: false })}/health_check`), body, undefined, undefined, 'application/json');
  }
}
...
/** List site channels */
  async list(siteId: string): Promise<SiteChannelsListResult> {
    return this.client.get<SiteChannelsListResult>(backendApiPath(`/sites/${serializePathParameter(siteId, { name: 'siteId', style: 'simple', explode: false })}/channels`));
  }
}

export interface SitesSiteCatalogListParams {
  q?: string;
}
...
/** List sites */
  async list(params?: SitesSiteCatalogListParams): Promise<SiteCatalogListResult> {
    const query = buildQueryString([
      { name: 'q', value: params?.q, style: 'form', explode: true, allowReserved: false },
    ]);
    return this.client.get<SiteCatalogListResult>(appendQueryString(backendApiPath(`/sites`), query));
  }
}
...
/** Create site */
  async create(body: AdminSiteCreateRequest): Promise<SiteCreateResult> {
    return this.client.post<SiteCreateResult>(backendApiPath(`/sites`), body, undefined, undefined, 'application/json');
  }

/** Delete site */
  async delete(siteId: string): Promise<SiteDeleteResult> {
    return this.client.delete<SiteDeleteResult>(backendApiPath(`/sites/${serializePathParameter(siteId, { name: 'siteId', style: 'simple', explode: false })}`));
  }

/** Update site */
  async update(siteId: string, body: AdminSiteUpdateRequest): Promise<SiteUpdateResult> {
    return this.client.patch<SiteUpdateResult>(backendApiPath(`/sites/${serializePathParameter(siteId, { name: 'siteId', style: 'simple', explode: false })}`), body, undefined, undefined, 'application/json');
  }
}
