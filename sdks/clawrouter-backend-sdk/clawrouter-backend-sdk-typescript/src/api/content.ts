...
export interface ContentAnnouncementsCreateParams {
  xRequestId?: string;
}

export interface ContentAnnouncementsUpdateParams {
  xRequestId?: string;
}
...
/** Create announcement */
  async create(body: AdminAnnouncementCreateRequest, params?: ContentAnnouncementsCreateParams): Promise<AnnouncementsCreateResult> {
    ...
    return this.client.post<AnnouncementsCreateResult>(backendApiPath(`/content/announcements`), body, undefined, requestHeaders, 'application/json');
  }
...
/** Update announcement */
  async update(announcementId: string, body: AdminAnnouncementUpdateRequest, params?: ContentAnnouncementsUpdateParams): Promise<AnnouncementsUpdateResult> {
    ...
    return this.client.patch<AnnouncementsUpdateResult>(backendApiPath(`/content/announcements/${serializePathParameter(announcementId, { name: 'announcementId', style: 'simple', explode: false })}`), body, undefined, requestHeaders, 'application/json');
  }
}
