...
public class AiResourceRecord {
    ...
    private Map<String, String> resourceSchema;
    ...
    public void setApiEndpointId(String apiEndpointId) {
    ...
    public Map<String, String> getMetadataSchema() {
        return this.metadataSchema;
    }

    public void setMetadataSchema(Map<String, String> metadataSchema) {
    ...
    public Map<String, String> getResourceSchema() {
        return this.resourceSchema;
    }

    public void setResourceSchema(Map<String, String> resourceSchema) {
