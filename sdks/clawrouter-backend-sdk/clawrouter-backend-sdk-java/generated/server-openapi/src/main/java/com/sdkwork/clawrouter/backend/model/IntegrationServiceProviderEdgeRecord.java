...
public class IntegrationServiceProviderEdgeRecord {
    ...
    private Map<String, String> contractSnapshot;
    ...
    public Map<String, String> getContractSnapshot() {
        return this.contractSnapshot;
    }

    public void setContractSnapshot(Map<String, String> contractSnapshot) {
