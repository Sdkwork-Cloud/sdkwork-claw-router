...
public class OpsReferralStatSnapshotRecord {
    ...
    private String directInvitedCount;
    private String id;
    private String invitationCode;
    private String invitationCodeId;
    private String inviteLink;
    private String inviterEmailSnapshot;
    private String inviterNameSnapshot;
    private String inviterUserId;
    private Map<String, String> metadata;
    private String organizationId;
    private String paidInviteeCount;
    private String periodEnd;
    private String periodStart;
    private String rebuildVersion;
    private String rewardAwardedAmount;
    private String rewardPendingAmount;
    private String secondaryInvitedCount;
