...
public class CommercePaymentReconciliationItemRecord {
    ...
    public String getReconciliationRunId() {
        return this.reconciliationRunId;
    }

    public void setReconciliationRunId(String reconciliationRunId) {
        this.reconciliationRunId = reconciliationRunId;
    }

    public String getRefundAttemptId() {
        return this.refundAttemptId;
    }

    public void setRefundAttemptId(String refundAttemptId) {
