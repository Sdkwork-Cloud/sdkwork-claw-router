...
public class PromotionUserCouponRecord {
    ...
    private String couponCodeSuffix;
    ...
    public String getClaimCodeSuffix() {
        return this.claimCodeSuffix;
    }

    public void setClaimCodeSuffix(String claimCodeSuffix) {
    ...
    public void setCouponCodeHash(String couponCodeHash) {
        this.couponCodeHash = couponCodeHash;
    }

    public String getCouponCodeSuffix() {
        return this.couponCodeSuffix;
    }

    public void setCouponCodeSuffix(String couponCodeSuffix) {
        this.couponCodeSuffix = couponCodeSuffix;
    }
