...
public class PromptsApi {
    ...
    public PromptsApi(HttpClient client) {
        this.client = client;
    }
    ...
    public DefinitionsListResult definitionsList(Integer page, Integer pageSize, String q, String promptType, String visibility, String status, String categoryId) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/prompts"), query));
        return client.convertValue(raw, new TypeReference<DefinitionsListResult>() {});
    }
    ...
    public DefinitionsCreateResult definitionsCreate(AdminPromptCreateRequest body, String idempotencyKey, String xRequestId) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<DefinitionsCreateResult>() {});
    }
    ...
    public DefinitionBindingsListResult definitionBindingsList(String promptId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/prompts/" + serializePathParameter(promptId, new PathParameterSpec("promptId", "simple", false)) + "/bindings"));
        return client.convertValue(raw, new TypeReference<DefinitionBindingsListResult>() {});
    }
    ...
    public DefinitionBindingsCreateResult definitionBindingsCreate(String promptId, AdminPromptBindingCreateRequest body, String idempotencyKey, String xRequestId) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<DefinitionBindingsCreateResult>() {});
    }

    /** List prompt versions */
    public VersionsListResult versionsList(String promptId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/prompts/" + serializePathParameter(promptId, new PathParameterSpec("promptId", "simple", false)) + "/versions"));
        return client.convertValue(raw, new TypeReference<VersionsListResult>() {});
    }
    ...
    public VersionsCreateResult versionsCreate(String promptId, AdminPromptVersionCreateRequest body, String idempotencyKey, String xRequestId) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<VersionsCreateResult>() {});
    }
