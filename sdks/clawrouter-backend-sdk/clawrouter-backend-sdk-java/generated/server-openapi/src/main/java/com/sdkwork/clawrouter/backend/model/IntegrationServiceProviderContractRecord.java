...
public class IntegrationServiceProviderContractRecord {
    ...
    private String contractFileRef;
    ...
    public String getContractFileRef() {
        return this.contractFileRef;
    }

    public void setContractFileRef(String contractFileRef) {
        this.contractFileRef = contractFileRef;
    }
