...
public class AdminAiResourceItem {
    ...
    private String id;
    private List<AdminAiResourceMemberItem> members;
    ...
    public List<AdminAiResourceMemberItem> getMembers() {
        return this.members;
    }

    public void setMembers(List<AdminAiResourceMemberItem> members) {
