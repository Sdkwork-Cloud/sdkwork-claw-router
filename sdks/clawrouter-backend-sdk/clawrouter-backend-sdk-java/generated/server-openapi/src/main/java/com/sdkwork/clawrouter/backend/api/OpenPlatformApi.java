...
public class OpenPlatformApi {
    ...
    public OpenPlatformApi(HttpClient client) {
        this.client = client;
    }
    ...
    public AccountsListResult accountsList(String provider, String type, String status, Integer page, Integer pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/open_platform/accounts"), query));
        return client.convertValue(raw, new TypeReference<AccountsListResult>() {});
    }
    ...
    public AccountsRetrieveResult accountsRetrieve(String accountId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/open_platform/accounts/" + serializePathParameter(accountId, new PathParameterSpec("accountId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<AccountsRetrieveResult>() {});
    }
    ...
    public AccountsEntriesListResult accountsEntriesList(String accountId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/open_platform/accounts/" + serializePathParameter(accountId, new PathParameterSpec("accountId", "simple", false)) + "/entries"));
        return client.convertValue(raw, new TypeReference<AccountsEntriesListResult>() {});
    }
    ...
    public AccountsPayBindingsListResult accountsPayBindingsList(String accountId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/open_platform/accounts/" + serializePathParameter(accountId, new PathParameterSpec("accountId", "simple", false)) + "/pay_bindings"));
        return client.convertValue(raw, new TypeReference<AccountsPayBindingsListResult>() {});
    }
    ...
    public ManifestsListResult manifestsList(String provider, String type) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("provider", provider, "form", true, false, null),
            new QueryParameterSpec("type", type, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/open_platform/manifests"), query));
        return client.convertValue(raw, new TypeReference<ManifestsListResult>() {});
    }

    /** List open platform providers */
    public ProvidersListResult providersList(String status) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("status", status, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/open_platform/providers"), query));
