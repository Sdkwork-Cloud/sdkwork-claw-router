...
public class CommerceUsageServiceProviderAdjustmentRecord {
    ...
    public String getSettledLedgerEntryId() {
        return this.settledLedgerEntryId;
    }

    public void setSettledLedgerEntryId(String settledLedgerEntryId) {
        this.settledLedgerEntryId = settledLedgerEntryId;
    }
