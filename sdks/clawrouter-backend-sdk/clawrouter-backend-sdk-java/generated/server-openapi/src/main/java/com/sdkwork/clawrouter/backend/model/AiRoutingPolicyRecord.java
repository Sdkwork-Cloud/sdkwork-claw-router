...
public class AiRoutingPolicyRecord {
    ...
    public String getSloSuccessRate() {
        return this.sloSuccessRate;
    }

    public void setSloSuccessRate(String sloSuccessRate) {
        this.sloSuccessRate = sloSuccessRate;
    }
