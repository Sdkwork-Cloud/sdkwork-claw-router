...
public class AiMemoryLinkRecord {
    ...
    private String id;
    private String injectedTextSnapshot;
    ...
    public String getInjectedTextSnapshot() {
        return this.injectedTextSnapshot;
    }

    public void setInjectedTextSnapshot(String injectedTextSnapshot) {
        this.injectedTextSnapshot = injectedTextSnapshot;
    }
    ...
    public Integer getRecallRank() {
        return this.recallRank;
    }

    public void setRecallRank(Integer recallRank) {
        this.recallRank = recallRank;
    }

    public String getRecallScore() {
        return this.recallScore;
    }

    public void setRecallScore(String recallScore) {
