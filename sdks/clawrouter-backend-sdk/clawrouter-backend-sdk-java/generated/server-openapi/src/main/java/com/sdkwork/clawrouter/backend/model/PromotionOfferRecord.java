...
public class PromotionOfferRecord {
    ...
    public String getCurrentOfferVersionId() {
        return this.currentOfferVersionId;
    }

    public void setCurrentOfferVersionId(String currentOfferVersionId) {
        this.currentOfferVersionId = currentOfferVersionId;
    }
