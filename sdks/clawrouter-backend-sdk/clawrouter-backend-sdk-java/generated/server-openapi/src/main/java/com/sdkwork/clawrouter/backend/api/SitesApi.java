...
public class SitesApi {
    ...
    public SitesApi(HttpClient client) {
        this.client = client;
    }

    /** List sites */
    public SiteCatalogListResult siteCatalogList(String q) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("q", q, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/sites"), query));
        return client.convertValue(raw, new TypeReference<SiteCatalogListResult>() {});
    }

    /** Create site */
    public SiteCreateResult siteCreate(AdminSiteCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/sites"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<SiteCreateResult>() {});
    }

    /** Delete site */
    public SiteDeleteResult siteDelete(String siteId) throws Exception {
        Object raw = client.delete(ApiPaths.backendPath("/sites/" + serializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<SiteDeleteResult>() {});
    }

    /** Update site */
    public SiteUpdateResult siteUpdate(String siteId, AdminSiteUpdateRequest body) throws Exception {
        Object raw = client.patch(ApiPaths.backendPath("/sites/" + serializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<SiteUpdateResult>() {});
    }

    /** List site channels */
    public SiteChannelsListResult siteChannelsList(String siteId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/sites/" + serializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false)) + "/channels"));
        return client.convertValue(raw, new TypeReference<SiteChannelsListResult>() {});
    }

    /** Health check site */
    public HealthCheckCreateResult healthCheckCreate(String siteId, AdminSiteActionRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/sites/" + serializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false)) + "/health_check"), body, null, null, "application/json");
    ...
    public TestConnectionCreateResult testConnectionCreate(String siteId, AdminSiteActionRequest body) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<TestConnectionCreateResult>() {});
    }
