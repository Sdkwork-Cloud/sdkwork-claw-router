...
public class CommerceUsageServiceProviderReconciliationItemRecord {
    ...
    private String providerInvoiceItemId;
    ...
    public String getProviderInvoiceItemId() {
        return this.providerInvoiceItemId;
    }

    public void setProviderInvoiceItemId(String providerInvoiceItemId) {
        this.providerInvoiceItemId = providerInvoiceItemId;
    }
