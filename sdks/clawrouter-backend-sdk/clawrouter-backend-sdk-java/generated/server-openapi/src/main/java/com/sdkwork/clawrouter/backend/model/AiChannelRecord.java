...
public class AiChannelRecord {
    ...
    private Map<String, String> credentialRotationPolicy;
    ...
    private String upstreamBalanceAmount;
    ...
    public Map<String, String> getCredentialRotationPolicy() {
        return this.credentialRotationPolicy;
    }

    public void setCredentialRotationPolicy(Map<String, String> credentialRotationPolicy) {
        this.credentialRotationPolicy = credentialRotationPolicy;
    }
