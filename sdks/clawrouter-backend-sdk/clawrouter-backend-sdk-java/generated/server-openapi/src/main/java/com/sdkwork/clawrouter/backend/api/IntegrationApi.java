...
public class IntegrationApi {
    ...
    public ProviderSecretsListResult providerSecretsList(String providerCode, String status) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("provider_code", providerCode, "form", true, false, null),
            new QueryParameterSpec("status", status, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/integration/provider_secrets"), query));
