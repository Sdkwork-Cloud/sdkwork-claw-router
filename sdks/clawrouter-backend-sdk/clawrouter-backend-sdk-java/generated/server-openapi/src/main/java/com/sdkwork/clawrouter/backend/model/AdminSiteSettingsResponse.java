...
public class AdminSiteSettingsResponse {
    ...
    public void setIcpRecordUrl(String icpRecordUrl) {
    ...
    public String getPoliceRecordUrl() {
        return this.policeRecordUrl;
    }

    public void setPoliceRecordUrl(String policeRecordUrl) {
        this.policeRecordUrl = policeRecordUrl;
    }
