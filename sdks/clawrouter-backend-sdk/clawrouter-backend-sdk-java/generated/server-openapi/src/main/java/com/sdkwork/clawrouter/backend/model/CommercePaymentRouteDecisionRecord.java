...
public class CommercePaymentRouteDecisionRecord {
    ...
    private String fallbackFromChannelId;
    private String id;
    ...
    public String getFallbackFromChannelId() {
        return this.fallbackFromChannelId;
    }

    public void setFallbackFromChannelId(String fallbackFromChannelId) {
        this.fallbackFromChannelId = fallbackFromChannelId;
    }
