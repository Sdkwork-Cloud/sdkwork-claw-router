...
class PromptsApi {
  ...
  Future<DefinitionsListResult?> definitionsList([int? page, int? pageSize, String? q, String? promptType, String? visibility, String? status, String? categoryId]) async {
    final query = buildQueryString([
      ...
      QueryParameterSpec('prompt_type', promptType, 'form', true, false, null),
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.backendPath('/prompts'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DefinitionsListResult.fromJson(map);
    })();
  }
  ...
  Future<DefinitionsCreateResult?> definitionsCreate(AdminPromptCreateRequest body, String idempotencyKey) async {
    ...
    final response = await _client.post(ApiPaths.backendPath('/prompts'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DefinitionsCreateResult.fromJson(map);
    })();
  }
  ...
  Future<DefinitionBindingsListResult?> definitionBindingsList(String promptId) async {
    final response = await _client.get(ApiPaths.backendPath('/prompts/${serializePathParameter(promptId, const PathParameterSpec('promptId', 'simple', false))}/bindings'));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DefinitionBindingsListResult.fromJson(map);
    })();
  }
  ...
  Future<DefinitionBindingsCreateResult?> definitionBindingsCreate(String promptId, AdminPromptBindingCreateRequest body, String idempotencyKey) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.backendPath('/prompts/${serializePathParameter(promptId, const PathParameterSpec('promptId', 'simple', false))}/bindings'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DefinitionBindingsCreateResult.fromJson(map);
    })();
  }

  /// List prompt versions
  Future<VersionsListResult?> versionsList(String promptId) async {
    final response = await _client.get(ApiPaths.backendPath('/prompts/${serializePathParameter(promptId, const PathParameterSpec('promptId', 'simple', false))}/versions'));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : VersionsListResult.fromJson(map);
    })();
  }
  ...
  Future<VersionsCreateResult?> versionsCreate(String promptId, AdminPromptVersionCreateRequest body, String idempotencyKey) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.backendPath('/prompts/${serializePathParameter(promptId, const PathParameterSpec('promptId', 'simple', false))}/versions'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : VersionsCreateResult.fromJson(map);
    })();
  }
}
