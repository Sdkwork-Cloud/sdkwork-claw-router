...
class McpApi {
  ...
  Future<ServersListResult?> serversList([int? page, int? pageSize, String? q, String? transport, String? visibility, String? status, String? categoryId]) async {
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.backendPath('/mcp/servers'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersListResult.fromJson(map);
    })();
  }
  ...
  Future<ServersCreateResult?> serversCreate(AdminMcpServerCreateRequest body, String idempotencyKey, [String? xRequestId]) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.backendPath('/mcp/servers'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersCreateResult.fromJson(map);
    })();
  }

  /// Retrieve MCP server
  Future<ServersRetrieveResult?> serversRetrieve(String serverId) async {
    final response = await _client.get(ApiPaths.backendPath('/mcp/servers/${serializePathParameter(serverId, const PathParameterSpec('serverId', 'simple', false))}'));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersRetrieveResult.fromJson(map);
    })();
  }
  ...
  /// List MCP bindings
  Future<ServersBindingsListResult?> serversBindingsList(String serverId) async {
    final response = await _client.get(ApiPaths.backendPath('/mcp/servers/${serializePathParameter(serverId, const PathParameterSpec('serverId', 'simple', false))}/bindings'));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersBindingsListResult.fromJson(map);
    })();
  }
  ...
  Future<ServersBindingsCreateResult?> serversBindingsCreate(String serverId, AdminMcpBindingCreateRequest body, String idempotencyKey, [String? xRequestId]) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.backendPath('/mcp/servers/${serializePathParameter(serverId, const PathParameterSpec('serverId', 'simple', false))}/bindings'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersBindingsCreateResult.fromJson(map);
    })();
  }
  ...
  Future<ServersRevisionsListResult?> serversRevisionsList(String serverId) async {
    final response = await _client.get(ApiPaths.backendPath('/mcp/servers/${serializePathParameter(serverId, const PathParameterSpec('serverId', 'simple', false))}/revisions'));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersRevisionsListResult.fromJson(map);
    })();
  }
  ...
  Future<ServersRevisionsCreateResult?> serversRevisionsCreate(String serverId, AdminMcpServerRevisionCreateRequest body, String idempotencyKey, [String? xRequestId]) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.backendPath('/mcp/servers/${serializePathParameter(serverId, const PathParameterSpec('serverId', 'simple', false))}/revisions'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersRevisionsCreateResult.fromJson(map);
    })();
  }

  /// List MCP tools
  Future<ServersToolsListResult?> serversToolsList(String serverId) async {
    final response = await _client.get(ApiPaths.backendPath('/mcp/servers/${serializePathParameter(serverId, const PathParameterSpec('serverId', 'simple', false))}/tools'));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : ServersToolsListResult.fromJson(map);
    })();
  }
