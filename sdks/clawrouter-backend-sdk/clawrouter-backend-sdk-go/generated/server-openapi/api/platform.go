...
// List apps
func (a *PlatformApi) AppsList(q *string, status *string, marketStatus *string, appType *string, page *int, pageSize *int, xRequestId *string) (sdktypes.AppsListResult, error) {
