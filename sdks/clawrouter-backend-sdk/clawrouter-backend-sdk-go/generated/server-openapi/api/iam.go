...
func (a *IamApi) ApiKeysDelete(apiKeyId string) (sdktypes.ApiKeysDeleteResult, error) {
    raw, err := a.client.Delete(BackendApiPath(fmt.Sprintf("/iam/api_keys/%s", SerializePathParameter(apiKeyId, PathParameterSpec{Name: "apiKeyId", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
