...
/** List transactions */
  async fetchTransactions(pageNo?: number, pageSize?: number, keyword?: string, status?: string, startTime?: string, endTime?: string): Promise<PlusApiResult> {
    ...
    return this.client.get<PlusApiResult>(appendQueryString(backendApiPath(`/finance/admin/ledger`), query));
  }
}
