...
import type { PlusApiResult } from '../types';
...
/** List dashboard data */
  async fetchDashboardData(pageNo?: number, pageSize?: number, keyword?: string, status?: string, startTime?: string, endTime?: string): Promise<PlusApiResult> {
    ...
    return this.client.get<PlusApiResult>(appendQueryString(backendApiPath(`/dashboard/admin/overview`), query));
  }
}
