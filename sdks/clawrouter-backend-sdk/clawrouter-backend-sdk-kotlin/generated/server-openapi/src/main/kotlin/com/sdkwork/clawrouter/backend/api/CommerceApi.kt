...
class CommerceApi(private val client: HttpClient) {
    ...
    suspend fun auditCommerceEventsList(page: Int? = null, pageSize: Int? = null, status: String? = null): AuditCommerceEventsListResult? {
    ...
    suspend fun catalogAttributesList(scope: String? = null, status: String? = null, page: Int? = null, pageSize: Int? = null): CatalogAttributesListResult? {
        val query = buildQueryString(listOf(
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/catalog/attributes"), query))
        return client.convertValue(raw, object : TypeReference<CatalogAttributesListResult>() {})
    }
    ...
    suspend fun catalogAttributesCreate(body: CommerceProductAttributeMutationRequest, idempotencyKey: String): CatalogAttributesCreateResult? {
        ...
        val raw = client.post(ApiPaths.backendPath("/catalog/attributes"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<CatalogAttributesCreateResult>() {})
    }
    ...
    suspend fun catalogCategoriesList(parentId: String? = null, status: String? = null, page: Int? = null, pageSize: Int? = null): CatalogCategoriesListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/catalog/categories"), query))
    ...
    suspend fun catalogCategoriesCreate(body: CommerceProductCategoryMutationRequest, idempotencyKey: String): CatalogCategoriesCreateResult? {
        ...
        val raw = client.post(ApiPaths.backendPath("/catalog/categories"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<CatalogCategoriesCreateResult>() {})
    }
    ...
    suspend fun catalogCategoriesUpdate(categoryId: String, body: CommerceProductCategoryMutationRequest, idempotencyKey: String): CatalogCategoriesUpdateResult? {
        ...
        val raw = client.patch(ApiPaths.backendPath("/catalog/categories/${serializePathParameter(categoryId, PathParameterSpec("categoryId", "simple", false))}"), body, null, requestHeaders, "application/json")
    ...
    suspend fun catalogPriceLists(currencyCode: String? = null, marketCode: String? = null, status: String? = null, page: Int? = null, pageSize: Int? = null): CatalogPriceListsListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/catalog/price_lists"), query))
        return client.convertValue(raw, object : TypeReference<CatalogPriceListsListResult>() {})
    }
    ...
    suspend fun catalogPriceListsCreate(body: CommercePriceListMutationRequest, idempotencyKey: String): CatalogPriceListsCreateResult? {
        ...
        val raw = client.post(ApiPaths.backendPath("/catalog/price_lists"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<CatalogPriceListsCreateResult>() {})
    }
    ...
    suspend fun catalogProductsList(q: String? = null, categoryId: String? = null, productType: String? = null, status: String? = null, page: Int? = null, pageSize: Int? = null, sort: String? = null): CatalogProductsListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/catalog/products"), query))
    ...
    suspend fun catalogProductsCreate(body: CommerceProductSpuMutationRequest, idempotencyKey: String): CatalogProductsCreateResult? {
        ...
        val raw = client.post(ApiPaths.backendPath("/catalog/products"), body, null, requestHeaders, "application/json")
    ...
    suspend fun catalogProductsUpdate(productId: String, body: CommerceProductSpuMutationRequest, idempotencyKey: String): CatalogProductsUpdateResult? {
        ...
        val raw = client.patch(ApiPaths.backendPath("/catalog/products/${serializePathParameter(productId, PathParameterSpec("productId", "simple", false))}"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<CatalogProductsUpdateResult>() {})
    }

    /** List product SKUs for admin management */
    suspend fun catalogSkusList(productId: String? = null, fulfillmentType: String? = null, status: String? = null, page: Int? = null, pageSize: Int? = null): CatalogSkusListResult? {
        val query = buildQueryString(listOf(
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/catalog/skus"), query))
        return client.convertValue(raw, object : TypeReference<CatalogSkusListResult>() {})
    }
    ...
    suspend fun catalogSkusUpdate(skuId: String, body: CommerceProductSkuMutationRequest, idempotencyKey: String): CatalogSkusUpdateResult? {
        ...
        val raw = client.patch(ApiPaths.backendPath("/catalog/skus/${serializePathParameter(skuId, PathParameterSpec("skuId", "simple", false))}"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<CatalogSkusUpdateResult>() {})
    }

    /** Commerce Reports Order Revenue List */
    suspend fun reportsOrderRevenueList(page: Int? = null, pageSize: Int? = null, status: String? = null): CommerceReportsOrderRevenueListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    suspend fun reportsRefundsList(page: Int? = null, pageSize: Int? = null, status: String? = null): CommerceReportsRefundsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    suspend fun inventoryLedgerEntriesList(skuId: String? = null, warehouseId: String? = null, sourceType: String? = null, sourceId: String? = null, page: Int? = null, pageSize: Int? = null): InventoryLedgerEntriesListResult? {
        val query = buildQueryString(listOf(
    ...
    suspend fun inventoryReservationsList(skuId: String? = null, orderId: String? = null, checkoutSessionId: String? = null, status: String? = null, page: Int? = null, pageSize: Int? = null): InventoryReservationsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("sku_id", skuId, "form", true, false, null),
    ...
    suspend fun inventoryStocksList(skuId: String? = null, warehouseId: String? = null, status: String? = null, page: Int? = null, pageSize: Int? = null): InventoryStocksListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("sku_id", skuId, "form", true, false, null),
            QueryParameterSpec("warehouse_id", warehouseId, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null),
    ...
    suspend fun invoicesTitlesList(page: Int? = null, pageSize: Int? = null, status: String? = null): InvoicesTitlesListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    suspend fun membershipsEntitlementsList(page: Int? = null, pageSize: Int? = null, planId: String? = null, membershipId: String? = null, status: String? = null): MembershipsEntitlementsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
    ...
    suspend fun membershipsMembersList(page: Int? = null, pageSize: Int? = null, cursor: String? = null, userId: String? = null, planId: String? = null, status: String? = null): MembershipsMembersListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
    ...
    suspend fun membershipsPackageGroupsList(page: Int? = null, pageSize: Int? = null, status: String? = null): MembershipsPackageGroupsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    suspend fun membershipsPackagesList(page: Int? = null, pageSize: Int? = null, packageGroupId: String? = null, planId: String? = null, status: String? = null): MembershipsPackagesListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
    ...
    suspend fun membershipsPlansList(page: Int? = null, pageSize: Int? = null, status: String? = null): MembershipsPlansListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    suspend fun paymentsAttemptsList(intentId: String? = null, providerCode: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null): PaymentsAttemptsListResult? {
        val query = buildQueryString(listOf(
    ...
    suspend fun paymentsChannelsList(providerAccountId: String? = null, methodCode: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null): PaymentsChannelsListResult? {
        val query = buildQueryString(listOf(
    ...
    suspend fun paymentsIntentsList(orderId: String? = null, providerCode: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null): PaymentsIntentsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("order_id", orderId, "form", true, false, null),
            QueryParameterSpec("provider_code", providerCode, "form", true, false, null),
            QueryParameterSpec("page", page, "form", true, false, null),
    ...
    suspend fun paymentsProviderAccountsList(providerCode: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null): PaymentsProviderAccountsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("provider_code", providerCode, "form", true, false, null),
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
    ...
    suspend fun paymentsReconciliationRunsList(providerCode: String? = null, businessDate: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null): PaymentsReconciliationRunsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("provider_code", providerCode, "form", true, false, null),
    ...
    suspend fun paymentsRouteRulesList(methodCode: String? = null, countryCode: String? = null, currencyCode: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null): PaymentsRouteRulesListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("method_code", methodCode, "form", true, false, null),
    ...
    suspend fun paymentsWebhookEventsList(providerCode: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null): PaymentsWebhookEventsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("provider_code", providerCode, "form", true, false, null),
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
    ...
    suspend fun rechargesOrdersList(page: Int? = null, pageSize: Int? = null, status: String? = null): RechargesOrdersListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    /** Shipments List */
    suspend fun shipmentsList(page: Int? = null, pageSize: Int? = null, status: String? = null): ShipmentsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    suspend fun shipmentsTrackingEventsList(shipmentId: String, page: Int? = null, pageSize: Int? = null, status: String? = null): ShipmentsTrackingEventsListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
    ...
    suspend fun walletExchangeRulesList(page: Int? = null, pageSize: Int? = null, status: String? = null): WalletExchangeRulesListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("status", status, "form", true, false, null)
