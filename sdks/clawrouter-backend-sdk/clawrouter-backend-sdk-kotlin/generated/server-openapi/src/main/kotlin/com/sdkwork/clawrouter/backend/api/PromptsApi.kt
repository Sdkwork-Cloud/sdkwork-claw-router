...
class PromptsApi(private val client: HttpClient) {
    ...
    suspend fun definitionsList(page: Int? = null, pageSize: Int? = null, q: String? = null, promptType: String? = null, visibility: String? = null, status: String? = null, categoryId: String? = null): DefinitionsListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/prompts"), query))
        return client.convertValue(raw, object : TypeReference<DefinitionsListResult>() {})
    }
    ...
    suspend fun definitionsCreate(body: AdminPromptCreateRequest, idempotencyKey: String): DefinitionsCreateResult? {
        ...
        val raw = client.post(ApiPaths.backendPath("/prompts"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<DefinitionsCreateResult>() {})
    }
    ...
    suspend fun definitionBindingsList(promptId: String): DefinitionBindingsListResult? {
        val raw = client.get(ApiPaths.backendPath("/prompts/${serializePathParameter(promptId, PathParameterSpec("promptId", "simple", false))}/bindings"))
        return client.convertValue(raw, object : TypeReference<DefinitionBindingsListResult>() {})
    }
    ...
    suspend fun definitionBindingsCreate(promptId: String, body: AdminPromptBindingCreateRequest, idempotencyKey: String): DefinitionBindingsCreateResult? {
        ...
        val raw = client.post(ApiPaths.backendPath("/prompts/${serializePathParameter(promptId, PathParameterSpec("promptId", "simple", false))}/bindings"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<DefinitionBindingsCreateResult>() {})
    }

    /** List prompt versions */
    suspend fun versionsList(promptId: String): VersionsListResult? {
        val raw = client.get(ApiPaths.backendPath("/prompts/${serializePathParameter(promptId, PathParameterSpec("promptId", "simple", false))}/versions"))
        return client.convertValue(raw, object : TypeReference<VersionsListResult>() {})
    }
    ...
    suspend fun versionsCreate(promptId: String, body: AdminPromptVersionCreateRequest, idempotencyKey: String): VersionsCreateResult? {
        ...
        val raw = client.post(ApiPaths.backendPath("/prompts/${serializePathParameter(promptId, PathParameterSpec("promptId", "simple", false))}/versions"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<VersionsCreateResult>() {})
    }
