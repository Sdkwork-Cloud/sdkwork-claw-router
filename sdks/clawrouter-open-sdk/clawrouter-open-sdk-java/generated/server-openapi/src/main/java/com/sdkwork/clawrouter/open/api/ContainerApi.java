...
public class ContainerApi {
    ...
    public ContainerApi(HttpClient client) {
        this.client = client;
    }

    /** List containers */
    public OpenAiContainerList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/containers"), query));
        return client.convertValue(raw, new TypeReference<OpenAiContainerList>() {});
    }

    /** Create container */
    public OpenAiContainer create(OpenAiContainerCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/containers"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiContainer>() {});
    }

    /** Delete container */
    public DeleteResult delete(String containerId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/containers/" + serializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve container */
    public OpenAiContainer retrieve(String containerId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/containers/" + serializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiContainer>() {});
    }

    /** List container files */
    public OpenAiContainerFileList listFiles(String containerId, Integer limit, String order, String after, String before) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("limit", limit, "form", true, false, null),
            new QueryParameterSpec("order", order, "form", true, false, null),
            new QueryParameterSpec("after", after, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/containers/" + serializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false)) + "/files"), query));
        return client.convertValue(raw, new TypeReference<OpenAiContainerFileList>() {});
    }

    /** Create container file */
    public OpenAiContainerFile createFile(String containerId, OpenAiContainerFileCreateMultipartRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/containers/" + serializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false)) + "/files"), body, null, null, "multipart/form-data");
        return client.convertValue(raw, new TypeReference<OpenAiContainerFile>() {});
    }

    /** Delete container file */
    public DeleteResult deleteFiles(String containerId, String fileId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/containers/" + serializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false)) + "/files/" + serializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }
