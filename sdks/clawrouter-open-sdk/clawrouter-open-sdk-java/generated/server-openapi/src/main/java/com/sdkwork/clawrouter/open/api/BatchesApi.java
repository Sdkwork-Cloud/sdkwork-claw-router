...
public class BatchesApi {
    ...
    public OpenAiBatchList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/batches"), query));
        return client.convertValue(raw, new TypeReference<OpenAiBatchList>() {});
    }

    /** Create batch */
    public OpenAiBatch create(OpenAiBatchCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/batches"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiBatch>() {});
    }

    /** Retrieve batch */
    public OpenAiBatch retrieve(String batchId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/batches/" + serializePathParameter(batchId, new PathParameterSpec("batch_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiBatch>() {});
    }

    /** Cancel batch */
    public OpenAiBatch cancel(String batchId) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/batches/" + serializePathParameter(batchId, new PathParameterSpec("batch_id", "simple", false)) + "/cancel"), null);
        return client.convertValue(raw, new TypeReference<OpenAiBatch>() {});
    }
