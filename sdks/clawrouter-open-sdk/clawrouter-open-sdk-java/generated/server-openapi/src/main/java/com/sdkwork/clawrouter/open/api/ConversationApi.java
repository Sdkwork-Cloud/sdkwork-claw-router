...
public class ConversationApi {
    ...
    /** List conversations */
    public OpenAiConversationList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/conversations"), query));
        return client.convertValue(raw, new TypeReference<OpenAiConversationList>() {});
    }

    /** Create conversation */
    public OpenAiConversation create(OpenAiConversationCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/conversations"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiConversation>() {});
    }

    /** Delete conversation */
    public DeleteResult delete(String conversationId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve conversation */
    public OpenAiConversation retrieve(String conversationId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiConversation>() {});
    }

    /** Modify conversation */
    public OpenAiConversation update(String conversationId, OpenAiConversationUpdateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiConversation>() {});
    }

    /** List conversation items */
    public OpenAiConversationItemList listItems(String conversationId, Integer limit, String order, String after, String before) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("limit", limit, "form", true, false, null),
            new QueryParameterSpec("order", order, "form", true, false, null),
            new QueryParameterSpec("after", after, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false)) + "/items"), query));
        return client.convertValue(raw, new TypeReference<OpenAiConversationItemList>() {});
    }

    /** Create conversation item */
    public OpenAiConversationItem createItem(String conversationId, OpenAiConversationItemCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false)) + "/items"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiConversationItem>() {});
    }

    /** Delete conversation item */
    public DeleteResult deleteItems(String conversationId, String itemId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false)) + "/items/" + serializePathParameter(itemId, new PathParameterSpec("item_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }
