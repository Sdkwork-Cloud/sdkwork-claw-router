...
public class AssistantsApi {
    ...
    /** List assistants */
    public OpenAiAssistantList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/assistants"), query));
        return client.convertValue(raw, new TypeReference<OpenAiAssistantList>() {});
    }

    /** Create assistant */
    public OpenAiAssistant create(OpenAiAssistantCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/assistants"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiAssistant>() {});
    }

    /** Delete assistant */
    public DeleteResult delete(String assistantId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/assistants/" + serializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve assistant */
    public OpenAiAssistant retrieve(String assistantId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/assistants/" + serializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiAssistant>() {});
    }

    /** Modify assistant */
    public OpenAiAssistant update(String assistantId, OpenAiAssistantUpdateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/assistants/" + serializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiAssistant>() {});
    }
