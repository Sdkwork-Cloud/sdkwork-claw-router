...
public class FilesApi {
    ...
    /** List files */
    public OpenAiFileList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/files"), query));
        return client.convertValue(raw, new TypeReference<OpenAiFileList>() {});
    }

    /** Upload file */
    public OpenAiFile create(OpenAiFileUploadRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/files"), body, null, null, "multipart/form-data");
        return client.convertValue(raw, new TypeReference<OpenAiFile>() {});
    }

    /** Delete file */
    public DeleteResult delete(String fileId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/files/" + serializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve file */
    public OpenAiFile retrieve(String fileId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/files/" + serializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiFile>() {});
    }
