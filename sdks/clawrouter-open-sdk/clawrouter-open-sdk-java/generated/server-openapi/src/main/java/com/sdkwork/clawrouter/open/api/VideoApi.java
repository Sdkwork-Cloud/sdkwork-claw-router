...
public class VideoApi {
    ...
    /** List videos */
    public OpenAiVideoList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/videos"), query));
        return client.convertValue(raw, new TypeReference<OpenAiVideoList>() {});
    }

    /** Create video */
    public OpenAiVideo create(OpenAiVideoCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/videos"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiVideo>() {});
    }

    /** Create video character */
    public OpenAiVideoCharacter createCharacter(OpenAiVideoCharacterCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/videos/characters"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiVideoCharacter>() {});
    }

    /** Retrieve video character */
    public OpenAiVideoCharacter listCharacters(String characterId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/videos/characters/" + serializePathParameter(characterId, new PathParameterSpec("character_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiVideoCharacter>() {});
    }

    /** Edit video */
    public OpenAiVideo createEdit(OpenAiVideoEditRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/videos/edits"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiVideo>() {});
    }

    /** Extend video */
    public OpenAiVideo createExtension(OpenAiVideoExtendRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/videos/extensions"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiVideo>() {});
    }

    /** Delete video */
    public DeleteResult delete(String videoId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/videos/" + serializePathParameter(videoId, new PathParameterSpec("video_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve video */
    public OpenAiVideo retrieve(String videoId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/videos/" + serializePathParameter(videoId, new PathParameterSpec("video_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiVideo>() {});
    }
    ...
    /** Remix video */
    public OpenAiVideo createRemix(String videoId, OpenAiVideoRemixRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/videos/" + serializePathParameter(videoId, new PathParameterSpec("video_id", "simple", false)) + "/remix"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiVideo>() {});
    }
