...
public class ProjectApi {
    ...
    public OpenAiRoleAssignmentList listGroupsRoles(String projectId, String groupId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/groups/" + serializePathParameter(groupId, new PathParameterSpec("group_id", "simple", false)) + "/roles"), query));
        return client.convertValue(raw, new TypeReference<OpenAiRoleAssignmentList>() {});
    }

    /** Create project group role */
    public OpenAiRoleAssignment createGroupsRole(String projectId, String groupId, OpenAiRoleAssignmentCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/groups/" + serializePathParameter(groupId, new PathParameterSpec("group_id", "simple", false)) + "/roles"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiRoleAssignment>() {});
    }

    /** Delete project group role */
    public DeleteResult deleteGroupsRoles(String projectId, String groupId, String roleId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/groups/" + serializePathParameter(groupId, new PathParameterSpec("group_id", "simple", false)) + "/roles/" + serializePathParameter(roleId, new PathParameterSpec("role_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** List project roles */
    public OpenAiRoleList listRoles(String projectId, Integer limit, String order, String after, String before) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("limit", limit, "form", true, false, null),
            new QueryParameterSpec("order", order, "form", true, false, null),
            new QueryParameterSpec("after", after, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/roles"), query));
        return client.convertValue(raw, new TypeReference<OpenAiRoleList>() {});
    }

    /** Create project role */
    public OpenAiRole createRole(String projectId, OpenAiRoleCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/roles"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiRole>() {});
    }

    /** Delete project role */
    public DeleteResult deleteRoles(String projectId, String roleId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/roles/" + serializePathParameter(roleId, new PathParameterSpec("role_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** List project user roles */
    public OpenAiRoleAssignmentList listUsersRoles(String projectId, String userId, Integer limit, String order, String after, String before) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("limit", limit, "form", true, false, null),
            new QueryParameterSpec("order", order, "form", true, false, null),
            new QueryParameterSpec("after", after, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/users/" + serializePathParameter(userId, new PathParameterSpec("user_id", "simple", false)) + "/roles"), query));
        return client.convertValue(raw, new TypeReference<OpenAiRoleAssignmentList>() {});
    }

    /** Create project user role */
    public OpenAiRoleAssignment createUsersRole(String projectId, String userId, OpenAiRoleAssignmentCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/users/" + serializePathParameter(userId, new PathParameterSpec("user_id", "simple", false)) + "/roles"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiRoleAssignment>() {});
    }

    /** Delete project user role */
    public DeleteResult deleteUsersRoles(String projectId, String userId, String roleId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/projects/" + serializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false)) + "/users/" + serializePathParameter(userId, new PathParameterSpec("user_id", "simple", false)) + "/roles/" + serializePathParameter(roleId, new PathParameterSpec("role_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }
