...
public class FineTuningApi {
    ...
    public OpenAiFineTuningGraderRunResult createRun(OpenAiFineTuningGraderRunRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/fine_tuning/alpha/graders/run"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningGraderRunResult>() {});
    }

    /** Validate fine-tuning grader */
    public OpenAiFineTuningGraderValidationResult createValidate(OpenAiFineTuningGraderValidateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/fine_tuning/alpha/graders/validate"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningGraderValidationResult>() {});
    }
    ...
    public OpenAiFineTuningCheckpointPermissionList retrievePermission(String fineTunedModelCheckpoint, Integer limit, String order, String after, String before, String projectId) throws Exception {
        String query = buildQueryString(List.of(
            ...
            new QueryParameterSpec("project_id", projectId, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/fine_tuning/checkpoints/" + serializePathParameter(fineTunedModelCheckpoint, new PathParameterSpec("fine_tuned_model_checkpoint", "simple", false)) + "/permissions"), query));
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningCheckpointPermissionList>() {});
    }

    /** Create fine-tuning checkpoint permission */
    public OpenAiFineTuningCheckpointPermission createPermission(String fineTunedModelCheckpoint, OpenAiFineTuningCheckpointPermissionCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/fine_tuning/checkpoints/" + serializePathParameter(fineTunedModelCheckpoint, new PathParameterSpec("fine_tuned_model_checkpoint", "simple", false)) + "/permissions"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningCheckpointPermission>() {});
    }

    /** Delete fine-tuning checkpoint permission */
    public DeleteResult deletePermission(String fineTunedModelCheckpoint, String permissionId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/fine_tuning/checkpoints/" + serializePathParameter(fineTunedModelCheckpoint, new PathParameterSpec("fine_tuned_model_checkpoint", "simple", false)) + "/permissions/" + serializePathParameter(permissionId, new PathParameterSpec("permission_id", "simple", false)) + ""));
    ...
    public OpenAiFineTuningJobList listJob(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/fine_tuning/jobs"), query));
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJobList>() {});
    }

    /** Create fine-tuning job */
    public OpenAiFineTuningJob createJob(OpenAiFineTuningJobCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/fine_tuning/jobs"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJob>() {});
    }

    /** Retrieve fine-tuning job */
    public OpenAiFineTuningJob retrieveJob(String fineTuningJobId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/fine_tuning/jobs/" + serializePathParameter(fineTuningJobId, new PathParameterSpec("fine_tuning_job_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJob>() {});
    }

    /** Cancel fine-tuning job */
    public OpenAiFineTuningJob createCancel(String fineTuningJobId) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/fine_tuning/jobs/" + serializePathParameter(fineTuningJobId, new PathParameterSpec("fine_tuning_job_id", "simple", false)) + "/cancel"), null);
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJob>() {});
    }
    ...
    public OpenAiFineTuningJobCheckpointList retrieveCheckpoint(String fineTuningJobId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/fine_tuning/jobs/" + serializePathParameter(fineTuningJobId, new PathParameterSpec("fine_tuning_job_id", "simple", false)) + "/checkpoints"), query));
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJobCheckpointList>() {});
    }
    ...
    public OpenAiFineTuningJobEventList retrieveEvent(String fineTuningJobId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/fine_tuning/jobs/" + serializePathParameter(fineTuningJobId, new PathParameterSpec("fine_tuning_job_id", "simple", false)) + "/events"), query));
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJobEventList>() {});
    }

    /** Pause fine-tuning job */
    public OpenAiFineTuningJob createPause(String fineTuningJobId) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/fine_tuning/jobs/" + serializePathParameter(fineTuningJobId, new PathParameterSpec("fine_tuning_job_id", "simple", false)) + "/pause"), null);
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJob>() {});
    }

    /** Resume fine-tuning job */
    public OpenAiFineTuningJob createResume(String fineTuningJobId) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/fine_tuning/jobs/" + serializePathParameter(fineTuningJobId, new PathParameterSpec("fine_tuning_job_id", "simple", false)) + "/resume"), null);
        return client.convertValue(raw, new TypeReference<OpenAiFineTuningJob>() {});
    }
