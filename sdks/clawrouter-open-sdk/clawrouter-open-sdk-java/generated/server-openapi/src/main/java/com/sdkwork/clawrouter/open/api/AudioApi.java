...
public class AudioApi {
    ...
    public OpenAiAudioTranscription createTranscription(OpenAiAudioTranscriptionRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/audio/transcriptions"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiAudioTranscription>() {});
    }

    /** Create translation */
    public OpenAiAudioTranslation createTranslation(OpenAiAudioTranslationRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/audio/translations"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiAudioTranslation>() {});
    }
    ...
    public OpenAiVoiceConsentList listVoiceConsents(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/audio/voice_consents"), query));
        return client.convertValue(raw, new TypeReference<OpenAiVoiceConsentList>() {});
    }

    /** Create voice consent */
    public OpenAiVoiceConsent createVoiceConsent(OpenAiVoiceConsentCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/audio/voice_consents"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiVoiceConsent>() {});
    }

    /** Delete voice consent */
    public DeleteResult deleteVoiceConsents(String consentId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/audio/voice_consents/" + serializePathParameter(consentId, new PathParameterSpec("consent_id", "simple", false)) + ""));
    ...
    public OpenAiVoiceList listVoices(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/audio/voices"), query));
        return client.convertValue(raw, new TypeReference<OpenAiVoiceList>() {});
    }

    /** Create voice */
    public OpenAiVoice createVoice(OpenAiVoiceCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/audio/voices"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiVoice>() {});
    }
