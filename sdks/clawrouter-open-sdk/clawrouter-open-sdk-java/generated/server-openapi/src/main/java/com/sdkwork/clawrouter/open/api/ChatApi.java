...
public class ChatApi {
    ...
    public OpenAiChatCompletionList list(Integer limit, String order, String after, String before, String model, String metadata) throws Exception {
        String query = buildQueryString(List.of(
            ...
            new QueryParameterSpec("metadata", metadata, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/chat/completions"), query));
        return client.convertValue(raw, new TypeReference<OpenAiChatCompletionList>() {});
    }

    /** Create chat completion */
    public OpenAiChatCompletion create(OpenAiChatCompletionRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/chat/completions"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiChatCompletion>() {});
    }

    /** Delete stored chat completion */
    public DeleteResult delete(String completionId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/chat/completions/" + serializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve stored chat completion */
    public OpenAiChatCompletion retrieve(String completionId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/chat/completions/" + serializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiChatCompletion>() {});
    }

    /** Modify stored chat completion */
    public OpenAiChatCompletion update(String completionId, OpenAiChatCompletionUpdateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/chat/completions/" + serializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiChatCompletion>() {});
    }

    /** List stored chat completion messages */
    public OpenAiChatCompletionMessageList listMessages(String completionId, Integer limit, String order, String after, String before) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("limit", limit, "form", true, false, null),
            new QueryParameterSpec("order", order, "form", true, false, null),
            new QueryParameterSpec("after", after, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/chat/completions/" + serializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false)) + "/messages"), query));
        return client.convertValue(raw, new TypeReference<OpenAiChatCompletionMessageList>() {});
    }
