...
public class FilesAnthropicApi {
    private final HttpClient client;
    
    public FilesAnthropicApi(HttpClient client) {
        this.client = client;
    }

    /** Anthropic list files */
    public AnthropicFileListResponse listV1Files(String beforeId, String afterId, Integer limit) throws Exception {
