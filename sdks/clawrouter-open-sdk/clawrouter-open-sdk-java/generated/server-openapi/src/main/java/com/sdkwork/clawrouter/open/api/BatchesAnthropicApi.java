...
public class BatchesAnthropicApi {
    ...
    public BatchesAnthropicApi(HttpClient client) {
        this.client = client;
    }

    /** Anthropic list message batches */
    public AnthropicMessageBatchListResponse listV1MessagesBatches(String beforeId, String afterId, Integer limit) throws Exception {
