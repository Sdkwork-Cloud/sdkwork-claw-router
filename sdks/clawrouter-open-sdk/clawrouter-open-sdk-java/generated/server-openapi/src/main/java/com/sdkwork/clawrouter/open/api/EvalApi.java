...
public class EvalApi {
    ...
    public EvalApi(HttpClient client) {
        this.client = client;
    }
    ...
    public OpenAiEvalList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals"), query));
        return client.convertValue(raw, new TypeReference<OpenAiEvalList>() {});
    }

    /** Create eval */
    public OpenAiEval create(OpenAiEvalCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/evals"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiEval>() {});
    }

    /** Delete eval */
    public DeleteResult delete(String evalId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/evals/" + serializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve eval */
    public OpenAiEval retrieve(String evalId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/evals/" + serializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiEval>() {});
    }

    /** Modify eval */
    public OpenAiEval update(String evalId, OpenAiEvalUpdateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/evals/" + serializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiEval>() {});
    }
    ...
    public OpenAiEvalRunList listRuns(String evalId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals/" + serializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false)) + "/runs"), query));
        return client.convertValue(raw, new TypeReference<OpenAiEvalRunList>() {});
    }

    /** Create eval run */
    public OpenAiEvalRun createRun(String evalId, OpenAiEvalRunCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/evals/" + serializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false)) + "/runs"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiEvalRun>() {});
    }

    /** Delete eval run */
    public DeleteResult deleteRuns(String evalId, String runId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/evals/" + serializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false)) + "/runs/" + serializePathParameter(runId, new PathParameterSpec("run_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }
    ...
    public OpenAiEvalRunOutputItemList listRunsOutputItems(String evalId, String runId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals/" + serializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false)) + "/runs/" + serializePathParameter(runId, new PathParameterSpec("run_id", "simple", false)) + "/output_items"), query));
        return client.convertValue(raw, new TypeReference<OpenAiEvalRunOutputItemList>() {});
    }
