...
public class ThreadsApi {
    ...
    /** Create thread */
    public OpenAiThread create(OpenAiThreadCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/threads"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiThread>() {});
    }

    /** Create thread and run */
    public OpenAiRun createRun(OpenAiThreadAndRunCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/threads/runs"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiRun>() {});
    }

    /** Delete thread */
    public DeleteResult delete(String threadId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve thread */
    public OpenAiThread retrieve(String threadId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiThread>() {});
    }

    /** Modify thread */
    public OpenAiThread update(String threadId, OpenAiThreadUpdateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiThread>() {});
    }
    ...
    public OpenAiThreadMessageList listMessages(String threadId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + "/messages"), query));
        return client.convertValue(raw, new TypeReference<OpenAiThreadMessageList>() {});
    }

    /** Create thread message */
    public OpenAiThreadMessage createMessage(String threadId, OpenAiThreadMessageCreateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + "/messages"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiThreadMessage>() {});
    }

    /** Delete thread message */
    public DeleteResult deleteMessages(String threadId, String messageId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + "/messages/" + serializePathParameter(messageId, new PathParameterSpec("message_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }
    ...
    public OpenAiRunList listRuns(String threadId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + "/runs"), query));
        return client.convertValue(raw, new TypeReference<OpenAiRunList>() {});
    }

    /** Cancel thread run */
    public OpenAiRun createRunsCancel(String threadId, String runId) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + "/runs/" + serializePathParameter(runId, new PathParameterSpec("run_id", "simple", false)) + "/cancel"), null);
        return client.convertValue(raw, new TypeReference<OpenAiRun>() {});
    }
    ...
    public OpenAiRunStepList listRunsSteps(String threadId, String runId, Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + "/runs/" + serializePathParameter(runId, new PathParameterSpec("run_id", "simple", false)) + "/steps"), query));
        return client.convertValue(raw, new TypeReference<OpenAiRunStepList>() {});
    }

    /** Submit run tool outputs */
    public OpenAiRun createRunsSubmitToolOutput(String threadId, String runId, OpenAiRunSubmitToolOutputsRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/threads/" + serializePathParameter(threadId, new PathParameterSpec("thread_id", "simple", false)) + "/runs/" + serializePathParameter(runId, new PathParameterSpec("run_id", "simple", false)) + "/submit_tool_outputs"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiRun>() {});
    }
