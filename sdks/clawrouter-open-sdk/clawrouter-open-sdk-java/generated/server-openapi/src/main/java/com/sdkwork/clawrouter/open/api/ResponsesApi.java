...
public class ResponsesApi {
    ...
    /** Create response */
    public OpenAiResponse create(OpenAiResponsesRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/responses"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiResponse>() {});
    }

    /** Compact response */
    public OpenAiResponse compact(OpenAiResponseCompactRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/responses/compact"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiResponse>() {});
    }

    /** Count response input tokens */
    public OpenAiResponseInputTokenCount createInputToken(OpenAiResponseInputTokenCountRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/responses/input_tokens"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiResponseInputTokenCount>() {});
    }

    /** Delete response */
    public DeleteResult delete(String responseId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/responses/" + serializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve response */
    public OpenAiResponse retrieve(String responseId, List<String> include) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("include[]", include, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/responses/" + serializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false)) + ""), query));
        return client.convertValue(raw, new TypeReference<OpenAiResponse>() {});
    }

    /** Cancel response */
    public OpenAiResponse cancel(String responseId) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/responses/" + serializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false)) + "/cancel"), null);
        return client.convertValue(raw, new TypeReference<OpenAiResponse>() {});
    }

    /** List response input items */
    public OpenAiResponseInputItemList listInputItems(String responseId, Integer limit, String order, String after, String before, List<String> include) throws Exception {
        String query = buildQueryString(List.of(
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/responses/" + serializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false)) + "/input_items"), query));
        return client.convertValue(raw, new TypeReference<OpenAiResponseInputItemList>() {});
    }
