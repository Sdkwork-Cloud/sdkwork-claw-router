...
public class SkillApi {
    ...
    /** List skills */
    public OpenAiSkillList list(Integer limit, String order, String after, String before) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/skills"), query));
        return client.convertValue(raw, new TypeReference<OpenAiSkillList>() {});
    }

    /** Create skill */
    public OpenAiSkill create(OpenAiSkillCreateMultipartRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/skills"), body, null, null, "multipart/form-data");
        return client.convertValue(raw, new TypeReference<OpenAiSkill>() {});
    }

    /** Delete skill */
    public DeleteResult delete(String skillId) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve skill */
    public OpenAiSkill retrieve(String skillId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<OpenAiSkill>() {});
    }

    /** Modify skill */
    public OpenAiSkill update(String skillId, OpenAiSkillUpdateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenAiSkill>() {});
    }

    /** Retrieve skill content */
    public String content(String skillId) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + "/content"));
        return client.convertValue(raw, new TypeReference<String>() {});
    }

    /** List skill versions */
    public OpenAiSkillVersionList listVersions(String skillId, Integer limit, String order, String after, String before) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("limit", limit, "form", true, false, null),
            new QueryParameterSpec("order", order, "form", true, false, null),
            new QueryParameterSpec("after", after, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + "/versions"), query));
        return client.convertValue(raw, new TypeReference<OpenAiSkillVersionList>() {});
    }

    /** Create skill version */
    public OpenAiSkillVersion createVersion(String skillId, OpenAiSkillVersionCreateMultipartRequest body) throws Exception {
        Object raw = client.post(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + "/versions"), body, null, null, "multipart/form-data");
        return client.convertValue(raw, new TypeReference<OpenAiSkillVersion>() {});
    }

    /** Delete skill version */
    public DeleteResult deleteVersions(String skillId, String version) throws Exception {
        Object raw = client.delete(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + "/versions/" + serializePathParameter(version, new PathParameterSpec("version", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DeleteResult>() {});
    }

    /** Retrieve skill version content */
    public String listVersionsContent(String skillId, String version) throws Exception {
        Object raw = client.get(ApiPaths.aiPath("/skills/" + serializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false)) + "/versions/" + serializePathParameter(version, new PathParameterSpec("version", "simple", false)) + "/content"));
        return client.convertValue(raw, new TypeReference<String>() {});
    }
