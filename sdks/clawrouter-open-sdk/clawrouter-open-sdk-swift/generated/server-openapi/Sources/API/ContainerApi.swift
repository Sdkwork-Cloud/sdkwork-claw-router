...
public class ContainerApi {
    ...
    /// List containers
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiContainerList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/containers"), query), responseType: OpenAiContainerList.self)
    }

    /// Create container
    public func create(body: OpenAiContainerCreateRequest) async throws -> OpenAiContainer? {
        return try await client.post(ApiPaths.aiPath("/containers"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiContainer.self)
    }

    /// Delete container
    public func delete(containerId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/containers/\(serializePathParameter(containerId, PathParameterSpec(name: "container_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve container
    public func retrieve(containerId: String) async throws -> OpenAiContainer? {
        return try await client.get(ApiPaths.aiPath("/containers/\(serializePathParameter(containerId, PathParameterSpec(name: "container_id", style: "simple", explode: false)))"), responseType: OpenAiContainer.self)
    }

    /// List container files
    public func listFiles(containerId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiContainerFileList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/containers/\(serializePathParameter(containerId, PathParameterSpec(name: "container_id", style: "simple", explode: false)))/files"), query), responseType: OpenAiContainerFileList.self)
    }

    /// Create container file
    public func createFile(containerId: String, body: OpenAiContainerFileCreateMultipartRequest) async throws -> OpenAiContainerFile? {
        return try await client.post(ApiPaths.aiPath("/containers/\(serializePathParameter(containerId, PathParameterSpec(name: "container_id", style: "simple", explode: false)))/files"), body: body, params: nil, headers: nil, contentType: "multipart/form-data", responseType: OpenAiContainerFile.self)
    }

    /// Delete container file
    public func deleteFiles(containerId: String, fileId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/containers/\(serializePathParameter(containerId, PathParameterSpec(name: "container_id", style: "simple", explode: false)))/files/\(serializePathParameter(fileId, PathParameterSpec(name: "file_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve container file content
    public func listFilesContent(containerId: String, fileId: String) async throws -> String? {
        return try await client.get(ApiPaths.aiPath("/containers/\(serializePathParameter(containerId, PathParameterSpec(name: "container_id", style: "simple", explode: false)))/files/\(serializePathParameter(fileId, PathParameterSpec(name: "file_id", style: "simple", explode: false)))/content"), responseType: String.self)
    }
