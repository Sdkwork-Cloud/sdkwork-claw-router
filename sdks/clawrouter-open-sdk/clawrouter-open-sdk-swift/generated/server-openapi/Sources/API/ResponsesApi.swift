...
public class ResponsesApi {
    ...
    /// Create response
    public func create(body: OpenAiResponsesRequest) async throws -> OpenAiResponse? {
        return try await client.post(ApiPaths.aiPath("/responses"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiResponse.self)
    }

    /// Compact response
    public func compact(body: OpenAiResponseCompactRequest) async throws -> OpenAiResponse? {
        return try await client.post(ApiPaths.aiPath("/responses/compact"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiResponse.self)
    }

    /// Count response input tokens
    public func createInputToken(body: OpenAiResponseInputTokenCountRequest) async throws -> OpenAiResponseInputTokenCount? {
        return try await client.post(ApiPaths.aiPath("/responses/input_tokens"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiResponseInputTokenCount.self)
    }

    /// Delete response
    public func delete(responseId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/responses/\(serializePathParameter(responseId, PathParameterSpec(name: "response_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve response
    public func retrieve(responseId: String, include: [String]? = nil) async throws -> OpenAiResponse? {
        let query = buildQueryString([
            QueryParameterSpec(name: "include[]", value: include, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/responses/\(serializePathParameter(responseId, PathParameterSpec(name: "response_id", style: "simple", explode: false)))"), query), responseType: OpenAiResponse.self)
    }

    /// Cancel response
    public func cancel(responseId: String) async throws -> OpenAiResponse? {
        return try await client.post(ApiPaths.aiPath("/responses/\(serializePathParameter(responseId, PathParameterSpec(name: "response_id", style: "simple", explode: false)))/cancel"), body: nil, responseType: OpenAiResponse.self)
    }

    /// List response input items
    public func listInputItems(responseId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil, include: [String]? = nil) async throws -> OpenAiResponseInputItemList? {
        let query = buildQueryString([
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/responses/\(serializePathParameter(responseId, PathParameterSpec(name: "response_id", style: "simple", explode: false)))/input_items"), query), responseType: OpenAiResponseInputItemList.self)
    }
