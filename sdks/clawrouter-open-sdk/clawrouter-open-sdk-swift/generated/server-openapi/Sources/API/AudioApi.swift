...
public class AudioApi {
    ...
    /// Create speech
    public func createSpeech(body: OpenAiSpeechCreateRequest) async throws -> String? {
        return try await client.post(ApiPaths.aiPath("/audio/speech"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: String.self)
    }

    /// Create transcription
    public func createTranscription(body: OpenAiAudioTranscriptionRequest) async throws -> OpenAiAudioTranscription? {
        return try await client.post(ApiPaths.aiPath("/audio/transcriptions"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiAudioTranscription.self)
    }

    /// Create translation
    public func createTranslation(body: OpenAiAudioTranslationRequest) async throws -> OpenAiAudioTranslation? {
        return try await client.post(ApiPaths.aiPath("/audio/translations"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiAudioTranslation.self)
    }

    /// List voice consents
    public func listVoiceConsents(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiVoiceConsentList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/audio/voice_consents"), query), responseType: OpenAiVoiceConsentList.self)
    }

    /// Create voice consent
    public func createVoiceConsent(body: OpenAiVoiceConsentCreateRequest) async throws -> OpenAiVoiceConsent? {
        return try await client.post(ApiPaths.aiPath("/audio/voice_consents"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVoiceConsent.self)
    }

    /// Delete voice consent
    public func deleteVoiceConsents(consentId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/audio/voice_consents/\(serializePathParameter(consentId, PathParameterSpec(name: "consent_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// List voices
    public func listVoices(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiVoiceList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/audio/voices"), query), responseType: OpenAiVoiceList.self)
    }

    /// Create voice
    public func createVoice(body: OpenAiVoiceCreateRequest) async throws -> OpenAiVoice? {
        return try await client.post(ApiPaths.aiPath("/audio/voices"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVoice.self)
    }
