...
public class EvalApi {
    ...
    /// List evals
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiEvalList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals"), query), responseType: OpenAiEvalList.self)
    }

    /// Create eval
    public func create(body: OpenAiEvalCreateRequest) async throws -> OpenAiEval? {
        return try await client.post(ApiPaths.aiPath("/evals"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiEval.self)
    }

    /// Delete eval
    public func delete(evalId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/evals/\(serializePathParameter(evalId, PathParameterSpec(name: "eval_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve eval
    public func retrieve(evalId: String) async throws -> OpenAiEval? {
        return try await client.get(ApiPaths.aiPath("/evals/\(serializePathParameter(evalId, PathParameterSpec(name: "eval_id", style: "simple", explode: false)))"), responseType: OpenAiEval.self)
    }

    /// Modify eval
    public func update(evalId: String, body: OpenAiEvalUpdateRequest) async throws -> OpenAiEval? {
        return try await client.post(ApiPaths.aiPath("/evals/\(serializePathParameter(evalId, PathParameterSpec(name: "eval_id", style: "simple", explode: false)))"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiEval.self)
    }

    /// List eval runs
    public func listRuns(evalId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiEvalRunList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals/\(serializePathParameter(evalId, PathParameterSpec(name: "eval_id", style: "simple", explode: false)))/runs"), query), responseType: OpenAiEvalRunList.self)
    }

    /// Create eval run
    public func createRun(evalId: String, body: OpenAiEvalRunCreateRequest) async throws -> OpenAiEvalRun? {
        return try await client.post(ApiPaths.aiPath("/evals/\(serializePathParameter(evalId, PathParameterSpec(name: "eval_id", style: "simple", explode: false)))/runs"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiEvalRun.self)
    }

    /// Delete eval run
    public func deleteRuns(evalId: String, runId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/evals/\(serializePathParameter(evalId, PathParameterSpec(name: "eval_id", style: "simple", explode: false)))/runs/\(serializePathParameter(runId, PathParameterSpec(name: "run_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// List eval run output items
    public func listRunsOutputItems(evalId: String, runId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiEvalRunOutputItemList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals/\(serializePathParameter(evalId, PathParameterSpec(name: "eval_id", style: "simple", explode: false)))/runs/\(serializePathParameter(runId, PathParameterSpec(name: "run_id", style: "simple", explode: false)))/output_items"), query), responseType: OpenAiEvalRunOutputItemList.self)
    }
