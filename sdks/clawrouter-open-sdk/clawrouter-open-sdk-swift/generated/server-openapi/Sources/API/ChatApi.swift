...
public class ChatApi {
    ...
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil, model: String? = nil, metadata: String? = nil) async throws -> OpenAiChatCompletionList? {
        let query = buildQueryString([
            ...
            QueryParameterSpec(name: "metadata", value: metadata, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/chat/completions"), query), responseType: OpenAiChatCompletionList.self)
    }

    /// Create chat completion
    public func create(body: OpenAiChatCompletionRequest) async throws -> OpenAiChatCompletion? {
        return try await client.post(ApiPaths.aiPath("/chat/completions"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiChatCompletion.self)
    }

    /// Delete stored chat completion
    public func delete(completionId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/chat/completions/\(serializePathParameter(completionId, PathParameterSpec(name: "completion_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve stored chat completion
    public func retrieve(completionId: String) async throws -> OpenAiChatCompletion? {
        return try await client.get(ApiPaths.aiPath("/chat/completions/\(serializePathParameter(completionId, PathParameterSpec(name: "completion_id", style: "simple", explode: false)))"), responseType: OpenAiChatCompletion.self)
    }

    /// Modify stored chat completion
    public func update(completionId: String, body: OpenAiChatCompletionUpdateRequest) async throws -> OpenAiChatCompletion? {
        return try await client.post(ApiPaths.aiPath("/chat/completions/\(serializePathParameter(completionId, PathParameterSpec(name: "completion_id", style: "simple", explode: false)))"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiChatCompletion.self)
    }

    /// List stored chat completion messages
    public func listMessages(completionId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiChatCompletionMessageList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/chat/completions/\(serializePathParameter(completionId, PathParameterSpec(name: "completion_id", style: "simple", explode: false)))/messages"), query), responseType: OpenAiChatCompletionMessageList.self)
    }
