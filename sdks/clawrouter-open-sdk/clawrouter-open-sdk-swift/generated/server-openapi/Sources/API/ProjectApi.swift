...
public class ProjectApi {
    ...
    public func listGroupsRoles(projectId: String, groupId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiRoleAssignmentList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/groups/\(serializePathParameter(groupId, PathParameterSpec(name: "group_id", style: "simple", explode: false)))/roles"), query), responseType: OpenAiRoleAssignmentList.self)
    }

    /// Create project group role
    public func createGroupsRole(projectId: String, groupId: String, body: OpenAiRoleAssignmentCreateRequest) async throws -> OpenAiRoleAssignment? {
        return try await client.post(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/groups/\(serializePathParameter(groupId, PathParameterSpec(name: "group_id", style: "simple", explode: false)))/roles"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiRoleAssignment.self)
    }

    /// Delete project group role
    public func deleteGroupsRoles(projectId: String, groupId: String, roleId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/groups/\(serializePathParameter(groupId, PathParameterSpec(name: "group_id", style: "simple", explode: false)))/roles/\(serializePathParameter(roleId, PathParameterSpec(name: "role_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// List project roles
    public func listRoles(projectId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiRoleList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/roles"), query), responseType: OpenAiRoleList.self)
    }

    /// Create project role
    public func createRole(projectId: String, body: OpenAiRoleCreateRequest) async throws -> OpenAiRole? {
        return try await client.post(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/roles"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiRole.self)
    }

    /// Delete project role
    public func deleteRoles(projectId: String, roleId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/roles/\(serializePathParameter(roleId, PathParameterSpec(name: "role_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// List project user roles
    public func listUsersRoles(projectId: String, userId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiRoleAssignmentList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/users/\(serializePathParameter(userId, PathParameterSpec(name: "user_id", style: "simple", explode: false)))/roles"), query), responseType: OpenAiRoleAssignmentList.self)
    }

    /// Create project user role
    public func createUsersRole(projectId: String, userId: String, body: OpenAiRoleAssignmentCreateRequest) async throws -> OpenAiRoleAssignment? {
        return try await client.post(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/users/\(serializePathParameter(userId, PathParameterSpec(name: "user_id", style: "simple", explode: false)))/roles"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiRoleAssignment.self)
    }

    /// Delete project user role
    public func deleteUsersRoles(projectId: String, userId: String, roleId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/projects/\(serializePathParameter(projectId, PathParameterSpec(name: "project_id", style: "simple", explode: false)))/users/\(serializePathParameter(userId, PathParameterSpec(name: "user_id", style: "simple", explode: false)))/roles/\(serializePathParameter(roleId, PathParameterSpec(name: "role_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }
