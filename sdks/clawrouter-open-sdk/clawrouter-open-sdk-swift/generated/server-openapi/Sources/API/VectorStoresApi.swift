...
public class VectorStoresApi {
    ...
    /// List vector stores
    public func listVectorStore(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiVectorStoreList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/vector_stores"), query), responseType: OpenAiVectorStoreList.self)
    }

    /// Create vector store
    public func createVectorStore(body: OpenAiVectorStoreCreateRequest) async throws -> OpenAiVectorStore? {
        return try await client.post(ApiPaths.aiPath("/vector_stores"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVectorStore.self)
    }

    /// Delete vector store
    public func deleteVectorStore(vectorStoreId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve vector store
    public func retrieveVectorStore(vectorStoreId: String) async throws -> OpenAiVectorStore? {
        return try await client.get(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))"), responseType: OpenAiVectorStore.self)
    }

    /// Create vector store file batch
    public func createFileBatch(vectorStoreId: String, body: OpenAiVectorStoreFileBatchCreateRequest) async throws -> OpenAiVectorStoreFileBatch? {
        return try await client.post(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))/file_batches"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVectorStoreFileBatch.self)
    }

    /// Retrieve vector store file batch
    public func retrieveFileBatch(vectorStoreId: String, batchId: String) async throws -> OpenAiVectorStoreFileBatch? {
        return try await client.get(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))/file_batches/\(serializePathParameter(batchId, PathParameterSpec(name: "batch_id", style: "simple", explode: false)))"), responseType: OpenAiVectorStoreFileBatch.self)
    }

    /// Cancel vector store file batch
    public func createCancel(vectorStoreId: String, batchId: String) async throws -> OpenAiVectorStoreFileBatch? {
        return try await client.post(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))/file_batches/\(serializePathParameter(batchId, PathParameterSpec(name: "batch_id", style: "simple", explode: false)))/cancel"), body: nil, responseType: OpenAiVectorStoreFileBatch.self)
    }

    /// List vector store files
    public func retrieveFile(vectorStoreId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiVectorStoreFileList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))/files"), query), responseType: OpenAiVectorStoreFileList.self)
    }

    /// Create vector store file
    public func createFile(vectorStoreId: String, body: OpenAiVectorStoreFileCreateRequest) async throws -> OpenAiVectorStoreFile? {
        return try await client.post(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))/files"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVectorStoreFile.self)
    }

    /// Delete vector store file
    public func deleteFile(vectorStoreId: String, fileId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))/files/\(serializePathParameter(fileId, PathParameterSpec(name: "file_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Search vector store
    public func createSearch(vectorStoreId: String, body: OpenAiVectorStoreSearchRequest) async throws -> OpenAiVectorStoreSearchResponse? {
        return try await client.post(ApiPaths.aiPath("/vector_stores/\(serializePathParameter(vectorStoreId, PathParameterSpec(name: "vector_store_id", style: "simple", explode: false)))/search"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVectorStoreSearchResponse.self)
    }
