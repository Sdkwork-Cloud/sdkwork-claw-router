...
public class SkillApi {
    ...
    /// List skills
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiSkillList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/skills"), query), responseType: OpenAiSkillList.self)
    }

    /// Create skill
    public func create(body: OpenAiSkillCreateMultipartRequest) async throws -> OpenAiSkill? {
        return try await client.post(ApiPaths.aiPath("/skills"), body: body, params: nil, headers: nil, contentType: "multipart/form-data", responseType: OpenAiSkill.self)
    }

    /// Delete skill
    public func delete(skillId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve skill
    public func retrieve(skillId: String) async throws -> OpenAiSkill? {
        return try await client.get(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))"), responseType: OpenAiSkill.self)
    }

    /// Modify skill
    public func update(skillId: String, body: OpenAiSkillUpdateRequest) async throws -> OpenAiSkill? {
        return try await client.post(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiSkill.self)
    }

    /// Retrieve skill content
    public func content(skillId: String) async throws -> String? {
        return try await client.get(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))/content"), responseType: String.self)
    }

    /// List skill versions
    public func listVersions(skillId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiSkillVersionList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))/versions"), query), responseType: OpenAiSkillVersionList.self)
    }

    /// Create skill version
    public func createVersion(skillId: String, body: OpenAiSkillVersionCreateMultipartRequest) async throws -> OpenAiSkillVersion? {
        return try await client.post(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))/versions"), body: body, params: nil, headers: nil, contentType: "multipart/form-data", responseType: OpenAiSkillVersion.self)
    }

    /// Delete skill version
    public func deleteVersions(skillId: String, version: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))/versions/\(serializePathParameter(version, PathParameterSpec(name: "version", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve skill version content
    public func listVersionsContent(skillId: String, version: String) async throws -> String? {
        return try await client.get(ApiPaths.aiPath("/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skill_id", style: "simple", explode: false)))/versions/\(serializePathParameter(version, PathParameterSpec(name: "version", style: "simple", explode: false)))/content"), responseType: String.self)
    }
