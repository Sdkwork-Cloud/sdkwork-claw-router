...
public class ConversationApi {
    ...
    /// List conversations
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiConversationList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/conversations"), query), responseType: OpenAiConversationList.self)
    }

    /// Create conversation
    public func create(body: OpenAiConversationCreateRequest) async throws -> OpenAiConversation? {
        return try await client.post(ApiPaths.aiPath("/conversations"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiConversation.self)
    }

    /// Delete conversation
    public func delete(conversationId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversation_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve conversation
    public func retrieve(conversationId: String) async throws -> OpenAiConversation? {
        return try await client.get(ApiPaths.aiPath("/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversation_id", style: "simple", explode: false)))"), responseType: OpenAiConversation.self)
    }

    /// Modify conversation
    public func update(conversationId: String, body: OpenAiConversationUpdateRequest) async throws -> OpenAiConversation? {
        return try await client.post(ApiPaths.aiPath("/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversation_id", style: "simple", explode: false)))"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiConversation.self)
    }

    /// List conversation items
    public func listItems(conversationId: String, limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiConversationItemList? {
        let query = buildQueryString([
            QueryParameterSpec(name: "limit", value: limit, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "order", value: order, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "after", value: after, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversation_id", style: "simple", explode: false)))/items"), query), responseType: OpenAiConversationItemList.self)
    }

    /// Create conversation item
    public func createItem(conversationId: String, body: OpenAiConversationItemCreateRequest) async throws -> OpenAiConversationItem? {
        return try await client.post(ApiPaths.aiPath("/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversation_id", style: "simple", explode: false)))/items"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiConversationItem.self)
    }

    /// Delete conversation item
    public func deleteItems(conversationId: String, itemId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversation_id", style: "simple", explode: false)))/items/\(serializePathParameter(itemId, PathParameterSpec(name: "item_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }
