...
public class VideoApi {
    ...
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiVideoList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/videos"), query), responseType: OpenAiVideoList.self)
    }

    /// Create video
    public func create(body: OpenAiVideoCreateRequest) async throws -> OpenAiVideo? {
        return try await client.post(ApiPaths.aiPath("/videos"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVideo.self)
    }

    /// Create video character
    public func createCharacter(body: OpenAiVideoCharacterCreateRequest) async throws -> OpenAiVideoCharacter? {
        return try await client.post(ApiPaths.aiPath("/videos/characters"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVideoCharacter.self)
    }

    /// Retrieve video character
    public func listCharacters(characterId: String) async throws -> OpenAiVideoCharacter? {
        return try await client.get(ApiPaths.aiPath("/videos/characters/\(serializePathParameter(characterId, PathParameterSpec(name: "character_id", style: "simple", explode: false)))"), responseType: OpenAiVideoCharacter.self)
    }

    /// Edit video
    public func createEdit(body: OpenAiVideoEditRequest) async throws -> OpenAiVideo? {
        return try await client.post(ApiPaths.aiPath("/videos/edits"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVideo.self)
    }

    /// Extend video
    public func createExtension(body: OpenAiVideoExtendRequest) async throws -> OpenAiVideo? {
        return try await client.post(ApiPaths.aiPath("/videos/extensions"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVideo.self)
    }

    /// Delete video
    public func delete(videoId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/videos/\(serializePathParameter(videoId, PathParameterSpec(name: "video_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve video
    public func retrieve(videoId: String) async throws -> OpenAiVideo? {
        return try await client.get(ApiPaths.aiPath("/videos/\(serializePathParameter(videoId, PathParameterSpec(name: "video_id", style: "simple", explode: false)))"), responseType: OpenAiVideo.self)
    }

    /// Retrieve video content
    public func content(videoId: String) async throws -> String? {
        return try await client.get(ApiPaths.aiPath("/videos/\(serializePathParameter(videoId, PathParameterSpec(name: "video_id", style: "simple", explode: false)))/content"), responseType: String.self)
    }

    /// Remix video
    public func createRemix(videoId: String, body: OpenAiVideoRemixRequest) async throws -> OpenAiVideo? {
        return try await client.post(ApiPaths.aiPath("/videos/\(serializePathParameter(videoId, PathParameterSpec(name: "video_id", style: "simple", explode: false)))/remix"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiVideo.self)
    }
