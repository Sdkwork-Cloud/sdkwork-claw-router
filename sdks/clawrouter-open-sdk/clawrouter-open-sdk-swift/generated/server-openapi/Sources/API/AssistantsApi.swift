...
public class AssistantsApi {
    ...
    /// List assistants
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiAssistantList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/assistants"), query), responseType: OpenAiAssistantList.self)
    }

    /// Create assistant
    public func create(body: OpenAiAssistantCreateRequest) async throws -> OpenAiAssistant? {
        return try await client.post(ApiPaths.aiPath("/assistants"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiAssistant.self)
    }

    /// Delete assistant
    public func delete(assistantId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/assistants/\(serializePathParameter(assistantId, PathParameterSpec(name: "assistant_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve assistant
    public func retrieve(assistantId: String) async throws -> OpenAiAssistant? {
        return try await client.get(ApiPaths.aiPath("/assistants/\(serializePathParameter(assistantId, PathParameterSpec(name: "assistant_id", style: "simple", explode: false)))"), responseType: OpenAiAssistant.self)
    }

    /// Modify assistant
    public func update(assistantId: String, body: OpenAiAssistantUpdateRequest) async throws -> OpenAiAssistant? {
        return try await client.post(ApiPaths.aiPath("/assistants/\(serializePathParameter(assistantId, PathParameterSpec(name: "assistant_id", style: "simple", explode: false)))"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiAssistant.self)
    }
