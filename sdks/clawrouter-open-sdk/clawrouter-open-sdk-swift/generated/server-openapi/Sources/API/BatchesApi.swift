...
public class BatchesApi {
    ...
    /// List batches
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiBatchList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/batches"), query), responseType: OpenAiBatchList.self)
    }

    /// Create batch
    public func create(body: OpenAiBatchCreateRequest) async throws -> OpenAiBatch? {
        return try await client.post(ApiPaths.aiPath("/batches"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: OpenAiBatch.self)
    }

    /// Retrieve batch
    public func retrieve(batchId: String) async throws -> OpenAiBatch? {
        return try await client.get(ApiPaths.aiPath("/batches/\(serializePathParameter(batchId, PathParameterSpec(name: "batch_id", style: "simple", explode: false)))"), responseType: OpenAiBatch.self)
    }

    /// Cancel batch
    public func cancel(batchId: String) async throws -> OpenAiBatch? {
        return try await client.post(ApiPaths.aiPath("/batches/\(serializePathParameter(batchId, PathParameterSpec(name: "batch_id", style: "simple", explode: false)))/cancel"), body: nil, responseType: OpenAiBatch.self)
    }
