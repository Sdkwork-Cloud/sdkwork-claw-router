...
public class FilesApi {
    ...
    /// List files
    public func list(limit: Int? = nil, order: String? = nil, after: String? = nil, before: String? = nil) async throws -> OpenAiFileList? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/files"), query), responseType: OpenAiFileList.self)
    }

    /// Upload file
    public func create(body: OpenAiFileUploadRequest) async throws -> OpenAiFile? {
        return try await client.post(ApiPaths.aiPath("/files"), body: body, params: nil, headers: nil, contentType: "multipart/form-data", responseType: OpenAiFile.self)
    }

    /// Delete file
    public func delete(fileId: String) async throws -> DeleteResult? {
        return try await client.delete(ApiPaths.aiPath("/files/\(serializePathParameter(fileId, PathParameterSpec(name: "file_id", style: "simple", explode: false)))"), responseType: DeleteResult.self)
    }

    /// Retrieve file
    public func retrieve(fileId: String) async throws -> OpenAiFile? {
        return try await client.get(ApiPaths.aiPath("/files/\(serializePathParameter(fileId, PathParameterSpec(name: "file_id", style: "simple", explode: false)))"), responseType: OpenAiFile.self)
    }

    /// Retrieve file content
    public func content(fileId: String) async throws -> String? {
        return try await client.get(ApiPaths.aiPath("/files/\(serializePathParameter(fileId, PathParameterSpec(name: "file_id", style: "simple", explode: false)))/content"), responseType: String.self)
    }
