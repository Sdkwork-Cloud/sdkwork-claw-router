...
/// Item module returned inside the listMessages list response.
#[derive(Serialize, Deserialize, Debug, Clone, Default)]
pub struct ListMessagesItem {
    ...
    /// Usage field on the list messages item, using the open ai token usage module.
    #[serde(default, skip_serializing_if = "Option::is_none")]
