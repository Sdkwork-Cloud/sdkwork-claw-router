...
from ..models import AnthropicDeleteResponse, AnthropicFile, AnthropicFileListResponse, AnthropicFileUploadMultipartRequest
...
class FilesAnthropicApi:
    """files_anthropic API client."""
    
    def __init__(self, client: HttpClient):
        self._client = client

    def list_v1_files(self, before_id: Optional[str] = None, after_id: Optional[str] = None, limit: Optional[int] = None) -> AnthropicFileListResponse:
        """Anthropic list files"""
        query = build_query_string([
            {'name': 'before_id', 'value': before_id, 'style': 'form', 'explode': True, 'allow_reserved': False},
    ...
    def list_v1_files_content(self, file_id: str) -> str:
        """Anthropic retrieve file content"""
        return self._client.get(f"/v1/anthropic/v1/files/{serialize_path_parameter(file_id, {'name': 'file_id', 'style': 'simple', 'explode': False})}/content")
