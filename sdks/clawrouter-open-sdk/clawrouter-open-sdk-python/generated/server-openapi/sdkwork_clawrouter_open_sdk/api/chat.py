...
from ..models import DeleteResult, OpenAiChatCompletion, OpenAiChatCompletionList, OpenAiChatCompletionMessageList, OpenAiChatCompletionRequest, OpenAiChatCompletionUpdateRequest
...
class ChatApi:
    ...
    def list(self, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None, model: Optional[str] = None, metadata: Optional[str] = None) -> OpenAiChatCompletionList:
        ...
        query = build_query_string([
            ...
            {'name': 'metadata', 'value': metadata, 'style': 'form', 'explode': True, 'allow_reserved': False},
        ])
        return self._client.get(_append_query_string(f"/v1/chat/completions", query))

    def create(self, body: OpenAiChatCompletionRequest) -> OpenAiChatCompletion:
        """Create chat completion"""
        return self._client.post(f"/v1/chat/completions", json=body)

    def delete(self, completion_id: str) -> DeleteResult:
        """Delete stored chat completion"""
        return self._client.delete(f"/v1/chat/completions/{serialize_path_parameter(completion_id, {'name': 'completion_id', 'style': 'simple', 'explode': False})}")

    def retrieve(self, completion_id: str) -> OpenAiChatCompletion:
        """Retrieve stored chat completion"""
        return self._client.get(f"/v1/chat/completions/{serialize_path_parameter(completion_id, {'name': 'completion_id', 'style': 'simple', 'explode': False})}")

    def update(self, completion_id: str, body: OpenAiChatCompletionUpdateRequest) -> OpenAiChatCompletion:
        """Modify stored chat completion"""
        return self._client.post(f"/v1/chat/completions/{serialize_path_parameter(completion_id, {'name': 'completion_id', 'style': 'simple', 'explode': False})}", json=body)
    ...
    def list_messages(self, completion_id: str, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None) -> OpenAiChatCompletionMessageList:
        ...
        return self._client.get(_append_query_string(f"/v1/chat/completions/{serialize_path_parameter(completion_id, {'name': 'completion_id', 'style': 'simple', 'explode': False})}/messages", query))
