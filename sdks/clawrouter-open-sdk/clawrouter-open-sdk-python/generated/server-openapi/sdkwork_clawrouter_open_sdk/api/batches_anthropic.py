...
from ..models import AnthropicMessageBatch, AnthropicMessageBatchCreateRequest, AnthropicMessageBatchListResponse
...
class BatchesAnthropicApi:
    """batches_anthropic API client."""
    
    def __init__(self, client: HttpClient):
        self._client = client

    def list_v1_messages_batches(self, before_id: Optional[str] = None, after_id: Optional[str] = None, limit: Optional[int] = None) -> AnthropicMessageBatchListResponse:
