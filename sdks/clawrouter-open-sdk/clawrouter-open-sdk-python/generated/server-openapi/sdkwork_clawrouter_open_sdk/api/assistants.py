...
from ..models import DeleteResult, OpenAiAssistant, OpenAiAssistantCreateRequest, OpenAiAssistantList, OpenAiAssistantUpdateRequest
...
class AssistantsApi:
    ...
    def list(self, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None) -> OpenAiAssistantList:
        ...
        return self._client.get(_append_query_string(f"/v1/assistants", query))

    def create(self, body: OpenAiAssistantCreateRequest) -> OpenAiAssistant:
        """Create assistant"""
        return self._client.post(f"/v1/assistants", json=body)

    def delete(self, assistant_id: str) -> DeleteResult:
        """Delete assistant"""
        return self._client.delete(f"/v1/assistants/{serialize_path_parameter(assistant_id, {'name': 'assistant_id', 'style': 'simple', 'explode': False})}")

    def retrieve(self, assistant_id: str) -> OpenAiAssistant:
        """Retrieve assistant"""
        return self._client.get(f"/v1/assistants/{serialize_path_parameter(assistant_id, {'name': 'assistant_id', 'style': 'simple', 'explode': False})}")

    def update(self, assistant_id: str, body: OpenAiAssistantUpdateRequest) -> OpenAiAssistant:
        """Modify assistant"""
        return self._client.post(f"/v1/assistants/{serialize_path_parameter(assistant_id, {'name': 'assistant_id', 'style': 'simple', 'explode': False})}", json=body)
