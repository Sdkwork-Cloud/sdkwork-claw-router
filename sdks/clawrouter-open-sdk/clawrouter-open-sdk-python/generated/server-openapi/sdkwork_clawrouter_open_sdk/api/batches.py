...
from ..models import OpenAiBatch, OpenAiBatchCreateRequest, OpenAiBatchList
...
class BatchesApi:
    ...
    def list(self, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None) -> OpenAiBatchList:
        """List batches"""
        ...
        return self._client.get(_append_query_string(f"/v1/batches", query))

    def create(self, body: OpenAiBatchCreateRequest) -> OpenAiBatch:
        """Create batch"""
        return self._client.post(f"/v1/batches", json=body)

    def retrieve(self, batch_id: str) -> OpenAiBatch:
        """Retrieve batch"""
        return self._client.get(f"/v1/batches/{serialize_path_parameter(batch_id, {'name': 'batch_id', 'style': 'simple', 'explode': False})}")

    def cancel(self, batch_id: str) -> OpenAiBatch:
        """Cancel batch"""
        return self._client.post(f"/v1/batches/{serialize_path_parameter(batch_id, {'name': 'batch_id', 'style': 'simple', 'explode': False})}/cancel")
