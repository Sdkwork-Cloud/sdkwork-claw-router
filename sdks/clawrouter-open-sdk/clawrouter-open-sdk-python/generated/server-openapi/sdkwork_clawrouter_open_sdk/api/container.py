...
from ..models import DeleteResult, OpenAiContainer, OpenAiContainerCreateRequest, OpenAiContainerFile, OpenAiContainerFileCreateMultipartRequest, OpenAiContainerFileList, OpenAiContainerList
...
class ContainerApi:
    ...
    def list(self, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None) -> OpenAiContainerList:
        """List containers"""
        ...
        return self._client.get(_append_query_string(f"/v1/containers", query))

    def create(self, body: OpenAiContainerCreateRequest) -> OpenAiContainer:
        """Create container"""
        return self._client.post(f"/v1/containers", json=body)

    def delete(self, container_id: str) -> DeleteResult:
        """Delete container"""
        return self._client.delete(f"/v1/containers/{serialize_path_parameter(container_id, {'name': 'container_id', 'style': 'simple', 'explode': False})}")

    def retrieve(self, container_id: str) -> OpenAiContainer:
        """Retrieve container"""
        return self._client.get(f"/v1/containers/{serialize_path_parameter(container_id, {'name': 'container_id', 'style': 'simple', 'explode': False})}")

    def list_files(self, container_id: str, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None) -> OpenAiContainerFileList:
        ...
        return self._client.get(_append_query_string(f"/v1/containers/{serialize_path_parameter(container_id, {'name': 'container_id', 'style': 'simple', 'explode': False})}/files", query))

    def create_file(self, container_id: str, body: OpenAiContainerFileCreateMultipartRequest) -> OpenAiContainerFile:
        """Create container file"""
        return self._client.post(f"/v1/containers/{serialize_path_parameter(container_id, {'name': 'container_id', 'style': 'simple', 'explode': False})}/files", data=body)

    def delete_files(self, container_id: str, file_id: str) -> DeleteResult:
