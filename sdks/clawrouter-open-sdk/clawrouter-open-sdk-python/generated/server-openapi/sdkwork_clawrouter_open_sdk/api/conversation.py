...
from ..models import DeleteResult, OpenAiConversation, OpenAiConversationCreateRequest, OpenAiConversationItem, OpenAiConversationItemCreateRequest, OpenAiConversationItemList, OpenAiConversationList, OpenAiConversationUpdateRequest
...
class ConversationApi:
    ...
    def list(self, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None) -> OpenAiConversationList:
        ...
        return self._client.get(_append_query_string(f"/v1/conversations", query))

    def create(self, body: OpenAiConversationCreateRequest) -> OpenAiConversation:
        """Create conversation"""
        return self._client.post(f"/v1/conversations", json=body)

    def delete(self, conversation_id: str) -> DeleteResult:
        """Delete conversation"""
        return self._client.delete(f"/v1/conversations/{serialize_path_parameter(conversation_id, {'name': 'conversation_id', 'style': 'simple', 'explode': False})}")

    def retrieve(self, conversation_id: str) -> OpenAiConversation:
        """Retrieve conversation"""
        return self._client.get(f"/v1/conversations/{serialize_path_parameter(conversation_id, {'name': 'conversation_id', 'style': 'simple', 'explode': False})}")

    def update(self, conversation_id: str, body: OpenAiConversationUpdateRequest) -> OpenAiConversation:
        """Modify conversation"""
        return self._client.post(f"/v1/conversations/{serialize_path_parameter(conversation_id, {'name': 'conversation_id', 'style': 'simple', 'explode': False})}", json=body)
    ...
    def list_items(self, conversation_id: str, limit: Optional[int] = None, order: Optional[str] = None, after: Optional[str] = None, before: Optional[str] = None) -> OpenAiConversationItemList:
        ...
        return self._client.get(_append_query_string(f"/v1/conversations/{serialize_path_parameter(conversation_id, {'name': 'conversation_id', 'style': 'simple', 'explode': False})}/items", query))

    def create_item(self, conversation_id: str, body: OpenAiConversationItemCreateRequest) -> OpenAiConversationItem:
        """Create conversation item"""
        return self._client.post(f"/v1/conversations/{serialize_path_parameter(conversation_id, {'name': 'conversation_id', 'style': 'simple', 'explode': False})}/items", json=body)

    def delete_items(self, conversation_id: str, item_id: str) -> DeleteResult:
        """Delete conversation item"""
        return self._client.delete(f"/v1/conversations/{serialize_path_parameter(conversation_id, {'name': 'conversation_id', 'style': 'simple', 'explode': False})}/items/{serialize_path_parameter(item_id, {'name': 'item_id', 'style': 'simple', 'explode': False})}")
