...
from ..models import GoogleBatchEmbedContentsRequest, GoogleBatchEmbedContentsResponse, GoogleEmbedContentRequest, GoogleEmbedContentResponse
...
class EmbeddingsGoogleApi:
    """embeddings_google API client."""
