...
/** Item module returned inside the listChatCompletionMessages list response. */
export interface ListChatCompletionMessagesItem {
  ...
  status?: string;
  /** Usage field on the list chat completion messages item, using the open ai token usage module. */
