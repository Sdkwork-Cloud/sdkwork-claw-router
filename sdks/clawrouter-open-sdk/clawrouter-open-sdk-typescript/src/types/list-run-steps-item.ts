...
/** Item module returned inside the listRunSteps list response. */
export interface ListRunStepsItem {
  ...
  status?: string;
  /** Usage field on the list run steps item, using the open ai token usage module. */
