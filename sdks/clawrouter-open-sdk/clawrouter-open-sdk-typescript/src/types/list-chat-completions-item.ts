...
/** Item module returned inside the listChatCompletions list response. */
export interface ListChatCompletionsItem {
  ...
  status?: string;
  /** Usage field on the list chat completions item, using the open ai token usage module. */
