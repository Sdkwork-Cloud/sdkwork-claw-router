...
class SystemApi(private val client: HttpClient) {
    ...
    suspend fun promotionsDiscountApplicationsCreate(body: PromotionCommandRequest, idempotencyKey: String): PromotionsDiscountApplicationsCreateResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/promotions/discount_applications"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<PromotionsDiscountApplicationsCreateResult>() {})
    }
    ...
    suspend fun promotionsDiscountApplicationsReversalsCreate(body: PromotionCommandRequest, idempotencyKey: String): PromotionsDiscountApplicationsReversalsCreateResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/promotions/discount_applications/reversals"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<PromotionsDiscountApplicationsReversalsCreateResult>() {})
    }
    ...
    suspend fun promotionsDiscountApplicationsRelease(applicationId: String, body: PromotionCommandRequest, idempotencyKey: String): PromotionsDiscountApplicationsReleaseResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/promotions/discount_applications/${serializePathParameter(applicationId, PathParameterSpec("applicationId", "simple", false))}/releases"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<PromotionsDiscountApplicationsReleaseResult>() {})
    }
    ...
    suspend fun siteRuntimeRetrieve(tenantCode: String? = null, organizationCode: String? = null): SiteRuntimeRetrieveResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/system/site/runtime"), query))
