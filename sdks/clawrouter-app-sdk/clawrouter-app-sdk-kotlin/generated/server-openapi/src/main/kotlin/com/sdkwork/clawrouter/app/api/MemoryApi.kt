...
class MemoryApi(private val client: HttpClient) {

    /** Retrieve memory entry */
    suspend fun entriesRetrieve(entryId: String): EntriesRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/memory/entries/${serializePathParameter(entryId, PathParameterSpec("entryId", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<EntriesRetrieveResult>() {})
    }
    ...
    suspend fun spacesList(page: String? = null, pageSize: String? = null): SpacesListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/memory/spaces"), query))
        return client.convertValue(raw, object : TypeReference<SpacesListResult>() {})
    }
    ...
    suspend fun spacesCreate(body: MemorySpaceCreateRequest, idempotencyKey: String): SpacesCreateResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/memory/spaces"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<SpacesCreateResult>() {})
    }

    /** Retrieve memory space */
    suspend fun spacesRetrieve(spaceId: String): SpacesRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/memory/spaces/${serializePathParameter(spaceId, PathParameterSpec("spaceId", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<SpacesRetrieveResult>() {})
    }
    ...
    suspend fun entriesList(spaceId: String, page: String? = null, pageSize: String? = null): EntriesListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/memory/spaces/${serializePathParameter(spaceId, PathParameterSpec("spaceId", "simple", false))}/entries"), query))
        return client.convertValue(raw, object : TypeReference<EntriesListResult>() {})
    }
    ...
    suspend fun entriesCreate(spaceId: String, body: MemoryEntryCreateRequest, idempotencyKey: String): EntriesCreateResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/memory/spaces/${serializePathParameter(spaceId, PathParameterSpec("spaceId", "simple", false))}/entries"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<EntriesCreateResult>() {})
    }
