...
class ChatApi(private val client: HttpClient) {
    ...
    suspend fun conversationsList(page: Int? = null, pageSize: Int? = null): ConversationsListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/chat/conversations"), query))
    ...
    suspend fun conversationsCreate(body: ChatConversationCreateRequest, idempotencyKey: String): ConversationsCreateResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/chat/conversations"), body, null, requestHeaders, "application/json")
    ...
    suspend fun conversationMessagesList(conversationId: String, limit: Int? = null, order: String? = null): ConversationMessagesListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/chat/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversationId", "simple", false))}/messages"), query))
    ...
    suspend fun turnsCreate(conversationId: String, body: ChatTurnCreateRequest, idempotencyKey: String): TurnsCreateResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/chat/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversationId", "simple", false))}/turns"), body, null, requestHeaders, "application/json")
    ...
    suspend fun turnResponsesCreate(conversationId: String, turnId: String, body: ChatTurnResponseRequest, idempotencyKey: String): TurnResponsesCreateResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/chat/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversationId", "simple", false))}/turns/${serializePathParameter(turnId, PathParameterSpec("turnId", "simple", false))}/response"), body, null, requestHeaders, "application/json")
