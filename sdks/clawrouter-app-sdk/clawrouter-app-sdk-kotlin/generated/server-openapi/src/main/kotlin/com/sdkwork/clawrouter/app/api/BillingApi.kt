...
class BillingApi(private val client: HttpClient) {
    ...
    /** List VIP benefits */
    suspend fun vipBenefitsList(): VipBenefitsListResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/benefits"))
        return client.convertValue(raw, object : TypeReference<VipBenefitsListResult>() {})
    }

    /** Retrieve VIP info */
    suspend fun vipInfoRetrieve(): VipInfoRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/info"))
        return client.convertValue(raw, object : TypeReference<VipInfoRetrieveResult>() {})
    }

    /** List VIP levels */
    suspend fun vipLevelsList(): VipLevelsListResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/levels"))
        return client.convertValue(raw, object : TypeReference<VipLevelsListResult>() {})
    }

    /** List VIP pack groups */
    suspend fun getVipPackGroupsList(): VipPackGroupsListResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/pack_groups"))
        return client.convertValue(raw, object : TypeReference<VipPackGroupsListResult>() {})
    }

    /** Retrieve VIP pack group */
    suspend fun vipPackGroupsRetrieve(packGroupId: String): VipPackGroupsRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/pack_groups/${serializePathParameter(packGroupId, PathParameterSpec("packGroupId", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<VipPackGroupsRetrieveResult>() {})
    }

    /** List VIP pack group packs */
    suspend fun getVipPackGroupsListPackGroups(packGroupId: String): VipPackGroupsPacksListResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/pack_groups/${serializePathParameter(packGroupId, PathParameterSpec("packGroupId", "simple", false))}/packs"))
    ...
    /** Retrieve VIP pack */
    suspend fun vipPacksRetrieve(packId: String): VipPacksRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/packs/${serializePathParameter(packId, PathParameterSpec("packId", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<VipPacksRetrieveResult>() {})
    }

    /** Retrieve VIP points balance */
    suspend fun vipPointsBalanceRetrieve(): VipPointsBalanceRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/points/balance"))
        return client.convertValue(raw, object : TypeReference<VipPointsBalanceRetrieveResult>() {})
    }

    /** Create VIP daily reward */
    suspend fun vipPointsDailyRewardsCreate(body: CommerceEmptyCommandRequest, idempotencyKey: String, xRequestId: String? = null): VipPointsDailyRewardsCreateResult? {
        val requestHeaders = buildRequestHeaders(
            mapOf(
                "Idempotency-Key" to HeaderParameterSpec(idempotencyKey, "simple", false, null),
                "X-Request-Id" to HeaderParameterSpec(xRequestId, "simple", false, null),
        ...
        val raw = client.post(ApiPaths.appPath("/billing/vip/points/daily_rewards"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<VipPointsDailyRewardsCreateResult>() {})
    }

    /** Retrieve VIP daily reward status */
    suspend fun vipPointsDailyRewardsStatusRetrieve(): VipPointsDailyRewardsStatusRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/points/daily_rewards/status"))
        return client.convertValue(raw, object : TypeReference<VipPointsDailyRewardsStatusRetrieveResult>() {})
    }

    /** List VIP points history */
    suspend fun vipPointsHistoryList(page: Int? = null, pageSize: Int? = null, cursor: String? = null): VipPointsHistoryListResult? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page", page, "form", true, false, null),
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("cursor", cursor, "form", true, false, null)
        ))
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/billing/vip/points/history"), query))
        return client.convertValue(raw, object : TypeReference<VipPointsHistoryListResult>() {})
    }

    /** Create VIP privilege speed up */
    suspend fun vipPrivilegesSpeedUpsCreate(body: CommerceVipPrivilegeSpeedUpRequest, idempotencyKey: String, xRequestId: String? = null): VipPrivilegesSpeedUpsCreateResult? {
        val requestHeaders = buildRequestHeaders(
            mapOf(
                "Idempotency-Key" to HeaderParameterSpec(idempotencyKey, "simple", false, null),
                "X-Request-Id" to HeaderParameterSpec(xRequestId, "simple", false, null),
        ...
        val raw = client.post(ApiPaths.appPath("/billing/vip/privileges/speed_ups"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<VipPrivilegesSpeedUpsCreateResult>() {})
    }

    /** Retrieve VIP privilege usage */
    suspend fun vipPrivilegesUsageRetrieve(): VipPrivilegesUsageRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/privileges/usage"))
        return client.convertValue(raw, object : TypeReference<VipPrivilegesUsageRetrieveResult>() {})
    }

    /** Create VIP purchase */
    suspend fun vipPurchaseCreate(body: CommerceVipPurchaseRequest, idempotencyKey: String, xRequestId: String? = null): VipPurchaseCreateResult? {
        val requestHeaders = buildRequestHeaders(
            mapOf(
                "Idempotency-Key" to HeaderParameterSpec(idempotencyKey, "simple", false, null),
                "X-Request-Id" to HeaderParameterSpec(xRequestId, "simple", false, null),
        ...
        val raw = client.post(ApiPaths.appPath("/billing/vip/purchase"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<VipPurchaseCreateResult>() {})
    }

    /** Renew VIP purchase */
    suspend fun vipPurchaseRenew(body: CommerceVipPurchaseRequest, idempotencyKey: String, xRequestId: String? = null): VipPurchaseRenewResult? {
        val requestHeaders = buildRequestHeaders(
            mapOf(
                "Idempotency-Key" to HeaderParameterSpec(idempotencyKey, "simple", false, null),
                "X-Request-Id" to HeaderParameterSpec(xRequestId, "simple", false, null),
        ...
        val raw = client.post(ApiPaths.appPath("/billing/vip/purchase/renew"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<VipPurchaseRenewResult>() {})
    }

    /** Upgrade VIP purchase */
    suspend fun vipPurchaseUpgrade(body: CommerceVipPurchaseRequest, idempotencyKey: String, xRequestId: String? = null): VipPurchaseUpgradeResult? {
        val requestHeaders = buildRequestHeaders(
            mapOf(
                "Idempotency-Key" to HeaderParameterSpec(idempotencyKey, "simple", false, null),
                "X-Request-Id" to HeaderParameterSpec(xRequestId, "simple", false, null),
        ...
        val raw = client.post(ApiPaths.appPath("/billing/vip/purchase/upgrade"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<VipPurchaseUpgradeResult>() {})
    }

    /** Retrieve VIP status */
    suspend fun vipStatusRetrieve(): VipStatusRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/billing/vip/status"))
        return client.convertValue(raw, object : TypeReference<VipStatusRetrieveResult>() {})
    }
