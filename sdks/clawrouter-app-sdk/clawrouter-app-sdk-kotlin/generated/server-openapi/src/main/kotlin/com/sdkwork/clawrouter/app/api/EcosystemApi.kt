...
class EcosystemApi(private val client: HttpClient) {
    ...
    suspend fun skillsList(q: String? = null, page: Int? = null, pageSize: Int? = null, status: String? = null, startTime: String? = null, endTime: String? = null): SkillsListResult? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/ecosystem/skills"), query))
    ...
    suspend fun skillsCategoriesList(): SkillsCategoriesListResult? {
        val raw = client.get(ApiPaths.appPath("/ecosystem/skills/categories"))
    ...
    suspend fun skillsRetrieve(skillId: String): SkillsRetrieveResult? {
        val raw = client.get(ApiPaths.appPath("/ecosystem/skills/${serializePathParameter(skillId, PathParameterSpec("skillId", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<SkillsRetrieveResult>() {})
    }

    /** Update skill config */
    suspend fun skillsConfigUpdate(skillId: String, body: AppSkillConfigRequest, xRequestId: String? = null): SkillsConfigUpdateResult? {
        ...
        val raw = client.put(ApiPaths.appPath("/ecosystem/skills/${serializePathParameter(skillId, PathParameterSpec("skillId", "simple", false))}/config"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<SkillsConfigUpdateResult>() {})
    }
    ...
    suspend fun skillsDisable(skillId: String, xRequestId: String? = null): SkillsDisableResult? {
        ...
        val raw = client.post(ApiPaths.appPath("/ecosystem/skills/${serializePathParameter(skillId, PathParameterSpec("skillId", "simple", false))}/disable"), null, null, requestHeaders)
        return client.convertValue(raw, object : TypeReference<SkillsDisableResult>() {})
    }

    /** Enable skill */
    suspend fun skillsEnable(skillId: String, body: AppSkillConfigRequest, xRequestId: String? = null): SkillsEnableResult? {
        val requestHeaders = buildRequestHeaders(
            mapOf(
                "X-Request-Id" to HeaderParameterSpec(xRequestId, "simple", false, null),
            ),
        ...
        val raw = client.post(ApiPaths.appPath("/ecosystem/skills/${serializePathParameter(skillId, PathParameterSpec("skillId", "simple", false))}/enable"), body, null, requestHeaders, "application/json")
        return client.convertValue(raw, object : TypeReference<SkillsEnableResult>() {})
    }

    /** Get my skills */
    suspend fun usersCurrentSkillsList(): UsersCurrentSkillsListResult? {
        val raw = client.get(ApiPaths.appPath("/ecosystem/users/current/skills"))
        return client.convertValue(raw, object : TypeReference<UsersCurrentSkillsListResult>() {})
    }
