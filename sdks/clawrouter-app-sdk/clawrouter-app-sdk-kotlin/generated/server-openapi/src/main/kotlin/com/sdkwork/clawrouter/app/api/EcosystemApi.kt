...
class EcosystemApi(private val client: HttpClient) {
    ...
    /** Update skill config */
    suspend fun skillsConfigUpdate(skillId: String, body: AppSkillConfigRequest): SkillsConfigUpdateResult? {
        val raw = client.put(ApiPaths.appPath("/ecosystem/skills/${serializePathParameter(skillId, PathParameterSpec("skillId", "simple", false))}/config"), body, null, null, "application/json")
    ...
    suspend fun skillsDisable(skillId: String): SkillsDisableResult? {
        val raw = client.post(ApiPaths.appPath("/ecosystem/skills/${serializePathParameter(skillId, PathParameterSpec("skillId", "simple", false))}/disable"), null)
        return client.convertValue(raw, object : TypeReference<SkillsDisableResult>() {})
    }

    /** Enable skill */
    suspend fun skillsEnable(skillId: String, body: AppSkillConfigRequest): SkillsEnableResult? {
        val raw = client.post(ApiPaths.appPath("/ecosystem/skills/${serializePathParameter(skillId, PathParameterSpec("skillId", "simple", false))}/enable"), body, null, null, "application/json")
