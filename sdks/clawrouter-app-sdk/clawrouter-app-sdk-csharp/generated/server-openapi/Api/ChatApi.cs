...
namespace Sdkwork.ClawRouter.App.Api
{
    public class ChatApi
    {
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.ConversationsListResult?> ConversationsListAsync(int? page = null, int? pageSize = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.ConversationsListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/chat/conversations"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.ConversationsCreateResult?> ConversationsCreateAsync(Sdkwork.ClawRouter.App.Models.ChatConversationCreateRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.ConversationsCreateResult>(ApiPaths.AppPath("/chat/conversations"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Retrieve product chat conversation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.ConversationsRetrieveResult?> ConversationsRetrieveAsync(string conversationId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.ConversationsRetrieveResult>(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}"));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.ConversationMessagesListResult?> ConversationMessagesListAsync(string conversationId, int? limit = null, string? order = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.ConversationMessagesListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}/messages"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.TurnsCreateResult?> TurnsCreateAsync(string conversationId, Sdkwork.ClawRouter.App.Models.ChatTurnCreateRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.TurnsCreateResult>(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}/turns"), body, null, requestHeaders, "application/json");
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.TurnResponsesCreateResult?> TurnResponsesCreateAsync(string conversationId, string turnId, Sdkwork.ClawRouter.App.Models.ChatTurnResponseRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.TurnResponsesCreateResult>(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}/turns/{SerializePathParameter(turnId, new PathParameterSpec("turnId", "simple", false))}/response"), body, null, requestHeaders, "application/json");
        }
