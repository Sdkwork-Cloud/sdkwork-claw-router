...
namespace Sdkwork.ClawRouter.App.Api
{
    public class EcosystemApi
    {
        ...
        /// Update skill config
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsConfigUpdateResult?> SkillsConfigUpdateAsync(string skillId, Sdkwork.ClawRouter.App.Models.AppSkillConfigRequest body)
        {
            return await _client.PutAsync<Sdkwork.ClawRouter.App.Models.SkillsConfigUpdateResult>(ApiPaths.AppPath($"/ecosystem/skills/{SerializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false))}/config"), body, null, null, "application/json");
        }

        /// <summary>
        /// Disable skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsDisableResult?> SkillsDisableAsync(string skillId)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.SkillsDisableResult>(ApiPaths.AppPath($"/ecosystem/skills/{SerializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false))}/disable"), null);
        }

        /// <summary>
        /// Enable skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsEnableResult?> SkillsEnableAsync(string skillId, Sdkwork.ClawRouter.App.Models.AppSkillConfigRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.SkillsEnableResult>(ApiPaths.AppPath($"/ecosystem/skills/{SerializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false))}/enable"), body, null, null, "application/json");
        }
