...
namespace Sdkwork.ClawRouter.App.Api
{
    public class EcosystemApi
    {
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsListResult?> SkillsListAsync(string? q = null, int? page = null, int? pageSize = null, string? status = null, string? startTime = null, string? endTime = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.SkillsListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/ecosystem/skills"), queryString));
        }

        /// <summary>
        /// Get categories
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsCategoriesListResult?> SkillsCategoriesListAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.SkillsCategoriesListResult>(ApiPaths.AppPath("/ecosystem/skills/categories"));
        }

        /// <summary>
        /// Get skill by ID
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsRetrieveResult?> SkillsRetrieveAsync(string skillId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.SkillsRetrieveResult>(ApiPaths.AppPath($"/ecosystem/skills/{SerializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false))}"));
        }

        /// <summary>
        /// Update skill config
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsConfigUpdateResult?> SkillsConfigUpdateAsync(string skillId, Sdkwork.ClawRouter.App.Models.AppSkillConfigRequest body, string? xRequestId = null)
        {
            ...
            return await _client.PutAsync<Sdkwork.ClawRouter.App.Models.SkillsConfigUpdateResult>(ApiPaths.AppPath($"/ecosystem/skills/{SerializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false))}/config"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Disable skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsDisableResult?> SkillsDisableAsync(string skillId, string? xRequestId = null)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.SkillsDisableResult>(ApiPaths.AppPath($"/ecosystem/skills/{SerializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false))}/disable"), null, null, requestHeaders);
        }

        /// <summary>
        /// Enable skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SkillsEnableResult?> SkillsEnableAsync(string skillId, Sdkwork.ClawRouter.App.Models.AppSkillConfigRequest body, string? xRequestId = null)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.SkillsEnableResult>(ApiPaths.AppPath($"/ecosystem/skills/{SerializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false))}/enable"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Get my skills
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.UsersCurrentSkillsListResult?> UsersCurrentSkillsListAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.UsersCurrentSkillsListResult>(ApiPaths.AppPath("/ecosystem/users/current/skills"));
        }
