    ...
    public class RuntimeApi
    {
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.InvocationsListResult?> InvocationsListAsync(int? page = null, int? pageSize = null, string? conversationId = null, string? chatTurnId = null, string? agentSessionId = null, string? runtime = null, string? status = null)
        {
            var queryString = BuildQueryString(new[]
            {
                ...
                new QueryParameterSpec("chat_turn_id", chatTurnId, "form", true, false, null),
                new QueryParameterSpec("agent_session_id", agentSessionId, "form", true, false, null),
                new QueryParameterSpec("runtime", runtime, "form", true, false, null),
                new QueryParameterSpec("status", status, "form", true, false, null),
            });
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.InvocationsListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/runtime/invocations"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.InvocationsCreateResult?> InvocationsCreateAsync(Sdkwork.ClawRouter.App.Models.RuntimeInvocationCreateRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.InvocationsCreateResult>(ApiPaths.AppPath("/runtime/invocations"), body, null, requestHeaders, "application/json");
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.ArtifactsListResult?> ArtifactsListAsync(string invocationId, int? page = null, int? pageSize = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.ArtifactsListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath($"/runtime/invocations/{SerializePathParameter(invocationId, new PathParameterSpec("invocationId", "simple", false))}/artifacts"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.ArtifactsCreateResult?> ArtifactsCreateAsync(string invocationId, Sdkwork.ClawRouter.App.Models.RuntimeArtifactCreateRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.ArtifactsCreateResult>(ApiPaths.AppPath($"/runtime/invocations/{SerializePathParameter(invocationId, new PathParameterSpec("invocationId", "simple", false))}/artifacts"), body, null, requestHeaders, "application/json");
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.InvocationsSubmitResult?> InvocationsSubmitAsync(string invocationId, Sdkwork.ClawRouter.App.Models.RuntimeInvocationCompleteRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.InvocationsSubmitResult>(ApiPaths.AppPath($"/runtime/invocations/{SerializePathParameter(invocationId, new PathParameterSpec("invocationId", "simple", false))}/complete"), body, null, requestHeaders, "application/json");
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.InvocationEventsListResult?> InvocationEventsListAsync(string invocationId, int? page = null, int? pageSize = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.InvocationEventsListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath($"/runtime/invocations/{SerializePathParameter(invocationId, new PathParameterSpec("invocationId", "simple", false))}/events"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.InvocationEventsCreateResult?> InvocationEventsCreateAsync(string invocationId, Sdkwork.ClawRouter.App.Models.RuntimeEventCreateRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.InvocationEventsCreateResult>(ApiPaths.AppPath($"/runtime/invocations/{SerializePathParameter(invocationId, new PathParameterSpec("invocationId", "simple", false))}/events"), body, null, requestHeaders, "application/json");
        }
