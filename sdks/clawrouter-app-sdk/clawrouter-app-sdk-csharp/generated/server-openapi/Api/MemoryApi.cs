...
namespace Sdkwork.ClawRouter.App.Api
{
    public class MemoryApi
    {
        ...
        public MemoryApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.EntriesRetrieveResult?> EntriesRetrieveAsync(string entryId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.EntriesRetrieveResult>(ApiPaths.AppPath($"/memory/entries/{SerializePathParameter(entryId, new PathParameterSpec("entryId", "simple", false))}"));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.SpacesListResult?> SpacesListAsync(string? page = null, string? pageSize = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.SpacesListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/memory/spaces"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.SpacesCreateResult?> SpacesCreateAsync(Sdkwork.ClawRouter.App.Models.MemorySpaceCreateRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.SpacesCreateResult>(ApiPaths.AppPath("/memory/spaces"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Retrieve memory space
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.SpacesRetrieveResult?> SpacesRetrieveAsync(string spaceId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.SpacesRetrieveResult>(ApiPaths.AppPath($"/memory/spaces/{SerializePathParameter(spaceId, new PathParameterSpec("spaceId", "simple", false))}"));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.EntriesListResult?> EntriesListAsync(string spaceId, string? page = null, string? pageSize = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.EntriesListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath($"/memory/spaces/{SerializePathParameter(spaceId, new PathParameterSpec("spaceId", "simple", false))}/entries"), queryString));
        }
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.EntriesCreateResult?> EntriesCreateAsync(string spaceId, Sdkwork.ClawRouter.App.Models.MemoryEntryCreateRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.EntriesCreateResult>(ApiPaths.AppPath($"/memory/spaces/{SerializePathParameter(spaceId, new PathParameterSpec("spaceId", "simple", false))}/entries"), body, null, requestHeaders, "application/json");
        }
