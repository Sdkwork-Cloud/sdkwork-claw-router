...
namespace Sdkwork.ClawRouter.App.Api
{
    public class BillingApi
    {
        ...
        /// List VIP benefits
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipBenefitsListResult?> VipBenefitsListAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipBenefitsListResult>(ApiPaths.AppPath("/billing/vip/benefits"));
        }

        /// <summary>
        /// Retrieve VIP info
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipInfoRetrieveResult?> VipInfoRetrieveAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipInfoRetrieveResult>(ApiPaths.AppPath("/billing/vip/info"));
        }

        /// <summary>
        /// List VIP levels
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipLevelsListResult?> VipLevelsListAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipLevelsListResult>(ApiPaths.AppPath("/billing/vip/levels"));
        }

        /// <summary>
        /// List VIP pack groups
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPackGroupsListResult?> GetVipPackGroupsListAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPackGroupsListResult>(ApiPaths.AppPath("/billing/vip/pack_groups"));
        }

        /// <summary>
        /// Retrieve VIP pack group
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPackGroupsRetrieveResult?> VipPackGroupsRetrieveAsync(string packGroupId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPackGroupsRetrieveResult>(ApiPaths.AppPath($"/billing/vip/pack_groups/{SerializePathParameter(packGroupId, new PathParameterSpec("packGroupId", "simple", false))}"));
        }

        /// <summary>
        /// List VIP pack group packs
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPackGroupsPacksListResult?> GetVipPackGroupsListPackGroupsAsync(string packGroupId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPackGroupsPacksListResult>(ApiPaths.AppPath($"/billing/vip/pack_groups/{SerializePathParameter(packGroupId, new PathParameterSpec("packGroupId", "simple", false))}/packs"));
        }
        ...
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPacksListResult>(ApiPaths.AppPath("/billing/vip/packs"));
        }

        /// <summary>
        /// Retrieve VIP pack
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPacksRetrieveResult?> VipPacksRetrieveAsync(string packId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPacksRetrieveResult>(ApiPaths.AppPath($"/billing/vip/packs/{SerializePathParameter(packId, new PathParameterSpec("packId", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve VIP points balance
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPointsBalanceRetrieveResult?> VipPointsBalanceRetrieveAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPointsBalanceRetrieveResult>(ApiPaths.AppPath("/billing/vip/points/balance"));
        }

        /// <summary>
        /// Create VIP daily reward
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPointsDailyRewardsCreateResult?> VipPointsDailyRewardsCreateAsync(Sdkwork.ClawRouter.App.Models.CommerceEmptyCommandRequest body, string idempotencyKey, string? xRequestId = null)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.VipPointsDailyRewardsCreateResult>(ApiPaths.AppPath("/billing/vip/points/daily_rewards"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Retrieve VIP daily reward status
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPointsDailyRewardsStatusRetrieveResult?> VipPointsDailyRewardsStatusRetrieveAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPointsDailyRewardsStatusRetrieveResult>(ApiPaths.AppPath("/billing/vip/points/daily_rewards/status"));
        }

        /// <summary>
        /// List VIP points history
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPointsHistoryListResult?> VipPointsHistoryListAsync(int? page = null, int? pageSize = null, string? cursor = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page", page, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPointsHistoryListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/billing/vip/points/history"), queryString));
        }

        /// <summary>
        /// Create VIP privilege speed up
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPrivilegesSpeedUpsCreateResult?> VipPrivilegesSpeedUpsCreateAsync(Sdkwork.ClawRouter.App.Models.CommerceVipPrivilegeSpeedUpRequest body, string idempotencyKey, string? xRequestId = null)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.VipPrivilegesSpeedUpsCreateResult>(ApiPaths.AppPath("/billing/vip/privileges/speed_ups"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Retrieve VIP privilege usage
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPrivilegesUsageRetrieveResult?> VipPrivilegesUsageRetrieveAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipPrivilegesUsageRetrieveResult>(ApiPaths.AppPath("/billing/vip/privileges/usage"));
        }

        /// <summary>
        /// Create VIP purchase
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPurchaseCreateResult?> VipPurchaseCreateAsync(Sdkwork.ClawRouter.App.Models.CommerceVipPurchaseRequest body, string idempotencyKey, string? xRequestId = null)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.VipPurchaseCreateResult>(ApiPaths.AppPath("/billing/vip/purchase"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Renew VIP purchase
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPurchaseRenewResult?> VipPurchaseRenewAsync(Sdkwork.ClawRouter.App.Models.CommerceVipPurchaseRequest body, string idempotencyKey, string? xRequestId = null)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.VipPurchaseRenewResult>(ApiPaths.AppPath("/billing/vip/purchase/renew"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Upgrade VIP purchase
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipPurchaseUpgradeResult?> VipPurchaseUpgradeAsync(Sdkwork.ClawRouter.App.Models.CommerceVipPurchaseRequest body, string idempotencyKey, string? xRequestId = null)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.VipPurchaseUpgradeResult>(ApiPaths.AppPath("/billing/vip/purchase/upgrade"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Retrieve VIP status
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.VipStatusRetrieveResult?> VipStatusRetrieveAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.VipStatusRetrieveResult>(ApiPaths.AppPath("/billing/vip/status"));
        }
