...
namespace Sdkwork.ClawRouter.App.Api
{
    public class NotificationApi
    {
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.NotificationsListResult?> NotificationsListAsync(string? appId = null, bool? includeArchived = null, int? page = null, int? pageSize = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.NotificationsListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/notification/notifications"), queryString));
        }
