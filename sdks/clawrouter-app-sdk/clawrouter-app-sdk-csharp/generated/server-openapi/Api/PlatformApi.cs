...
namespace Sdkwork.ClawRouter.App.Api
{
    public class PlatformApi
    {
        ...
        public async Task<Sdkwork.ClawRouter.App.Models.AppsStoreListResult?> AppsStoreListAsync(int? page = null, int? pageSize = null, string? q = null, string? status = null, string? startTime = null, string? endTime = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.AppsStoreListResult>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/platform/apps/store"), queryString));
        }

        /// <summary>
        /// Get categories
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.AppsStoreCategoriesListResult?> AppsStoreCategoriesListAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.AppsStoreCategoriesListResult>(ApiPaths.AppPath("/platform/apps/store/categories"));
        }

        /// <summary>
        /// Get app by ID
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.AppsStoreRetrieveResult?> AppsStoreRetrieveAsync(string appId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.AppsStoreRetrieveResult>(ApiPaths.AppPath($"/platform/apps/store/{SerializePathParameter(appId, new PathParameterSpec("appId", "simple", false))}"));
        }
