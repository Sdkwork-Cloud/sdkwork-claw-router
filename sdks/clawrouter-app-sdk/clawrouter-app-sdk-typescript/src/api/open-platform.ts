...
import type { OpenPlatformQrAuthPasswordCreateRequest, OpenPlatformQrAuthScanCreateRequest, OpenPlatformQrAuthSessionCreateRequest, QrAuthSessionsCreateResult, QrAuthSessionsPasswordsCreateResult, QrAuthSessionsRetrieveResult, QrAuthSessionsScansCreateResult } from '../types';
...
/** Record open platform QR auth scan */
  async create(sessionKey: string, body: OpenPlatformQrAuthScanCreateRequest): Promise<QrAuthSessionsScansCreateResult> {
    return this.client.post<QrAuthSessionsScansCreateResult>(appApiPath(`/open_platform/qr_auth/sessions/${serializePathParameter(sessionKey, { name: 'sessionKey', style: 'simple', explode: false })}/scans`), body, undefined, undefined, 'application/json');
  }
}
...
/** Complete open platform QR auth by password */
  async create(sessionKey: string, body: OpenPlatformQrAuthPasswordCreateRequest): Promise<QrAuthSessionsPasswordsCreateResult> {
    return this.client.post<QrAuthSessionsPasswordsCreateResult>(appApiPath(`/open_platform/qr_auth/sessions/${serializePathParameter(sessionKey, { name: 'sessionKey', style: 'simple', explode: false })}/passwords`), body, undefined, undefined, 'application/json');
  }
}
...
/** Create open platform QR auth session */
  async create(body: OpenPlatformQrAuthSessionCreateRequest): Promise<QrAuthSessionsCreateResult> {
    return this.client.post<QrAuthSessionsCreateResult>(appApiPath(`/open_platform/qr_auth/sessions`), body, undefined, undefined, 'application/json');
  }

/** Retrieve open platform QR auth session */
  async retrieve(sessionKey: string): Promise<QrAuthSessionsRetrieveResult> {
    return this.client.get<QrAuthSessionsRetrieveResult>(appApiPath(`/open_platform/qr_auth/sessions/${serializePathParameter(sessionKey, { name: 'sessionKey', style: 'simple', explode: false })}`));
  }
}
