...
public class RuntimeApi {
    ...
    public InvocationsListResult invocationsList(Integer page, Integer pageSize, String conversationId, String chatTurnId, String agentSessionId, String runtime, String status) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/runtime/invocations"), query));
    ...
    public ArtifactsListResult artifactsList(String invocationId, Integer page, Integer pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/runtime/invocations/" + serializePathParameter(invocationId, new PathParameterSpec("invocationId", "simple", false)) + "/artifacts"), query));
    ...
    public InvocationEventsListResult invocationEventsList(String invocationId, Integer page, Integer pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/runtime/invocations/" + serializePathParameter(invocationId, new PathParameterSpec("invocationId", "simple", false)) + "/events"), query));
