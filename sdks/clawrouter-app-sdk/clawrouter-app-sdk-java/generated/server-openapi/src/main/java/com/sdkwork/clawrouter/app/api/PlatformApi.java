...
public class PlatformApi {
    ...
    public AppsStoreListResult appsStoreList(Integer page, Integer pageSize, String q, String status, String startTime, String endTime) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/platform/apps/store"), query));
        return client.convertValue(raw, new TypeReference<AppsStoreListResult>() {});
    }

    /** Get categories */
    public AppsStoreCategoriesListResult appsStoreCategoriesList() throws Exception {
        Object raw = client.get(ApiPaths.appPath("/platform/apps/store/categories"));
        return client.convertValue(raw, new TypeReference<AppsStoreCategoriesListResult>() {});
    }

    /** Get app by ID */
    public AppsStoreRetrieveResult appsStoreRetrieve(String appId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/platform/apps/store/" + serializePathParameter(appId, new PathParameterSpec("appId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<AppsStoreRetrieveResult>() {});
    }
