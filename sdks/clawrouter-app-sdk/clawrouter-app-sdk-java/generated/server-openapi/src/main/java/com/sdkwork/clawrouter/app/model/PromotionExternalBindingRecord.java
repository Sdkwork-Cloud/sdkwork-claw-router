...
public class PromotionExternalBindingRecord {
    ...
    public String getExternalCurrencyCode() {
        return this.externalCurrencyCode;
    }

    public void setExternalCurrencyCode(String externalCurrencyCode) {
        this.externalCurrencyCode = externalCurrencyCode;
    }
    ...
    public String getExternalObjectType() {
        return this.externalObjectType;
    }
    ...
    public void setPlatformCardId(String platformCardId) {
