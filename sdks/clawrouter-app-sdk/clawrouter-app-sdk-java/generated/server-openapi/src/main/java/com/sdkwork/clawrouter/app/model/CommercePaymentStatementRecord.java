...
public class CommercePaymentStatementRecord {
    ...
    private String providerStatementId;
    ...
    public String getProviderStatementId() {
        return this.providerStatementId;
    }

    public void setProviderStatementId(String providerStatementId) {
        this.providerStatementId = providerStatementId;
    }
