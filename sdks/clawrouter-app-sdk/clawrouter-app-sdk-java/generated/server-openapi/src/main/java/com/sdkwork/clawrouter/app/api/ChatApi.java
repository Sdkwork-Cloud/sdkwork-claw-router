...
public class ChatApi {
    ...
    public ConversationsListResult conversationsList(Integer page, Integer pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/chat/conversations"), query));
    ...
    public ConversationMessagesListResult conversationMessagesList(String conversationId, Integer limit, String order) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/chat/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false)) + "/messages"), query));
