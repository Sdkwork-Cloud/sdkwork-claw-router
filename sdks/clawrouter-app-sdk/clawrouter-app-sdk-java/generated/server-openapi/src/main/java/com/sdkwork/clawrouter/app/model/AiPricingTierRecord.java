...
public class AiPricingTierRecord {
    ...
    private String cacheWriteUnitPrice;
    ...
    private String id;
    private String imageUnitPrice;
    private String includedQuantity;
    private String inputUnitPrice;
    private String maxQuantity;
    private Map<String, String> metadata;
    private String minQuantity;
    private String modelPricingId;
    private String multiplier;
    private String organizationId;
    private String outputUnitPrice;
    private String perRequestPrice;
