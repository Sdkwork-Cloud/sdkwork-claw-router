...
public class IntegrationServiceProviderRecord {
    ...
    private String suspendedReasonCode;
    ...
    public String getSuspendedReasonCode() {
        return this.suspendedReasonCode;
    }

    public void setSuspendedReasonCode(String suspendedReasonCode) {
        this.suspendedReasonCode = suspendedReasonCode;
    }
