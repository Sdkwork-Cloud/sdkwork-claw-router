...
public class AiAgentSessionRecord {
    ...
    private String forkedFromRunId;
    private String forkedFromStepId;
    ...
    private String runtimeStateStorageKey;
    ...
    public String getForkedFromRunId() {
        return this.forkedFromRunId;
    }

    public void setForkedFromRunId(String forkedFromRunId) {
        this.forkedFromRunId = forkedFromRunId;
    }

    public String getForkedFromStepId() {
        return this.forkedFromStepId;
    }

    public void setForkedFromStepId(String forkedFromStepId) {
        this.forkedFromStepId = forkedFromStepId;
    }
    ...
    public String getRuntimeStateStorageKey() {
        return this.runtimeStateStorageKey;
    }

    public void setRuntimeStateStorageKey(String runtimeStateStorageKey) {
        this.runtimeStateStorageKey = runtimeStateStorageKey;
    }
