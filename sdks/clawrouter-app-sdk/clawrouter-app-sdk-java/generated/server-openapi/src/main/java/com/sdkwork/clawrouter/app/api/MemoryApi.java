...
public class MemoryApi {
    ...
    public MemoryApi(HttpClient client) {
        this.client = client;
    }

    /** Retrieve memory entry */
    public EntriesRetrieveResult entriesRetrieve(String entryId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/memory/entries/" + serializePathParameter(entryId, new PathParameterSpec("entryId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<EntriesRetrieveResult>() {});
    }
    ...
    public SpacesListResult spacesList(String page, String pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/memory/spaces"), query));
        return client.convertValue(raw, new TypeReference<SpacesListResult>() {});
    }
    ...
    public SpacesCreateResult spacesCreate(MemorySpaceCreateRequest body, String idempotencyKey) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<SpacesCreateResult>() {});
    }

    /** Retrieve memory space */
    public SpacesRetrieveResult spacesRetrieve(String spaceId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/memory/spaces/" + serializePathParameter(spaceId, new PathParameterSpec("spaceId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<SpacesRetrieveResult>() {});
    }
    ...
    public EntriesListResult entriesList(String spaceId, String page, String pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/memory/spaces/" + serializePathParameter(spaceId, new PathParameterSpec("spaceId", "simple", false)) + "/entries"), query));
        return client.convertValue(raw, new TypeReference<EntriesListResult>() {});
    }
    ...
    public EntriesCreateResult entriesCreate(String spaceId, MemoryEntryCreateRequest body, String idempotencyKey) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<EntriesCreateResult>() {});
    }
