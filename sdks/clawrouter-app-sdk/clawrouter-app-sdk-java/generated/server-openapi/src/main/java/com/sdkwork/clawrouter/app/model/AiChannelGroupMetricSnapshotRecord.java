...
public class AiChannelGroupMetricSnapshotRecord {
    private String capacityLimit;
    private String capacityUsed;
    private String channelAvailableCount;
    private String channelGroupId;
    private String channelTotalCount;
    ...
    private String requestCountToday;
    private String requestCountTotal;
    ...
    private String usageAmountToday;
    private String usageAmountTotal;
    private String uuid;
    ...
    public String getChannelAvailableCount() {
        return this.channelAvailableCount;
    }

    public void setChannelAvailableCount(String channelAvailableCount) {
        this.channelAvailableCount = channelAvailableCount;
    }
    ...
    public String getChannelTotalCount() {
        return this.channelTotalCount;
    }

    public void setChannelTotalCount(String channelTotalCount) {
