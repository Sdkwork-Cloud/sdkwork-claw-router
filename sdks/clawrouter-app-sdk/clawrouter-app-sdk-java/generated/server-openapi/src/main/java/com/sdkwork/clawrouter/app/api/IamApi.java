...
public class IamApi {
    ...
    public DepartmentAssignmentsListResult departmentAssignmentsList(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<DepartmentAssignmentsListResult>() {});
    }

    /** List current IAM departments */
    public DepartmentsListResult departmentsList(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        return client.convertValue(raw, new TypeReference<DepartmentsListResult>() {});
    }

    /** Retrieve current IAM department tree */
    public DepartmentsTreeRetrieveResult departmentsTreeRetrieve(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/iam/departments/tree"), query));
        return client.convertValue(raw, new TypeReference<DepartmentsTreeRetrieveResult>() {});
    }

    /** List current IAM organization memberships */
    public OrganizationMembershipsListResult organizationMembershipsList(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        return client.convertValue(raw, new TypeReference<OrganizationMembershipsListResult>() {});
    }

    /** List current IAM organizations */
    public OrganizationsListResult organizationsList(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        return client.convertValue(raw, new TypeReference<OrganizationsListResult>() {});
    }

    /** Retrieve current IAM organization tree */
    public OrganizationsTreeRetrieveResult organizationsTreeRetrieve(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/iam/organizations/tree"), query));
        return client.convertValue(raw, new TypeReference<OrganizationsTreeRetrieveResult>() {});
    }

    /** List current IAM position assignments */
    public PositionAssignmentsListResult positionAssignmentsList(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        return client.convertValue(raw, new TypeReference<PositionAssignmentsListResult>() {});
    }

    /** List current IAM positions */
    public PositionsListResult positionsList(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        return client.convertValue(raw, new TypeReference<PositionsListResult>() {});
    }

    /** List current IAM role bindings */
    public RoleBindingsListResult roleBindingsList(String organizationId, String departmentId, String userId, String scopeId, String status, String q, Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("organization_id", organizationId, "form", true, false, null),
            new QueryParameterSpec("department_id", departmentId, "form", true, false, null),
            new QueryParameterSpec("user_id", userId, "form", true, false, null),
        ...
        return client.convertValue(raw, new TypeReference<RoleBindingsListResult>() {});
    }
