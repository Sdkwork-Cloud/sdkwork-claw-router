...
public class PromotionBudgetAccountRecord {
    ...
    public String getOverrunAmountMinor() {
        return this.overrunAmountMinor;
    }

    public void setOverrunAmountMinor(String overrunAmountMinor) {
        this.overrunAmountMinor = overrunAmountMinor;
    }

    public String getPlannedAmountMinor() {
        return this.plannedAmountMinor;
    }

    public void setPlannedAmountMinor(String plannedAmountMinor) {
