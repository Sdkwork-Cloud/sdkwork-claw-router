...
public class CommerceRefundAttemptRecord {
    ...
    private String refundAttemptNo;
    ...
    public String getRefundAttemptNo() {
        return this.refundAttemptNo;
    }

    public void setRefundAttemptNo(String refundAttemptNo) {
        this.refundAttemptNo = refundAttemptNo;
    }
