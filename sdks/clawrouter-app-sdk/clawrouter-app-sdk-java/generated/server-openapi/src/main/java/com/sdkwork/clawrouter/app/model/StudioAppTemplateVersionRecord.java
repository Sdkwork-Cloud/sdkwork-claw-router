...
public class StudioAppTemplateVersionRecord {
    ...
    private Map<String, String> dependencyManifest;
    ...
    public Map<String, String> getCapabilityManifest() {
        return this.capabilityManifest;
    }

    public void setCapabilityManifest(Map<String, String> capabilityManifest) {
    ...
    public Map<String, String> getDependencyManifest() {
        return this.dependencyManifest;
    }

    public void setDependencyManifest(Map<String, String> dependencyManifest) {
