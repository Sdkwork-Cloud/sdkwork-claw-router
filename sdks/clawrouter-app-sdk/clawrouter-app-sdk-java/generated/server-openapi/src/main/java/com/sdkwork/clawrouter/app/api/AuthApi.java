...
public class AuthApi {
    ...
    public LoginQrCodesCreateResult loginQrCodesCreate() throws Exception {
        Object raw = client.post(ApiPaths.appPath("/auth/qr_login_codes"), null);
    ...
    public LoginQrCodesRetrieveResult loginQrCodesRetrieve(String qrKey) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<LoginQrCodesRetrieveResult>() {});
    }
