...
public class AiMemoryEntryRecord {
    ...
    public String getLastRecalledAt() {
        return this.lastRecalledAt;
    }

    public void setLastRecalledAt(String lastRecalledAt) {
    ...
    public String getSupersedesMemoryId() {
        return this.supersedesMemoryId;
    }

    public void setSupersedesMemoryId(String supersedesMemoryId) {
