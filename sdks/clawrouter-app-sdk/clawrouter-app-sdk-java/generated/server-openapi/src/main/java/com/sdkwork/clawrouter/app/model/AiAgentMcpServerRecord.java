...
public class AiAgentMcpServerRecord {
    ...
    private Map<String, String> permissionPolicy;
    private Map<String, String> promptCatalog;
    private Map<String, String> resourceCatalog;
    private String serverCode;
    private String status;
    private String tenantId;
    private Map<String, String> toolCatalog;
