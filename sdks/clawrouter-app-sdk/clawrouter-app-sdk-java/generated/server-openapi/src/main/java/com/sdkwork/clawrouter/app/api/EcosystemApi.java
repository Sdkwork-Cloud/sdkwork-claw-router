...
public class EcosystemApi {
    ...
    public SkillsListResult skillsList(String q, String page, String pageSize, String status, String startTime, String endTime) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/ecosystem/skills"), query));
    ...
    public SkillsCategoriesListResult skillsCategoriesList() throws Exception {
        Object raw = client.get(ApiPaths.appPath("/ecosystem/skills/categories"));
    ...
    public SkillsRetrieveResult skillsRetrieve(String skillId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/ecosystem/skills/" + serializePathParameter(skillId, new PathParameterSpec("skillId", "simple", false)) + ""));
    ...
    /** Get my skills */
    public UsersCurrentSkillsListResult usersCurrentSkillsList() throws Exception {
        Object raw = client.get(ApiPaths.appPath("/ecosystem/users/current/skills"));
        return client.convertValue(raw, new TypeReference<UsersCurrentSkillsListResult>() {});
    }
