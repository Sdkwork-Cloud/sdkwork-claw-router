...
func (a *AuthApi) LoginQrCodesCreate() (sdktypes.LoginQrCodesCreateResult, error) {
    raw, err := a.client.Post(AppApiPath("/auth/qr_login_codes"), nil, nil, nil, "")
    if err != nil {
        var zero sdktypes.LoginQrCodesCreateResult
        return zero, err
    }
...
func (a *AuthApi) LoginQrCodesRetrieve(qrKey string) (sdktypes.LoginQrCodesRetrieveResult, error) {
    ...
    if err != nil {
        var zero sdktypes.LoginQrCodesRetrieveResult
        return zero, err
    }
    return decodeResult[sdktypes.LoginQrCodesRetrieveResult](raw)
}
