...
func (a *AuthApi) RegistrationsCreate(body sdktypes.IamRegistrationCreateRequest) (sdktypes.RegistrationsCreateResult, error) {
    raw, err := a.client.Post(AppApiPath("/auth/registrations"), body, nil, nil, "application/json")
    if err != nil {
...
// Create IAM session
func (a *AuthApi) SessionsCreate(body sdktypes.IamSessionCreateRequest) (sdktypes.SessionsCreateResult, error) {
    raw, err := a.client.Post(AppApiPath("/auth/sessions"), body, nil, nil, "application/json")
    if err != nil {
