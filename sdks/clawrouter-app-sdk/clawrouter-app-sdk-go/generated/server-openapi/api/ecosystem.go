...
func (a *EcosystemApi) SkillsList(q *string, page *string, pageSize *string, status *string, startTime *string, endTime *string) (sdktypes.SkillsListResult, error) {
    ...
    raw, err := a.client.Get(AppendQueryString(AppApiPath("/ecosystem/skills"), query), nil, nil)
    if err != nil {
...
func (a *EcosystemApi) SkillsCategoriesList() (sdktypes.SkillsCategoriesListResult, error) {
    raw, err := a.client.Get(AppApiPath("/ecosystem/skills/categories"), nil, nil)
    if err != nil {
...
func (a *EcosystemApi) SkillsRetrieve(skillId string) (sdktypes.SkillsRetrieveResult, error) {
    raw, err := a.client.Get(AppApiPath(fmt.Sprintf("/ecosystem/skills/%s", SerializePathParameter(skillId, PathParameterSpec{Name: "skillId", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
...
func (a *EcosystemApi) SkillsConfigUpdate(skillId string, body sdktypes.AppSkillConfigRequest) (sdktypes.SkillsConfigUpdateResult, error) {
    ...
    return decodeResult[sdktypes.SkillsConfigUpdateResult](raw)
}
...
// Get my skills
func (a *EcosystemApi) UsersCurrentSkillsList() (sdktypes.UsersCurrentSkillsListResult, error) {
    raw, err := a.client.Get(AppApiPath("/ecosystem/users/current/skills"), nil, nil)
    if err != nil {
        var zero sdktypes.UsersCurrentSkillsListResult
        return zero, err
    }
    return decodeResult[sdktypes.UsersCurrentSkillsListResult](raw)
}
