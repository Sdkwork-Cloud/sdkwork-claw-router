...
func NewMemoryApi(client *sdkhttp.Client) *MemoryApi {
    return &MemoryApi{client: client}
}

// Retrieve memory entry
func (a *MemoryApi) EntriesRetrieve(entryId string) (sdktypes.EntriesRetrieveResult, error) {
    raw, err := a.client.Get(AppApiPath(fmt.Sprintf("/memory/entries/%s", SerializePathParameter(entryId, PathParameterSpec{Name: "entryId", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
        var zero sdktypes.EntriesRetrieveResult
        return zero, err
    }
    return decodeResult[sdktypes.EntriesRetrieveResult](raw)
}
...
func (a *MemoryApi) SpacesList(page *int, pageSize *int) (sdktypes.SpacesListResult, error) {
    ...
    raw, err := a.client.Get(AppendQueryString(AppApiPath("/memory/spaces"), query), nil, nil)
    if err != nil {
        var zero sdktypes.SpacesListResult
        return zero, err
    }
    return decodeResult[sdktypes.SpacesListResult](raw)
}
...
func (a *MemoryApi) SpacesCreate(body sdktypes.MemorySpaceCreateRequest, idempotencyKey string, xRequestId *string) (sdktypes.SpacesCreateResult, error) {
    ...
    if err != nil {
        var zero sdktypes.SpacesCreateResult
        return zero, err
    }
    return decodeResult[sdktypes.SpacesCreateResult](raw)
}

// Retrieve memory space
func (a *MemoryApi) SpacesRetrieve(spaceId string) (sdktypes.SpacesRetrieveResult, error) {
    raw, err := a.client.Get(AppApiPath(fmt.Sprintf("/memory/spaces/%s", SerializePathParameter(spaceId, PathParameterSpec{Name: "spaceId", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
        var zero sdktypes.SpacesRetrieveResult
        return zero, err
    }
    return decodeResult[sdktypes.SpacesRetrieveResult](raw)
}
...
func (a *MemoryApi) EntriesList(spaceId string, page *int, pageSize *int) (sdktypes.EntriesListResult, error) {
    ...
    raw, err := a.client.Get(AppendQueryString(AppApiPath(fmt.Sprintf("/memory/spaces/%s/entries", SerializePathParameter(spaceId, PathParameterSpec{Name: "spaceId", Style: "simple", Explode: false}))), query), nil, nil)
    if err != nil {
        var zero sdktypes.EntriesListResult
        return zero, err
    }
    return decodeResult[sdktypes.EntriesListResult](raw)
}
...
func (a *MemoryApi) EntriesCreate(spaceId string, body sdktypes.MemoryEntryCreateRequest, idempotencyKey string, xRequestId *string) (sdktypes.EntriesCreateResult, error) {
    ...
    if err != nil {
        var zero sdktypes.EntriesCreateResult
        return zero, err
    }
    return decodeResult[sdktypes.EntriesCreateResult](raw)
}
