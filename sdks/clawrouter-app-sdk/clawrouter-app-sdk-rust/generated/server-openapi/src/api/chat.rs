...
use crate::models::{ChatConversationCreateRequest, ChatTurnCreateRequest, ChatTurnResponseRequest, ConversationMessagesListResult, ConversationsCreateResult, ConversationsListResult, ConversationsRetrieveResult, TurnResponsesCreateResult, TurnsCreateResult};
...
impl ChatApi {
    ...
    pub async fn conversations_retrieve(&self, conversation_id: &str) -> Result<ConversationsRetrieveResult, SdkworkError> {
