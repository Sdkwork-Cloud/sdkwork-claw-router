...
class SystemApi {
  ...
  Future<PromotionsDiscountApplicationsCreateResult?> promotionsDiscountApplicationsCreate(PromotionCommandRequest body, String idempotencyKey, [String? xRequestId]) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.appPath('/promotions/discount_applications'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : PromotionsDiscountApplicationsCreateResult.fromJson(map);
    })();
  }
  ...
  Future<PromotionsDiscountApplicationsReversalsCreateResult?> promotionsDiscountApplicationsReversalsCreate(PromotionCommandRequest body, String idempotencyKey, [String? xRequestId]) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.appPath('/promotions/discount_applications/reversals'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : PromotionsDiscountApplicationsReversalsCreateResult.fromJson(map);
    })();
  }
  ...
  Future<PromotionsDiscountApplicationsReleaseResult?> promotionsDiscountApplicationsRelease(String applicationId, PromotionCommandRequest body, String idempotencyKey, [String? xRequestId]) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.appPath('/promotions/discount_applications/${serializePathParameter(applicationId, const PathParameterSpec('applicationId', 'simple', false))}/releases'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : PromotionsDiscountApplicationsReleaseResult.fromJson(map);
    })();
  }
  ...
  Future<PromotionsDiscountApplicationsSettleResult?> promotionsDiscountApplicationsSettle(String applicationId, PromotionCommandRequest body, String idempotencyKey, [String? xRequestId]) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.appPath('/promotions/discount_applications/${serializePathParameter(applicationId, const PathParameterSpec('applicationId', 'simple', false))}/settlements'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<SiteRuntimeRetrieveResult?> siteRuntimeRetrieve([String? tenantCode, String? organizationCode]) async {
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.appPath('/system/site/runtime'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
