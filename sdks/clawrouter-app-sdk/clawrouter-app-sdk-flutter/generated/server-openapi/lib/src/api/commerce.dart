...
class CommerceApi {
  ...
  /// Addresses List
  Future<AddressesListResult?> addressesList([String? page, String? pageSize, String? status]) async {
  ...
  Future<BillingHistoryListResult?> billingHistoryList([String? page, String? pageSize, String? type, String? status]) async {
    final query = buildQueryString([
      QueryParameterSpec('page', page, 'form', true, false, null),
      QueryParameterSpec('page_size', pageSize, 'form', true, false, null),
  ...
  Future<MembershipsBenefitsListResult?> membershipsBenefitsList([String? planId]) async {
    final query = buildQueryString([
  ...
  Future<MembershipsPackageGroupsListResult?> getMembershipsPackageGroupsList([String? planId, bool? recommendedOnly]) async {
    final query = buildQueryString([
      QueryParameterSpec('plan_id', planId, 'form', true, false, null),
  ...
  Future<MembershipsPackageGroupsPackagesListResult?> getMembershipsPackageGroupsListPackageGroups(String packageGroupId, [String? planId]) async {
    final query = buildQueryString([
      QueryParameterSpec('plan_id', planId, 'form', true, false, null)
    ]);
  ...
  Future<MembershipsPackagesListResult?> membershipsPackagesList([String? page, String? pageSize, String? status]) async {
    final query = buildQueryString([
      QueryParameterSpec('page', page, 'form', true, false, null),
      QueryParameterSpec('page_size', pageSize, 'form', true, false, null),
      QueryParameterSpec('status', status, 'form', true, false, null)
  ...
  Future<MembershipsPointsHistoryListResult?> membershipsPointsHistoryList([String? page, String? pageSize, String? cursor]) async {
    final query = buildQueryString([
      QueryParameterSpec('page', page, 'form', true, false, null),
      QueryParameterSpec('page_size', pageSize, 'form', true, false, null),
