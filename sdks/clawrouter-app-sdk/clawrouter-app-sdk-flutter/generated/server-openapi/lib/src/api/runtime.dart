...
class RuntimeApi {
  ...
  Future<InvocationsListResult?> invocationsList([int? page, int? pageSize, String? conversationId, String? chatTurnId, String? agentSessionId, String? runtime, String? status]) async {
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.appPath('/runtime/invocations'), query));
    return (() {
  ...
  Future<InvocationsCreateResult?> invocationsCreate(RuntimeInvocationCreateRequest body, String idempotencyKey) async {
    ...
    final response = await _client.post(ApiPaths.appPath('/runtime/invocations'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<ArtifactsListResult?> artifactsList(String invocationId, [int? page, int? pageSize]) async {
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.appPath('/runtime/invocations/${serializePathParameter(invocationId, const PathParameterSpec('invocationId', 'simple', false))}/artifacts'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<ArtifactsCreateResult?> artifactsCreate(String invocationId, RuntimeArtifactCreateRequest body, String idempotencyKey) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.appPath('/runtime/invocations/${serializePathParameter(invocationId, const PathParameterSpec('invocationId', 'simple', false))}/artifacts'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<InvocationsSubmitResult?> invocationsSubmit(String invocationId, RuntimeInvocationCompleteRequest body, String idempotencyKey) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.appPath('/runtime/invocations/${serializePathParameter(invocationId, const PathParameterSpec('invocationId', 'simple', false))}/complete'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<InvocationEventsListResult?> invocationEventsList(String invocationId, [int? page, int? pageSize]) async {
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.appPath('/runtime/invocations/${serializePathParameter(invocationId, const PathParameterSpec('invocationId', 'simple', false))}/events'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<InvocationEventsCreateResult?> invocationEventsCreate(String invocationId, RuntimeEventCreateRequest body, String idempotencyKey) async {
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.appPath('/runtime/invocations/${serializePathParameter(invocationId, const PathParameterSpec('invocationId', 'simple', false))}/events'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
