...
class IamApi {
  ...
  Future<DepartmentAssignmentsListResult?> departmentAssignmentsList([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    ...
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DepartmentAssignmentsListResult.fromJson(map);
    })();
  }

  /// List current IAM departments
  Future<DepartmentsListResult?> departmentsList([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DepartmentsListResult.fromJson(map);
    })();
  }

  /// Retrieve current IAM department tree
  Future<DepartmentsTreeRetrieveResult?> departmentsTreeRetrieve([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.appPath('/iam/departments/tree'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DepartmentsTreeRetrieveResult.fromJson(map);
    })();
  }

  /// List current IAM organization memberships
  Future<OrganizationMembershipsListResult?> organizationMembershipsList([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : OrganizationMembershipsListResult.fromJson(map);
    })();
  }

  /// List current IAM organizations
  Future<OrganizationsListResult?> organizationsList([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : OrganizationsListResult.fromJson(map);
    })();
  }

  /// Retrieve current IAM organization tree
  Future<OrganizationsTreeRetrieveResult?> organizationsTreeRetrieve([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.appPath('/iam/organizations/tree'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : OrganizationsTreeRetrieveResult.fromJson(map);
    })();
  }

  /// List current IAM position assignments
  Future<PositionAssignmentsListResult?> positionAssignmentsList([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : PositionAssignmentsListResult.fromJson(map);
    })();
  }

  /// List current IAM positions
  Future<PositionsListResult?> positionsList([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : PositionsListResult.fromJson(map);
    })();
  }

  /// List current IAM role bindings
  Future<RoleBindingsListResult?> roleBindingsList([String? organizationId, String? departmentId, String? userId, String? scopeId, String? status, String? q, int? page, int? pageSize]) async {
    final query = buildQueryString([
      QueryParameterSpec('organization_id', organizationId, 'form', true, false, null),
      QueryParameterSpec('department_id', departmentId, 'form', true, false, null),
      QueryParameterSpec('user_id', userId, 'form', true, false, null),
    ...
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : RoleBindingsListResult.fromJson(map);
    })();
  }
