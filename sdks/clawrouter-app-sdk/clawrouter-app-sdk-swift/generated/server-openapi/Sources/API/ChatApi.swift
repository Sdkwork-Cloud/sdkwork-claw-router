...
public class ChatApi {
    ...
    public func conversationsList(page: Int? = nil, pageSize: Int? = nil) async throws -> ConversationsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/chat/conversations"), query), responseType: ConversationsListResult.self)
    }
    ...
    public func conversationsCreate(body: ChatConversationCreateRequest, idempotencyKey: String) async throws -> ConversationsCreateResult? {
        ...
        return try await client.post(ApiPaths.appPath("/chat/conversations"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ConversationsCreateResult.self)
    }
    ...
    public func conversationMessagesList(conversationId: String, limit: Int? = nil, order: String? = nil) async throws -> ConversationMessagesListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/chat/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversationId", style: "simple", explode: false)))/messages"), query), responseType: ConversationMessagesListResult.self)
    }
    ...
    public func turnsCreate(conversationId: String, body: ChatTurnCreateRequest, idempotencyKey: String) async throws -> TurnsCreateResult? {
        ...
        return try await client.post(ApiPaths.appPath("/chat/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversationId", style: "simple", explode: false)))/turns"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: TurnsCreateResult.self)
    }
