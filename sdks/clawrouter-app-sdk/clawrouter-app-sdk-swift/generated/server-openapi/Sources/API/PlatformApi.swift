...
public class PlatformApi {
    ...
    public func appsStoreList(page: Int? = nil, pageSize: Int? = nil, q: String? = nil, category: String? = nil, platformType: String? = nil, platformTypes: [String]? = nil, sort: String? = nil, status: String? = nil, startTime: String? = nil, endTime: String? = nil) async throws -> AppsStoreListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/platform/apps/store"), query), responseType: AppsStoreListResult.self)
    }

    /// Get categories
    public func appsStoreCategoriesList() async throws -> AppsStoreCategoriesListResult? {
        return try await client.get(ApiPaths.appPath("/platform/apps/store/categories"), responseType: AppsStoreCategoriesListResult.self)
    }

    /// Get app by ID
    public func appsStoreRetrieve(appId: String) async throws -> AppsStoreRetrieveResult? {
        return try await client.get(ApiPaths.appPath("/platform/apps/store/\(serializePathParameter(appId, PathParameterSpec(name: "appId", style: "simple", explode: false)))"), responseType: AppsStoreRetrieveResult.self)
    }
