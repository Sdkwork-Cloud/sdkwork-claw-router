...
public class EcosystemApi {
    ...
    public func skillsList(q: String? = nil, page: Int? = nil, pageSize: Int? = nil, status: String? = nil, startTime: String? = nil, endTime: String? = nil) async throws -> SkillsListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/ecosystem/skills"), query), responseType: SkillsListResult.self)
    }

    /// Get categories
    public func skillsCategoriesList() async throws -> SkillsCategoriesListResult? {
        return try await client.get(ApiPaths.appPath("/ecosystem/skills/categories"), responseType: SkillsCategoriesListResult.self)
    }

    /// Get skill by ID
    public func skillsRetrieve(skillId: String) async throws -> SkillsRetrieveResult? {
        return try await client.get(ApiPaths.appPath("/ecosystem/skills/\(serializePathParameter(skillId, PathParameterSpec(name: "skillId", style: "simple", explode: false)))"), responseType: SkillsRetrieveResult.self)
    }
    ...
    /// Get my skills
    public func usersCurrentSkillsList() async throws -> UsersCurrentSkillsListResult? {
        return try await client.get(ApiPaths.appPath("/ecosystem/users/current/skills"), responseType: UsersCurrentSkillsListResult.self)
    }
