...
public class MemoryApi {
    ...
    public func entriesRetrieve(entryId: String) async throws -> EntriesRetrieveResult? {
        return try await client.get(ApiPaths.appPath("/memory/entries/\(serializePathParameter(entryId, PathParameterSpec(name: "entryId", style: "simple", explode: false)))"), responseType: EntriesRetrieveResult.self)
    }
    ...
    public func spacesList(page: Int? = nil, pageSize: Int? = nil) async throws -> SpacesListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/memory/spaces"), query), responseType: SpacesListResult.self)
    }
    ...
    public func spacesCreate(body: MemorySpaceCreateRequest, idempotencyKey: String, xRequestId: String? = nil) async throws -> SpacesCreateResult? {
        ...
        return try await client.post(ApiPaths.appPath("/memory/spaces"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: SpacesCreateResult.self)
    }

    /// Retrieve memory space
    public func spacesRetrieve(spaceId: String) async throws -> SpacesRetrieveResult? {
        return try await client.get(ApiPaths.appPath("/memory/spaces/\(serializePathParameter(spaceId, PathParameterSpec(name: "spaceId", style: "simple", explode: false)))"), responseType: SpacesRetrieveResult.self)
    }
    ...
    public func entriesList(spaceId: String, page: Int? = nil, pageSize: Int? = nil) async throws -> EntriesListResult? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/memory/spaces/\(serializePathParameter(spaceId, PathParameterSpec(name: "spaceId", style: "simple", explode: false)))/entries"), query), responseType: EntriesListResult.self)
    }
    ...
    public func entriesCreate(spaceId: String, body: MemoryEntryCreateRequest, idempotencyKey: String, xRequestId: String? = nil) async throws -> EntriesCreateResult? {
        ...
        return try await client.post(ApiPaths.appPath("/memory/spaces/\(serializePathParameter(spaceId, PathParameterSpec(name: "spaceId", style: "simple", explode: false)))/entries"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: EntriesCreateResult.self)
    }
