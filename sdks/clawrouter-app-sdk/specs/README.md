# SDKWork Claw Router app API SDK Component Specs

This directory is the local standards index for `clawrouter-app-sdk`.
...
| Field | Value |
| --- | --- |
| Name | `clawrouter-app-sdk` |
| Type | `sdk-family` |
| Root | `sdkwork-claw-router/sdks/clawrouter-app-sdk` |
| Domain | `platform` |
| Capability | `router` |
