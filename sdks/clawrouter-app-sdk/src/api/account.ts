...
import type { FetchAccountDetailsResult, SubmitRechargeRequest, SubmitRechargeResult } from '../types';
...
/** Create recharge */
  async submitRecharge(body: SubmitRechargeRequest): Promise<SubmitRechargeResult> {
    return this.client.post<SubmitRechargeResult>(appApiPath(`/account/points/recharge`), body, undefined, undefined, 'application/json');
  }

/** List account details */
  async fetchAccountDetails(pageNo?: number, pageSize?: number, keyword?: string, status?: string, startTime?: string, endTime?: string): Promise<FetchAccountDetailsResult> {
    ...
    return this.client.get<FetchAccountDetailsResult>(appendQueryString(appApiPath(`/account/summary`), query));
  }
}
