...
import type { FetchRedeemHistoryResult, RedeemCodeRequest, RedeemCodeResult } from '../types';
...
/** List redeem history */
  async fetchRedeemHistory(pageNo?: number, pageSize?: number, keyword?: string, status?: string, startTime?: string, endTime?: string): Promise<FetchRedeemHistoryResult> {
    ...
    return this.client.get<FetchRedeemHistoryResult>(appendQueryString(appApiPath(`/coupons/my`), query));
  }

/** Redeem code */
  async redeemCode(body: RedeemCodeRequest): Promise<RedeemCodeResult> {
    return this.client.post<RedeemCodeResult>(appApiPath(`/coupons/redeem`), body, undefined, undefined, 'application/json');
  }
}
