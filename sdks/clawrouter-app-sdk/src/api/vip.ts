...
import type { FetchPackagesResult } from '../types';
...
/** List packages */
  async fetchPackages(pageNo?: number, pageSize?: number, keyword?: string, status?: string, startTime?: string, endTime?: string): Promise<FetchPackagesResult> {
    ...
    return this.client.get<FetchPackagesResult>(appendQueryString(appApiPath(`/vip/pack-groups/packs`), query));
  }
}
