...
import type { FetchMessagesResult } from '../types';
...
/** List messages */
  async fetchMessages(pageNo?: number, pageSize?: number, keyword?: string, status?: string, startTime?: string, endTime?: string): Promise<FetchMessagesResult> {
    ...
    return this.client.get<FetchMessagesResult>(appendQueryString(appApiPath(`/notification`), query));
  }
}
