...
class BillingVipApi:
    ...
    def __init__(self, client: HttpClient):
        ...
        self.info = BillingVipInfoApi(client)
        self.levels = BillingVipLevelsApi(client)
        self.pack_groups = BillingVipPackGroupsApi(client)
        self.packs = BillingVipPacksApi(client)
        self.points = BillingVipPointsApi(client)
        self.privileges = BillingVipPrivilegesApi(client)
        self.purchase = BillingVipPurchaseApi(client)
        self.status = BillingVipStatusApi(client)
...
class BillingVipBenefitsApi:
    ...
    def list(self) -> VipBenefitsListResult:
        """List VIP benefits"""
        return self._client.get(f"/app/v3/api/billing/vip/benefits")
...
class BillingVipInfoApi:
    ...
    def retrieve(self) -> VipInfoRetrieveResult:
        """Retrieve VIP info"""
        return self._client.get(f"/app/v3/api/billing/vip/info")
...
class BillingVipLevelsApi:
    ...
    def list(self) -> VipLevelsListResult:
        """List VIP levels"""
        return self._client.get(f"/app/v3/api/billing/vip/levels")
...
class BillingVipPackGroupsApi:
    ...
    def list(self) -> VipPackGroupsListResult:
        """List VIP pack groups"""
        return self._client.get(f"/app/v3/api/billing/vip/pack_groups")

    def retrieve(self, pack_group_id: str) -> VipPackGroupsRetrieveResult:
        """Retrieve VIP pack group"""
        return self._client.get(f"/app/v3/api/billing/vip/pack_groups/{serialize_path_parameter(pack_group_id, {'name': 'packGroupId', 'style': 'simple', 'explode': False})}")
...
class BillingVipPackGroupsPacksApi:
    ...
    def list(self, pack_group_id: str) -> VipPackGroupsPacksListResult:
        """List VIP pack group packs"""
        return self._client.get(f"/app/v3/api/billing/vip/pack_groups/{serialize_path_parameter(pack_group_id, {'name': 'packGroupId', 'style': 'simple', 'explode': False})}/packs")
...
class BillingVipPacksApi:
    ...
    def retrieve(self, pack_id: str) -> VipPacksRetrieveResult:
        """Retrieve VIP pack"""
        return self._client.get(f"/app/v3/api/billing/vip/packs/{serialize_path_parameter(pack_id, {'name': 'packId', 'style': 'simple', 'explode': False})}")
...
class BillingVipPointsApi:
    ...
    def __init__(self, client: HttpClient):
        ...
        self.daily_rewards = BillingVipPointsDailyRewardsApi(client)
        self.history = BillingVipPointsHistoryApi(client)
...
class BillingVipPointsBalanceApi:
    ...
    def retrieve(self) -> VipPointsBalanceRetrieveResult:
        """Retrieve VIP points balance"""
        return self._client.get(f"/app/v3/api/billing/vip/points/balance")
...
class BillingVipPointsDailyRewardsApi:
    ...
    def create(self, body: CommerceEmptyCommandRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> VipPointsDailyRewardsCreateResult:
        ...
        return self._client.post(f"/app/v3/api/billing/vip/points/daily_rewards", json=body, headers=request_headers)
...
class BillingVipPointsDailyRewardsStatusApi:
    ...
    def retrieve(self) -> VipPointsDailyRewardsStatusRetrieveResult:
        """Retrieve VIP daily reward status"""
        return self._client.get(f"/app/v3/api/billing/vip/points/daily_rewards/status")
...
class BillingVipPointsHistoryApi:
    ...
    def list(self, page: Optional[int] = None, page_size: Optional[int] = None, cursor: Optional[str] = None) -> VipPointsHistoryListResult:
        ...
        return self._client.get(_append_query_string(f"/app/v3/api/billing/vip/points/history", query))
...
class BillingVipPrivilegesApi:
    ...
    def __init__(self, client: HttpClient):
        ...
        self.usage = BillingVipPrivilegesUsageApi(client)
...
class BillingVipPrivilegesSpeedUpsApi:
    ...
    def create(self, body: CommerceVipPrivilegeSpeedUpRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> VipPrivilegesSpeedUpsCreateResult:
        ...
        return self._client.post(f"/app/v3/api/billing/vip/privileges/speed_ups", json=body, headers=request_headers)
...
class BillingVipPrivilegesUsageApi:
    ...
    def retrieve(self) -> VipPrivilegesUsageRetrieveResult:
        """Retrieve VIP privilege usage"""
        return self._client.get(f"/app/v3/api/billing/vip/privileges/usage")
...
class BillingVipPurchaseApi:
    ...
    def create(self, body: CommerceVipPurchaseRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> VipPurchaseCreateResult:
        """Create VIP purchase"""
        request_headers = build_request_headers(
            {
                'Idempotency-Key': {'value': idempotency_key, 'style': 'simple', 'explode': False},
        ...
        return self._client.post(f"/app/v3/api/billing/vip/purchase", json=body, headers=request_headers)

    def renew(self, body: CommerceVipPurchaseRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> VipPurchaseRenewResult:
        """Renew VIP purchase"""
        request_headers = build_request_headers(
            {
                'Idempotency-Key': {'value': idempotency_key, 'style': 'simple', 'explode': False},
        ...
        return self._client.post(f"/app/v3/api/billing/vip/purchase/renew", json=body, headers=request_headers)

    def upgrade(self, body: CommerceVipPurchaseRequest, idempotency_key: str, x_request_id: Optional[str] = None) -> VipPurchaseUpgradeResult:
        ...
        return self._client.post(f"/app/v3/api/billing/vip/purchase/upgrade", json=body, headers=request_headers)
...
class BillingVipStatusApi:
    ...
    def retrieve(self) -> VipStatusRetrieveResult:
        """Retrieve VIP status"""
        return self._client.get(f"/app/v3/api/billing/vip/status")
