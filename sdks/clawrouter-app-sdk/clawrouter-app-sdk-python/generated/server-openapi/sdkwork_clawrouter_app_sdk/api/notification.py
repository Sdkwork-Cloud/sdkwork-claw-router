...
from ..models import NotificationsAcknowledgeCreateResult, NotificationsListResult, NotificationsPopupSeenCreateResult
...
class NotificationApi:
    ...
    def __init__(self, client: HttpClient):
        self._client = client
        self.acknowledge = NotificationAcknowledgeApi(client)
    ...
    def list_notifications(self, app_id: Optional[str] = None, include_archived: Optional[bool] = None, page: Optional[int] = None, page_size: Optional[int] = None) -> NotificationsListResult:
        ...
        return self._client.get(_append_query_string(f"/app/v3/api/notification/notifications", query))

class NotificationAcknowledgeApi:
    """notification notifications.acknowledge API client."""
