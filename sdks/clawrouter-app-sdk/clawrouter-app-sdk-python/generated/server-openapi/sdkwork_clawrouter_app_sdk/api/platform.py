...
from ..models import AppsStoreCategoriesListResult, AppsStoreListResult, AppsStoreRetrieveResult
...
class PlatformAppsStoreApi:
    ...
    def list(self, page: Optional[int] = None, page_size: Optional[int] = None, q: Optional[str] = None, status: Optional[str] = None, start_time: Optional[str] = None, end_time: Optional[str] = None) -> AppsStoreListResult:
        ...
        return self._client.get(_append_query_string(f"/app/v3/api/platform/apps/store", query))

    def retrieve(self, app_id: str) -> AppsStoreRetrieveResult:
        """Get app by ID"""
        return self._client.get(f"/app/v3/api/platform/apps/store/{serialize_path_parameter(app_id, {'name': 'appId', 'style': 'simple', 'explode': False})}")
...
class PlatformAppsStoreCategoriesApi:
    ...
    def list(self) -> AppsStoreCategoriesListResult:
        """Get categories"""
        return self._client.get(f"/app/v3/api/platform/apps/store/categories")
