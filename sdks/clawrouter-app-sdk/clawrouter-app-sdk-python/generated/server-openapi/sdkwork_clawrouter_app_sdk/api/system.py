...
class SystemSiteRuntimeApi:
    ...
    def retrieve(self, tenant_code: Optional[str] = None, organization_code: Optional[str] = None) -> SiteRuntimeRetrieveResult:
        ...
        return self._client.get(_append_query_string(f"/app/v3/api/system/site/runtime", query))
