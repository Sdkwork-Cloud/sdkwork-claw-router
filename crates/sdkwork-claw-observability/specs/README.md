# SDKWork Claw Observability Component Specs

This directory is the local standards index for `sdkwork-claw-observability`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-observability` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-observability` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/sdkwork-claw-observability/Cargo.toml`
