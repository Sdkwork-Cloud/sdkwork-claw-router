# SDKWork Claw Contract Component Specs

This directory is the local standards index for `sdkwork-claw-contract`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-contract` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-contract` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/sdkwork-claw-contract/Cargo.toml`
