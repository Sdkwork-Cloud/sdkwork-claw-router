...
pub const PACKAGE_NAME: &str = "sdkwork-router-drive-open-api";
pub const CAPABILITY: &str = "drive";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-drive-open-api";
pub const SDK_FAMILY: &str = "sdkwork-drive-sdk";
