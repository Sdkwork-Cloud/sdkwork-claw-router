# SDKWork Claw Core Component Specs

This directory is the local standards index for `sdkwork-claw-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-core` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-core` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
