...
This README is the SDKWork module entrypoint for `sdkwork-claw-core`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/sdkwork-claw-core/Cargo.toml`
