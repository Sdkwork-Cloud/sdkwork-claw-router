# SDKWork Claw Provider Adapter Contract Component Specs

This directory is the local standards index for `sdkwork-claw-provider-adapter-contract`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-provider-adapter-contract` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-provider-adapter-contract` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/sdkwork-claw-provider-adapter-contract/Cargo.toml`
