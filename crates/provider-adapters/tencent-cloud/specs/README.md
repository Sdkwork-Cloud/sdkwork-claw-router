# SDKWork Provider Adapter Tencent Cloud Component Specs

This directory is the local standards index for `sdkwork-provider-adapter-tencent-cloud`.
...
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/provider-adapters/tencent-cloud` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
