# sdkwork-provider-adapter-alicloud
...
This README is the SDKWork module entrypoint for `sdkwork-provider-adapter-alicloud`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/provider-adapters/alicloud/Cargo.toml`
