# SDKWork Provider Adapter Alicloud Component Specs

This directory is the local standards index for `sdkwork-provider-adapter-alicloud`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-provider-adapter-alicloud` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/provider-adapters/alicloud` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
