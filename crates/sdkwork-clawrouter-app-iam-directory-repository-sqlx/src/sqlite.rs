...
fn row_to_organization(row: &sqlx::sqlite::SqliteRow) -> RepositoryResult<AppIamOrganizationItem> {
...
fn row_to_department(row: &sqlx::sqlite::SqliteRow) -> RepositoryResult<AppIamDepartmentItem> {
...
fn row_to_position(row: &sqlx::sqlite::SqliteRow) -> RepositoryResult<AppIamPositionItem> {
...
fn row_to_role_binding(row: &sqlx::sqlite::SqliteRow) -> RepositoryResult<AppIamRoleBindingItem> {
...
async fn table_exists(pool: &SqlitePool, table_name: &str) -> RepositoryResult<bool> {
