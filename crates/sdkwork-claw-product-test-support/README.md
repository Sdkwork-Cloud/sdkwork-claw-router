# sdkwork-claw-product-test-support
...
This README is the SDKWork module entrypoint for `sdkwork-claw-product-test-support`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
