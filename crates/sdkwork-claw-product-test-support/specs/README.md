# SDKWork Claw Product Test Support Component Specs

This directory is the local standards index for `sdkwork-claw-product-test-support`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-product-test-support` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-product-test-support` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/sdkwork-claw-product-test-support/Cargo.toml`
