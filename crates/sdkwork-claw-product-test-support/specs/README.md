...
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/crates/sdkwork-claw-product-test-support` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/crates/sdkwork-claw-product-test-support/Cargo.toml`
