# SDKWork Claw Config Component Specs

This directory is the local standards index for `sdkwork-claw-config`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-config` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-config` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
