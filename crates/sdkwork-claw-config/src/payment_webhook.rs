...
impl PaymentWebhookConfig {
    pub const ENV_PAYMENT_WEBHOOK_SECRET: &'static str = "SDKWORK_CLAW_PAYMENT_WEBHOOK_SECRET";
    pub const ENV_PAYMENT_WEBHOOK_MAX_CLOCK_SKEW_SECONDS: &'static str =
        "SDKWORK_CLAW_PAYMENT_WEBHOOK_MAX_CLOCK_SKEW_SECONDS";
    pub const MIN_SIGNING_SECRET_LEN: usize = 32;
    pub const DEFAULT_MAX_CLOCK_SKEW_SECONDS: u64 = 600;
...
impl fmt::Debug for PaymentWebhookConfig {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        formatter
            .debug_struct("PaymentWebhookConfig")
