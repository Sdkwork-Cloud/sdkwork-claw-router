...
fn alert_from_row(row: sqlx::sqlite::SqliteRow) -> RepositoryResult<AdminMonitorAlert> {
...
fn required_decimal_cell(row: &sqlx::sqlite::SqliteRow, column: &str) -> RepositoryResult<f64> {
