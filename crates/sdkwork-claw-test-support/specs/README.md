# SDKWork Claw Test Support Component Specs

This directory is the local standards index for `sdkwork-claw-test-support`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-test-support` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-test-support` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/sdkwork-claw-test-support/Cargo.toml`
