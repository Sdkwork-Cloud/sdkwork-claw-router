# SDKWork Claw Provider Adapter Core Component Specs

This directory is the local standards index for `sdkwork-claw-provider-adapter-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-provider-adapter-core` |
| Type | `rust-crate` |
| Root | `sdkwork-claw-router/crates/sdkwork-claw-provider-adapter-core` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-claw-router/crates/sdkwork-claw-provider-adapter-core/Cargo.toml`
