# SDKWork File Upload Client Component Specs

This directory is the local standards index for `@sdkwork/file-upload-client`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-upload-client` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/packages/common/file/sdkwork-file-upload-client` |
| Domain | `drive` |
