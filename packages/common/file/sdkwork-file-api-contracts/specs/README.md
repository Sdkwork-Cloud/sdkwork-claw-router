# SDKWork File API Contracts Component Specs

This directory is the local standards index for `@sdkwork/file-api-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-api-contracts` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/packages/common/file/sdkwork-file-api-contracts` |
| Domain | `file` |
