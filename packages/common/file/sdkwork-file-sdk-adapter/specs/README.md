# SDKWork File SDK Adapter Component Specs

This directory is the local standards index for `@sdkwork/file-sdk-adapter`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-sdk-adapter` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/packages/common/file/sdkwork-file-sdk-adapter` |
| Domain | `file` |
