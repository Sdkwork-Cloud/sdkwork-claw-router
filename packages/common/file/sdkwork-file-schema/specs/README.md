# SDKWork File Schema Component Specs

This directory is the local standards index for `@sdkwork/file-schema`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-schema` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/packages/common/file/sdkwork-file-schema` |
| Domain | `file` |
