# SDKWork File SDK Generation Component Specs

This directory is the local standards index for `@sdkwork/file-sdk-generation`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-sdk-generation` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/packages/common/file/sdkwork-file-sdk-generation` |
| Domain | `file` |
