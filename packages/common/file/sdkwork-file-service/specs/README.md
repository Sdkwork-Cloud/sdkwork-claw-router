# SDKWork File Service Component Specs

This directory is the local standards index for `@sdkwork/file-service`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-service` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/packages/common/file/sdkwork-file-service` |
| Domain | `file` |
