# SDKWork Storage Admin PC React Component Specs

This directory is the local standards index for `@sdkwork/storage-admin-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/storage-admin-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-claw-router/packages/pc-react/file/sdkwork-storage-admin-pc-react` |
| Domain | `file` |
