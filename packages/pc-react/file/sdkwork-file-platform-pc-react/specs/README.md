# SDKWork File Platform PC React Component Specs

This directory is the local standards index for `@sdkwork/file-platform-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-platform-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-claw-router/packages/pc-react/file/sdkwork-file-platform-pc-react` |
| Domain | `file` |
| Capability | `file-platform` |
...
- `pnpm --filter @sdkwork/file-platform-pc-react typecheck`
