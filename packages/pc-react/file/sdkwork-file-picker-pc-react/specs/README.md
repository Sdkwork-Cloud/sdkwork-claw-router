# SDKWork File Picker PC React Component Specs

This directory is the local standards index for `@sdkwork/file-picker-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-picker-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-claw-router/packages/pc-react/file/sdkwork-file-picker-pc-react` |
| Domain | `file` |
