# SDKWork File Attachments PC React Component Specs

This directory is the local standards index for `@sdkwork/file-attachments-pc-react`.
...
- `pnpm --filter @sdkwork/file-attachments-pc-react typecheck`
