# SDKWork File Upload PC React Component Specs

This directory is the local standards index for `@sdkwork/file-upload-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/file-upload-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-claw-router/packages/pc-react/file/sdkwork-file-upload-pc-react` |
| Domain | `file` |
