...
function resolveAuthorizationToken(
  ...
  if (tokenBundle.authToken) {
    return tokenBundle.authToken;
  }

  return runtimeConfig.auth.allowAuthorizationFallbackToAccessToken
...
export function createUserCenterRuntimeClient(
  ...
  async function request<TResponse>(
    ...
    const tokenHeaders = resolveRuntimeTokenHeaders(runtimeConfig);
    const authorizationToken = resolveAuthorizationToken(runtimeConfig, tokenBundle);
  ...
  return {
    ...
    getAccount() {
      return request("GET", runtimeConfig.localApi.account);
    },
    ...
    getMembership() {
      return request("GET", runtimeConfig.localApi.membership);
    },
    ...
    updateMembership(payload) {
      return request("PATCH", runtimeConfig.localApi.membership, payload);
    },
