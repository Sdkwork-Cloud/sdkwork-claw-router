# SDKWork User Center Native Component Specs

This directory is the local standards index for `sdkwork_user_center_native`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_user_center_native` |
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/pc-react/iam/sdkwork-user-center-core-pc-react/native/tauri-rust` |
| Domain | `iam` |
| Capability | `user` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/pc-react/iam/sdkwork-user-center-core-pc-react/native/tauri-rust/Cargo.toml`
