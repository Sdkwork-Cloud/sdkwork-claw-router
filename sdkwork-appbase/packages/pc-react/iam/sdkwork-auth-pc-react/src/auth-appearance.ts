...
.sdkwork-auth-surface {
  ...
  --sdkwork-auth-divider-color: rgba(24, 24, 27, 0.100);
  --sdkwork-auth-field-background-color: #ffffff;
  --sdkwork-auth-field-border-color: #e4e4e7;
  ...
  --sdkwork-auth-oauth-card-background-color: rgba(244, 244, 245, 0.800);
  --sdkwork-auth-oauth-card-border-color: rgba(24, 24, 27, 0.100);
  --sdkwork-auth-oauth-card-hint-color: #71717a;
  --sdkwork-auth-oauth-card-icon-background-color: #f4f4f5;
  --sdkwork-auth-oauth-card-icon-color: #52525b;
  --sdkwork-auth-oauth-card-title-color: #18181b;
  --sdkwork-auth-outline-button-background-color: #ffffff;
  --sdkwork-auth-outline-button-border-color: #e4e4e7;
  --sdkwork-auth-outline-button-text-color: #18181b;
  ...
  --sdkwork-auth-tabs-background-color: rgba(244, 244, 245, 0.800);
}
...
.sdkwork-auth-surface[data-sdk-color-mode="dark"] {
  ...
  --sdkwork-auth-divider-color: #27272a;
  --sdkwork-auth-field-background-color: #09090b;
  --sdkwork-auth-field-border-color: #27272a;
  --sdkwork-auth-field-placeholder-color: #a1a1aa;
  ...
  --sdkwork-auth-oauth-card-background-color: rgba(24, 24, 27, 0.800);
  --sdkwork-auth-oauth-card-border-color: rgba(39, 39, 42, 0.900);
  --sdkwork-auth-oauth-card-hint-color: #a1a1aa;
  --sdkwork-auth-oauth-card-icon-background-color: #18181b;
  --sdkwork-auth-oauth-card-icon-color: #d4d4d8;
  --sdkwork-auth-oauth-card-title-color: #f4f4f5;
  --sdkwork-auth-outline-button-background-color: #18181b;
  --sdkwork-auth-outline-button-border-color: #27272a;
  --sdkwork-auth-outline-button-text-color: #f4f4f5;
  --sdkwork-auth-tab-active-background-color: #09090b;
  --sdkwork-auth-tab-active-icon-color: #fecaca;
  --sdkwork-auth-tab-active-text-color: #ffffff;
  --sdkwork-auth-tab-hover-background-color: rgba(9, 9, 11, 0.700);
...
.sdkwork-auth-callback-shell[data-sdk-color-mode="dark"] {
  background-color: rgba(24, 24, 27, 0.920);
}
`;
...
export function createSdkworkAuthStandardAppearancePreset(): SdkworkAuthAppearanceConfig {
  return {
    theme: {
      ...
      fieldBorderColor: "rgba(24, 24, 27, 0.160)",
      ...
      oauthProviderCardBackgroundColor: "rgba(244, 244, 245, 0.800)",
      oauthProviderCardBorderColor: "rgba(24, 24, 27, 0.100)",
      oauthProviderCardHintColor: "#71717a",
      oauthProviderCardIconBackgroundColor: "#f4f4f5",
      ...
      shellBackgroundColor: "rgba(255, 255, 255, 0.920)",
      shellBorderColor: "transparent",
      tabActiveBackgroundColor: "#ffffff",
      tabActiveTextColor: "#09090b",
      tabBackgroundColor: "rgba(244, 244, 245, 0.800)",
