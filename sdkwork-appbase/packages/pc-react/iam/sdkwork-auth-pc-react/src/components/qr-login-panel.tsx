  ...
  return (
    <div
      className={mergeSdkworkAuthClassNames(
        "relative flex h-full flex-col justify-center overflow-hidden rounded-[28px] bg-zinc-950 p-8 text-white",
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[360px] flex-col justify-center gap-8">
        ...
        <div>
          <div
            className={mergeSdkworkAuthClassNames(
              "rounded-[30px] bg-zinc-900/70 p-4 backdrop-blur-sm",
          ...
          >
            <div
              className="mx-auto aspect-square min-h-[280px] w-full max-w-[280px]"
          ...
          {shouldShowStatus ? (
            <div className={`mt-5 text-sm font-medium ${
              qrState === "scanned" || qrState === "passwordRequired" || qrState === "bindRequired"
                ? "text-amber-300"
                : qrState === "confirmed"
                  ? "text-emerald-300"
