  ...
  return (
    <section
      className={mergeSdkworkAuthClassNames(
        viewportMode === "fixed"
          ? "sdkwork-iam-auth-routes fixed inset-0 z-[60] h-[100dvh] min-h-[100dvh] w-full min-w-0 shrink-0 overflow-hidden bg-zinc-100 dark:bg-zinc-950"
          : "sdkwork-iam-auth-routes relative isolate h-[100dvh] min-h-[100dvh] w-full min-w-0 shrink-0 overflow-hidden bg-zinc-100 dark:bg-zinc-950",
        className,
      )}
