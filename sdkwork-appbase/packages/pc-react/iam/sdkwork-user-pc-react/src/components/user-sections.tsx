...
export function SdkworkUserOverviewSection({
  ...
  const displayName = [profile.firstName, profile.lastName].filter(Boolean).join(" ").trim() || copy.overview.displayNameFallback;
      ...
      >
        ...
        >
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Input
              disabled={!capabilities.emailEditable}
              type="email"
              value={draft.email}
          ...
          <div className="md:col-span-2 flex justify-end">
            <Button loading={isSaving} type="submit">{copy.profile.saveButton}</Button>
          </div>
        </form>
      </SettingsSection>
    </Surface>
