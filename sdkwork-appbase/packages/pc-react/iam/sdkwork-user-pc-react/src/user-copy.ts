...
const EN_US_MESSAGES: SdkworkUserMessages = {
  ...
  overview: {
    ...
    displayNameFallback: "SDKWORK User",
  ...
  security: {
    boundaryDescription: "This section keeps profile and security logic in the shared IAM package while leaving application-level commerce or workflow settings to other domains.",
...
const ZH_CN_MESSAGES: SdkworkUserMessages = {
  ...
  overview: {
    ...
    displayNameFallback: "SDKWORK 用户",
    generalTitle: "通用",
