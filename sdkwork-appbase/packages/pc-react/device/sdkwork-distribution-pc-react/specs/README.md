# SDKWork Distribution PC React Component Specs

This directory is the local standards index for `@sdkwork/distribution-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/distribution-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/device/sdkwork-distribution-pc-react` |
| Domain | `device` |
...
- `pnpm --filter @sdkwork/distribution-pc-react typecheck`
