# SDKWork Install PC React Component Specs

This directory is the local standards index for `@sdkwork/install-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/install-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/device/sdkwork-install-pc-react` |
| Domain | `device` |
| Capability | `install` |
...
- `pnpm --filter @sdkwork/install-pc-react typecheck`
