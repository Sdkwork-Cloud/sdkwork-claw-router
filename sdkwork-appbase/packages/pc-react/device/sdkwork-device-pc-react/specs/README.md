# SDKWork Device PC React Component Specs

This directory is the local standards index for `@sdkwork/device-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/device-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/device/sdkwork-device-pc-react` |
| Domain | `device` |
| Capability | `device` |
...
- `pnpm --filter @sdkwork/device-pc-react typecheck`
