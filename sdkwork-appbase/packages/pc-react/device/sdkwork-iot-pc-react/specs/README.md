# SDKWork Iot PC React Component Specs

This directory is the local standards index for `@sdkwork/iot-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iot-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/device/sdkwork-iot-pc-react` |
| Domain | `device` |
| Capability | `iot` |
...
- `pnpm --filter @sdkwork/iot-pc-react typecheck`
