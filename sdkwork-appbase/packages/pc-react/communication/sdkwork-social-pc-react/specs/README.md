# SDKWork Social PC React Component Specs

This directory is the local standards index for `@sdkwork/social-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/social-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/communication/sdkwork-social-pc-react` |
...
- `pnpm --filter @sdkwork/social-pc-react typecheck`
