# SDKWork Community PC React Component Specs

This directory is the local standards index for `@sdkwork/community-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/community-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/communication/sdkwork-community-pc-react` |
...
- `pnpm --filter @sdkwork/community-pc-react typecheck`
