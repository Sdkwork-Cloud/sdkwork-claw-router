...
export type SdkworkCommunityReviewState =
  | "approved"
  | "draft"
  | "flagged"
  | "pending-review"
...
export interface SdkworkCommunityWorkspaceManifest extends SdkworkAppCapabilityManifest {
...
function resolveCommunityEntryDigestStatus(
  entry: SdkworkCommunityEntry,
): SdkworkCommunityEntryDigestStatus {
...
function toUniqueCommunityPublicationIssues(
  issues: readonly SdkworkCommunityPublicationIssue[],
...
export function normalizeCommunityReviewState(
...
export function summarizeCommunityFeed(
  entries: readonly SdkworkCommunityEntry[],
): SdkworkCommunityFeedSummary {
  return {
...
export function evaluateCommunityPublicationReadiness(
  ...
  const issues = toUniqueCommunityPublicationIssues([
...
export function createCommunityWorkspaceManifest({
  ...
  packageNames = ["@sdkwork/community-pc-react"],
  routePath = "/community",
  theme,
  title = "Community",
...
export const communityPackageMeta = {
  ...
  package: "@sdkwork/community-pc-react",
  status: "ready",
} as const;
