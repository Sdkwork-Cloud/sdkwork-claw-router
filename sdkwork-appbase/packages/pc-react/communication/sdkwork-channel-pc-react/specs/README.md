# SDKWork Channel PC React Component Specs

This directory is the local standards index for `@sdkwork/channel-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/channel-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/communication/sdkwork-channel-pc-react` |
...
- `pnpm --filter @sdkwork/channel-pc-react typecheck`
