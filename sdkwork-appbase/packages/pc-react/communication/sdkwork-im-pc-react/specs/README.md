# SDKWork Im PC React Component Specs

This directory is the local standards index for `@sdkwork/im-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/im-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/communication/sdkwork-im-pc-react` |
...
- `pnpm --filter @sdkwork/im-pc-react typecheck`
