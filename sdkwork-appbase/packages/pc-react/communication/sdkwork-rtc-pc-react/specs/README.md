# SDKWork Rtc PC React Component Specs

This directory is the local standards index for `@sdkwork/rtc-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/rtc-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/communication/sdkwork-rtc-pc-react` |
...
- `pnpm --filter @sdkwork/rtc-pc-react typecheck`
