# SDKWork Contacts PC React Component Specs

This directory is the local standards index for `@sdkwork/contacts-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/contacts-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/communication/sdkwork-contacts-pc-react` |
...
- `pnpm --filter @sdkwork/contacts-pc-react typecheck`
