# SDKWork Notification PC React Component Specs

This directory is the local standards index for `@sdkwork/notification-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notification-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/notification/sdkwork-notification-pc-react` |
| Domain | `notification` |
...
- `pnpm --filter @sdkwork/notification-pc-react typecheck`
