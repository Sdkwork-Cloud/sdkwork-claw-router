# SDKWork Settings PC React Component Specs

This directory is the local standards index for `@sdkwork/settings-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/settings-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-settings-pc-react` |
| Domain | `system` |
| Capability | `settings` |
...
- `pnpm --filter @sdkwork/settings-pc-react typecheck`
