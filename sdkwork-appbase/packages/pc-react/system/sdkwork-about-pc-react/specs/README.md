# SDKWork About PC React Component Specs

This directory is the local standards index for `@sdkwork/about-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/about-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-about-pc-react` |
| Domain | `system` |
| Capability | `about` |
...
- `pnpm --filter @sdkwork/about-pc-react typecheck`
