# SDKWork Dashboard PC React Component Specs

This directory is the local standards index for `@sdkwork/dashboard-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/dashboard-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-dashboard-pc-react` |
| Domain | `system` |
...
- `pnpm --filter @sdkwork/dashboard-pc-react typecheck`
