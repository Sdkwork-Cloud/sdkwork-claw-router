# SDKWork Permission PC React Component Specs

This directory is the local standards index for `@sdkwork/permission-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/permission-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-permission-pc-react` |
| Domain | `system` |
...
- `pnpm --filter @sdkwork/permission-pc-react typecheck`
