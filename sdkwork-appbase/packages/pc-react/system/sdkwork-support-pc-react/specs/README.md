# SDKWork Support PC React Component Specs

This directory is the local standards index for `@sdkwork/support-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/support-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-support-pc-react` |
| Domain | `system` |
| Capability | `support` |
...
- `pnpm --filter @sdkwork/support-pc-react typecheck`
