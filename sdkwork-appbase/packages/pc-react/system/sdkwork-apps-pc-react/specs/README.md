# SDKWork Apps PC React Component Specs

This directory is the local standards index for `@sdkwork/apps-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/apps-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-apps-pc-react` |
| Domain | `system` |
| Capability | `apps` |
...
- `pnpm --filter @sdkwork/apps-pc-react typecheck`
