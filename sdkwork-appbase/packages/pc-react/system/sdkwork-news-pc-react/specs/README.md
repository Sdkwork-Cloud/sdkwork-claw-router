# SDKWork News PC React Component Specs

This directory is the local standards index for `@sdkwork/news-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/news-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-news-pc-react` |
| Domain | `system` |
| Capability | `news` |
...
- `pnpm --filter @sdkwork/news-pc-react typecheck`
