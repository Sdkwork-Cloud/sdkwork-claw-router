# SDKWork Docs PC React Component Specs

This directory is the local standards index for `@sdkwork/docs-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/docs-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-docs-pc-react` |
| Domain | `system` |
| Capability | `docs` |
...
- `pnpm --filter @sdkwork/docs-pc-react typecheck`
