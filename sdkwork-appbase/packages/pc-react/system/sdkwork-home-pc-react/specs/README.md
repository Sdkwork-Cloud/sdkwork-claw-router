# SDKWork Home PC React Component Specs

This directory is the local standards index for `@sdkwork/home-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/home-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/system/sdkwork-home-pc-react` |
| Domain | `system` |
| Capability | `home` |
...
- `pnpm --filter @sdkwork/home-pc-react typecheck`
