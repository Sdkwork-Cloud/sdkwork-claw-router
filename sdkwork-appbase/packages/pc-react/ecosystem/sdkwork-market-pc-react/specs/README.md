# SDKWork Market PC React Component Specs

This directory is the local standards index for `@sdkwork/market-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/market-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/ecosystem/sdkwork-market-pc-react` |
| Domain | `ecosystem` |
| Capability | `market` |
...
- `pnpm --filter @sdkwork/market-pc-react typecheck`
