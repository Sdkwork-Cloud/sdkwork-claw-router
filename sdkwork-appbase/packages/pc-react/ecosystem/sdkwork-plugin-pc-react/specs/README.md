# SDKWork Plugin PC React Component Specs

This directory is the local standards index for `@sdkwork/plugin-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/plugin-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/ecosystem/sdkwork-plugin-pc-react` |
| Domain | `ecosystem` |
| Capability | `plugin` |
...
- `pnpm --filter @sdkwork/plugin-pc-react typecheck`
