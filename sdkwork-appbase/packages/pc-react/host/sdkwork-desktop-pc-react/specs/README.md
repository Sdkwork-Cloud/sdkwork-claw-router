# SDKWork Desktop PC React Component Specs

This directory is the local standards index for `@sdkwork/desktop-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/desktop-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/host/sdkwork-desktop-pc-react` |
| Domain | `host` |
| Capability | `desktop` |
...
- `pnpm --filter @sdkwork/desktop-pc-react typecheck`
