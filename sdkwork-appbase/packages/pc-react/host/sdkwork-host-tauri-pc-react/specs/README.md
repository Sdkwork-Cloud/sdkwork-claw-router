# SDKWork Host Tauri PC React Component Specs

This directory is the local standards index for `@sdkwork/host-tauri-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/host-tauri-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/host/sdkwork-host-tauri-pc-react` |
| Domain | `host` |
...
- `pnpm --filter @sdkwork/host-tauri-pc-react typecheck`
