# SDKWork Host PC React Component Specs

This directory is the local standards index for `@sdkwork/host-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/host-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/host/sdkwork-host-pc-react` |
| Domain | `host` |
| Capability | `host` |
...
- `pnpm --filter @sdkwork/host-pc-react typecheck`
