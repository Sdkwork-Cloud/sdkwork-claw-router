# SDKWork I18n PC React Component Specs

This directory is the local standards index for `@sdkwork/i18n-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/i18n-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/foundation/sdkwork-i18n-pc-react` |
| Domain | `foundation` |
| Capability | `i18n` |
...
- `pnpm --filter @sdkwork/i18n-pc-react typecheck`
