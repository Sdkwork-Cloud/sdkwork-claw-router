# SDKWork Shell PC React Component Specs

This directory is the local standards index for `@sdkwork/shell-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/shell-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/foundation/sdkwork-shell-pc-react` |
| Domain | `foundation` |
| Capability | `shell` |
...
- `pnpm --filter @sdkwork/shell-pc-react typecheck`
