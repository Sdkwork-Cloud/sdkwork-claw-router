# SDKWork Router PC React Component Specs

This directory is the local standards index for `@sdkwork/router-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/router-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/foundation/sdkwork-router-pc-react` |
| Domain | `foundation` |
| Capability | `router` |
...
- `pnpm --filter @sdkwork/router-pc-react typecheck`
