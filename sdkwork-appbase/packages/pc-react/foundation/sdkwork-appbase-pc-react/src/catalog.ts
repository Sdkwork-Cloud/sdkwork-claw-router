...
export const SDKWORK_PC_REACT_STARTER_PACKAGES: SdkworkCapabilityPackageMeta[] = [
  ...
  },
  {
    ...
    domain: "commerce",
    packageName: "@sdkwork/membership-pc-react",
    title: "Membership",
  },
  {
    capability: "membership-purchase",
    description: "Membership purchase header entry, package chooser, and reusable membership purchase menu.",
    domain: "commerce",
    packageName: "@sdkwork/membership-purchase-pc-react",
    title: "Membership Purchase",
  },
  {
    capability: "membership-admin",
    description: "Admin membership management for plans, packages, subscriptions, and entitlements.",
    domain: "commerce",
    packageName: "@sdkwork/membership-admin-pc-react",
