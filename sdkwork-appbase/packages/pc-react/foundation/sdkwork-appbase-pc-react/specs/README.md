# SDKWork Appbase PC React Component Specs

This directory is the local standards index for `@sdkwork/appbase-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/appbase-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/foundation/sdkwork-appbase-pc-react` |
| Domain | `foundation` |
| Capability | `appbase` |
