# SDKWork Workspace PC React Component Specs

This directory is the local standards index for `@sdkwork/workspace-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/workspace-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/foundation/sdkwork-workspace-pc-react` |
| Domain | `foundation` |
...
- `pnpm --filter @sdkwork/workspace-pc-react typecheck`
