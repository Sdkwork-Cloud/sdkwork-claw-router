# SDKWork Command PC React Component Specs

This directory is the local standards index for `@sdkwork/command-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/command-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/foundation/sdkwork-command-pc-react` |
| Domain | `foundation` |
| Capability | `command` |
...
- `pnpm --filter @sdkwork/command-pc-react typecheck`
