# SDKWork Search PC React Component Specs

This directory is the local standards index for `@sdkwork/search-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/search-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/foundation/sdkwork-search-pc-react` |
| Domain | `foundation` |
| Capability | `search` |
...
- `pnpm --filter @sdkwork/search-pc-react typecheck`
