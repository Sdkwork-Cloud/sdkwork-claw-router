# SDKWork Vip PC React Component Specs

This directory is the local standards index for `@sdkwork/vip-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/vip-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/commerce/sdkwork-vip-pc-react` |
| Domain | `commerce` |
| Capability | `vip` |
...
- `pnpm --filter @sdkwork/vip-pc-react typecheck`
