...
import type { SdkworkVipLevel } from "../vip-service";

export interface SdkworkVipLevelComparisonProps {
  levels: SdkworkVipLevel[];
}

export function SdkworkVipLevelComparison({
  levels,
}: SdkworkVipLevelComparisonProps) {
  const { copy, formatIncludedPoints } = useSdkworkVipIntl();
      ...
      <div className="grid gap-4 px-6 py-6 md:grid-cols-3">
        {levels.length === 0 ? (
          ...
          <article
            ...
            key={level.id}
            style={createSdkworkVipPanelStyle(level.isCurrent ? "brand" : "neutral", {
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              {level.isCurrent ? (
                <div
                  ...
                  style={createSdkworkVipToneStyle("success", {
                    backgroundWeight: 10,
                    borderWeight: 18,
                  })}
                >
