...
import type { SdkworkVipBenefit } from "../vip-service";

export interface SdkworkVipBenefitsGridProps {
  benefits: SdkworkVipBenefit[];
}

export function SdkworkVipBenefitsGrid({
  benefits,
}: SdkworkVipBenefitsGridProps) {
  const { copy, formatUsage } = useSdkworkVipIntl();
      ...
      <div className="grid gap-4 px-6 py-6 md:grid-cols-2 xl:grid-cols-3">
        {benefits.length === 0 ? (
          ...
          <article
            ...
            key={benefit.id}
            style={createSdkworkVipPanelStyle(benefit.claimed ? "success" : "warning", {
              backgroundWeight: 8,
              borderWeight: 16,
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <div
                ...
                style={createSdkworkVipToneStyle(benefit.claimed ? "success" : "warning", {
                  backgroundWeight: 12,
                  borderWeight: 22,
                })}
              >
