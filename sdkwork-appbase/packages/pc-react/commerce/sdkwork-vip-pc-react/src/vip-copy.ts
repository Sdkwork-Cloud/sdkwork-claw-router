...
export type SdkworkVipLocale = "en-US" | "zh-CN";

export type SdkworkVipMessagesOverrides = DeepPartial<SdkworkVipMessages>;

export interface SdkworkVipMessages {
  actions: {
    benefits: string;
    levels: string;
    plans: string;
...
const EN_US_MESSAGES: SdkworkVipMessages = {
  actions: {
    benefits: "Benefits",
    levels: "Levels",
    plans: "Plans",
    refresh: "Refresh VIP center",
  ...
  levels: {
    ...
    emptyDescription: "Level comparison will appear when VIP level data is available.",
    emptyTitle: "No VIP levels",
    eyebrow: "Levels",
    requiredPoints: "Required points",
    title: "Level comparison",
  },
  page: {
    errorTitle: "VIP center error",
    loading: "Loading VIP center...",
  },
  plans: {
  ...
  service: {
    ...
    signInRequired: "Please sign in to manage VIP memberships.",
...
const ZH_CN_MESSAGES: SdkworkVipMessages = {
  actions: {
    benefits: "\u6743\u76ca",
    levels: "\u7b49\u7ea7",
    plans: "\u65b9\u6848",
  ...
  levels: {
    ...
    emptyDescription: "\u5f53 VIP \u7b49\u7ea7\u6570\u636e\u53ef\u7528\u65f6\uff0c\u8fd9\u91cc\u4f1a\u5c55\u793a\u5bf9\u6bd4\u4fe1\u606f\u3002",
    emptyTitle: "\u6682\u65e0\u4f1a\u5458\u7b49\u7ea7",
    eyebrow: "\u7b49\u7ea7",
    requiredPoints: "\u9700\u8981\u79ef\u5206",
    title: "\u7b49\u7ea7\u5bf9\u6bd4",
...
const SDKWORK_VIP_MESSAGES: Record<SdkworkVipLocale, SdkworkVipMessages> = {
  "en-US": EN_US_MESSAGES,
  "zh-CN": ZH_CN_MESSAGES,
};

export function normalizeSdkworkVipLocale(locale?: string | null): SdkworkVipLocale {
...
export function createSdkworkVipMessages(
  locale?: string | null,
  overrides?: SdkworkVipMessagesOverrides,
): SdkworkVipMessages {
  return mergeDeep(
    SDKWORK_VIP_MESSAGES[normalizeSdkworkVipLocale(locale)],
    overrides,
  );
}

export function formatSdkworkVipTemplate(
  template: string,
  replacements: Record<string, string>,
): string {
...
export function formatSdkworkVipStatusLabel(
  value: "free" | "guest" | "vip",
  locale?: string | null,
  overrides?: SdkworkVipMessagesOverrides,
): string {
  const copy = createSdkworkVipMessages(locale, overrides);
  return copy.status[value];
}

export function formatSdkworkVipDurationLabel(
  value: number | null,
  locale?: string | null,
  overrides?: SdkworkVipMessagesOverrides,
): string {
...
export function formatSdkworkVipIncludedPointsLabel(
  value: number,
  locale?: string | null,
): string {
  return formatSdkworkPoints(value, normalizeSdkworkVipLocale(locale));
}

export function formatSdkworkVipUsageLabel(
  used: number | null,
  limit: number | null,
  locale?: string | null,
  overrides?: SdkworkVipMessagesOverrides,
...
export function formatSdkworkVipPriceWasLabel(
  value: string,
  locale?: string | null,
  overrides?: SdkworkVipMessagesOverrides,
): string {
