# SDKWork VIP Purchase PC React Component Specs

This directory is the local standards index for `@sdkwork/vip-purchase-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/vip-purchase-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/commerce/sdkwork-vip-purchase-pc-react` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/vip-purchase-pc-react typecheck`
