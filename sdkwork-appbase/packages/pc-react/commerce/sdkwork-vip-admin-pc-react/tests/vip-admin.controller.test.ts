...
import { createSdkworkVipAdminController } from "../src";

describe("sdkwork-vip-admin-pc-react controller", () => {
  it("bootstraps, switches views, and refreshes after every admin VIP mutation", async () => {
    const dashboard = {
      entitlements: [],
      levels: [
        {
