# SDKWork VIP Admin PC React Component Specs

This directory is the local standards index for `@sdkwork/vip-admin-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/vip-admin-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/commerce/sdkwork-vip-admin-pc-react` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/vip-admin-pc-react typecheck`
