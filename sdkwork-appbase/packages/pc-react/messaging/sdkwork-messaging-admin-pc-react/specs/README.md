# SDKWork Messaging Admin PC React Component Specs

This directory is the local standards index for `@sdkwork/messaging-admin-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/messaging-admin-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/messaging/sdkwork-messaging-admin-pc-react` |
| Domain | `messaging` |
| Capability | `messaging-admin` |
...
- `pnpm --filter @sdkwork/messaging-admin-pc-react typecheck`
