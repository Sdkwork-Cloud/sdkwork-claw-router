# SDKWork Open Platform Admin PC React Component Specs

This directory is the local standards index for `@sdkwork/open-platform-admin-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/open-platform-admin-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/integration/sdkwork-open-platform-admin-pc-react` |
| Domain | `integration` |
...
| [INTEGRATION_SPEC.md](../../../../../../../specs/INTEGRATION_SPEC.md) | External provider, connector, webhook, retry, and provider ID rules. |
...
- `pnpm --filter @sdkwork/open-platform-admin-pc-react typecheck`
