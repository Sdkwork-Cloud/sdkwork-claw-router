# SDKWork Video PC React Component Specs

This directory is the local standards index for `@sdkwork/video-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/video-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/content/sdkwork-video-pc-react` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/video-pc-react typecheck`
