...
export type SdkworkVideoVisualTone = SdkworkThemeVisualTone;

export function createSdkworkVideoToneStyle(
  tone: SdkworkVideoVisualTone,
  options: {
...
export function createSdkworkVideoPanelStyle(
  tone: SdkworkVideoVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkVideoBackdropStyle(): CSSProperties {
  return createSdkworkBackdropStyle();
}

export function createSdkworkVideoHeroStyle(): CSSProperties {
  return createSdkworkHeroStyle();
}

export function createSdkworkVideoHeroTextStyle(
