...
This directory is the local standards index for `@sdkwork/assets-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/assets-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/content/sdkwork-assets-pc-react` |
| Domain | `content` |
| Capability | `assets` |
...
- `pnpm --filter @sdkwork/assets-pc-react typecheck`
