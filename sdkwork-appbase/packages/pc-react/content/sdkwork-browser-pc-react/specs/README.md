# SDKWork Browser PC React Component Specs

This directory is the local standards index for `@sdkwork/browser-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/browser-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/content/sdkwork-browser-pc-react` |
| Domain | `content` |
| Capability | `browser` |
...
- `pnpm --filter @sdkwork/browser-pc-react typecheck`
