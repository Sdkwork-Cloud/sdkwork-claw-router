# SDKWork Media PC React Component Specs

This directory is the local standards index for `@sdkwork/media-pc-react`.
...
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/content/sdkwork-media-pc-react` |
| Domain | `content` |
| Capability | `media` |
