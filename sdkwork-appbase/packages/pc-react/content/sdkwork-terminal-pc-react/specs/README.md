# SDKWork Terminal PC React Component Specs

This directory is the local standards index for `@sdkwork/terminal-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/terminal-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/content/sdkwork-terminal-pc-react` |
| Domain | `content` |
| Capability | `terminal` |
...
- `pnpm --filter @sdkwork/terminal-pc-react typecheck`
