...
export type SdkworkTerminalVisualTone = SdkworkThemeVisualTone;

export function createSdkworkTerminalToneStyle(
  tone: SdkworkTerminalVisualTone,
  options: {
...
export function createSdkworkTerminalPanelStyle(
  tone: SdkworkTerminalVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkTerminalGlassStyle(
  tone: SdkworkTerminalVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkTerminalBackdropStyle(): CSSProperties {
  return createSdkworkBackdropStyle();
}

export function createSdkworkTerminalHeroStyle(): CSSProperties {
  return createSdkworkHeroStyle();
}

export function createSdkworkTerminalHeroTextStyle(
