# SDKWork Editor PC React Component Specs

This directory is the local standards index for `@sdkwork/editor-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/editor-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/content/sdkwork-editor-pc-react` |
| Domain | `content` |
| Capability | `editor` |
...
- `pnpm --filter @sdkwork/editor-pc-react typecheck`
