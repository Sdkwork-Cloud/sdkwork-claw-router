...
export type SdkworkEditorVisualTone = SdkworkThemeVisualTone;

export function createSdkworkEditorToneStyle(
  tone: SdkworkEditorVisualTone,
  options: {
...
export function createSdkworkEditorPanelStyle(
  tone: SdkworkEditorVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkEditorGlassStyle(
  tone: SdkworkEditorVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkEditorBackdropStyle(): CSSProperties {
  return createSdkworkBackdropStyle();
}

export function createSdkworkEditorHeroStyle(): CSSProperties {
  return createSdkworkHeroStyle();
}

export function createSdkworkEditorHeroTextStyle(
