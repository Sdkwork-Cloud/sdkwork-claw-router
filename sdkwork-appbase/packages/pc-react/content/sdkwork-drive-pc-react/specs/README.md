# SDKWork Drive PC React Component Specs

This directory is the local standards index for `@sdkwork/drive-pc-react`.
...
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/content/sdkwork-drive-pc-react` |
| Domain | `content` |
| Capability | `drive` |
