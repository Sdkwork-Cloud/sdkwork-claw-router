# SDKWork Agent PC React Component Specs

This directory is the local standards index for `@sdkwork/agent-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agent-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-agent-pc-react` |
| Domain | `intelligence` |
| Capability | `agent` |
...
- `pnpm --filter @sdkwork/agent-pc-react typecheck`
