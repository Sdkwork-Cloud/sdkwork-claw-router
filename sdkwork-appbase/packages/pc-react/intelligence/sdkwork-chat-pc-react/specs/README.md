# SDKWork Chat PC React Component Specs

This directory is the local standards index for `@sdkwork/chat-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/chat-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-chat-pc-react` |
| Domain | `intelligence` |
| Capability | `chat` |
...
- `pnpm --filter @sdkwork/chat-pc-react typecheck`
