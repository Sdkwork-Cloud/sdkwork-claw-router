# SDKWork Llm PC React Component Specs

This directory is the local standards index for `@sdkwork/llm-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/llm-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-llm-pc-react` |
| Domain | `intelligence` |
| Capability | `llm` |
...
- `pnpm --filter @sdkwork/llm-pc-react typecheck`
