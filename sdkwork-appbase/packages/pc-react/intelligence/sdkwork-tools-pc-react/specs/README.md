# SDKWork Tools PC React Component Specs

This directory is the local standards index for `@sdkwork/tools-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/tools-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-tools-pc-react` |
| Domain | `intelligence` |
| Capability | `tools` |
...
- `pnpm --filter @sdkwork/tools-pc-react typecheck`
