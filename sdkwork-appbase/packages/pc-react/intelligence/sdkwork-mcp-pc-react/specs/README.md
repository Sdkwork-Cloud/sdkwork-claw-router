# SDKWork Mcp PC React Component Specs

This directory is the local standards index for `@sdkwork/mcp-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/mcp-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-mcp-pc-react` |
| Domain | `intelligence` |
| Capability | `mcp` |
...
- `pnpm --filter @sdkwork/mcp-pc-react typecheck`
