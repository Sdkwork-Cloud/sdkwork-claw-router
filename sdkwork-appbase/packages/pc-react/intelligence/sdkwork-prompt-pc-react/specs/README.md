# SDKWork Prompt PC React Component Specs

This directory is the local standards index for `@sdkwork/prompt-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/prompt-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-prompt-pc-react` |
| Domain | `intelligence` |
| Capability | `prompt` |
...
- `pnpm --filter @sdkwork/prompt-pc-react typecheck`
