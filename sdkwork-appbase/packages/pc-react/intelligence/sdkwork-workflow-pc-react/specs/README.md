# SDKWork Workflow PC React Component Specs

This directory is the local standards index for `@sdkwork/workflow-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/workflow-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-workflow-pc-react` |
| Domain | `intelligence` |
| Capability | `workflow` |
...
- `pnpm --filter @sdkwork/workflow-pc-react typecheck`
