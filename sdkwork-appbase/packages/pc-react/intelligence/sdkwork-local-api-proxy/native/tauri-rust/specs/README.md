...
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-local-api-proxy/native/tauri-rust` |
| Domain | `device` |
| Capability | `app` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/pc-react/intelligence/sdkwork-local-api-proxy/native/tauri-rust/Cargo.toml`
