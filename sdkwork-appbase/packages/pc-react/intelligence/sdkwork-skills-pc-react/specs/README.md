# SDKWork Skills PC React Component Specs

This directory is the local standards index for `@sdkwork/skills-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/skills-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-skills-pc-react` |
| Domain | `intelligence` |
| Capability | `skills` |
...
- `pnpm --filter @sdkwork/skills-pc-react typecheck`
