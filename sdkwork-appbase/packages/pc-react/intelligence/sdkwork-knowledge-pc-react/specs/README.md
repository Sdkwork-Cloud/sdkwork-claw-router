# SDKWork Knowledge PC React Component Specs

This directory is the local standards index for `@sdkwork/knowledge-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/knowledge-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-knowledge-pc-react` |
| Domain | `intelligence` |
...
- `pnpm --filter @sdkwork/knowledge-pc-react typecheck`
