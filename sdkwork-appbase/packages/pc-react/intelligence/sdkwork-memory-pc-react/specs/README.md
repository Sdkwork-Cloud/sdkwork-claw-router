# SDKWork Memory PC React Component Specs

This directory is the local standards index for `@sdkwork/memory-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/memory-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-memory-pc-react` |
| Domain | `intelligence` |
| Capability | `memory` |
...
- `pnpm --filter @sdkwork/memory-pc-react typecheck`
