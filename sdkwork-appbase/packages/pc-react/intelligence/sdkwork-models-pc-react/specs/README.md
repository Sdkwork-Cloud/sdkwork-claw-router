# SDKWork Models PC React Component Specs

This directory is the local standards index for `@sdkwork/models-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/models-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/intelligence/sdkwork-models-pc-react` |
| Domain | `intelligence` |
| Capability | `models` |
...
- `pnpm --filter @sdkwork/models-pc-react typecheck`
