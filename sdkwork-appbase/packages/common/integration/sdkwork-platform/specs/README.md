# SDKWork Platform Component Specs

This directory is the local standards index for `@sdkwork/platform`.
...
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/integration/sdkwork-platform` |
| Domain | `integration` |
| Capability | `platform` |
...
- `pnpm --filter @sdkwork/platform typecheck`
