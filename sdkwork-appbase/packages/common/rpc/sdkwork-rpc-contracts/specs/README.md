# SDKWork Rpc Contracts Component Specs

This directory is the local standards index for `@sdkwork/rpc-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/rpc-contracts` |
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/rpc/sdkwork-rpc-contracts` |
| Domain | `platform` |
| Capability | `app` |
