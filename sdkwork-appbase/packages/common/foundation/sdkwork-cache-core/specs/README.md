# SDKWork Cache Core Component Specs

This directory is the local standards index for `@sdkwork/cache-core`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/cache-core` |
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/foundation/sdkwork-cache-core` |
| Domain | `foundation` |
...
- `pnpm --filter @sdkwork/cache-core typecheck`
