# SDKWork Runtime Bootstrap Component Specs

This directory is the local standards index for `@sdkwork/runtime-bootstrap`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/runtime-bootstrap` |
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/foundation/sdkwork-runtime-bootstrap` |
| Domain | `foundation` |
...
- `pnpm --filter @sdkwork/runtime-bootstrap typecheck`
