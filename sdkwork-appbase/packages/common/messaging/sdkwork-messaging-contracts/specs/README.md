# SDKWork Messaging Contracts Component Specs

This directory is the local standards index for `@sdkwork/messaging-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/messaging-contracts` |
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/messaging/sdkwork-messaging-contracts` |
| Domain | `messaging` |
