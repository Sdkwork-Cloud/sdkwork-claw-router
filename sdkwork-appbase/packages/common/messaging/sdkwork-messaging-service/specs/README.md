# SDKWork Messaging Service Component Specs

This directory is the local standards index for `@sdkwork/messaging-service`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/messaging-service` |
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/messaging/sdkwork-messaging-service` |
| Domain | `messaging` |
