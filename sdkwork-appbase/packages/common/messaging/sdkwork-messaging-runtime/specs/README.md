# SDKWork Messaging Runtime Component Specs

This directory is the local standards index for `@sdkwork/messaging-runtime`.
...
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/messaging/sdkwork-messaging-runtime` |
| Domain | `messaging` |
...
- `pnpm --filter @sdkwork/messaging-runtime typecheck`
