# SDKWork Messaging SDK Ports Component Specs

This directory is the local standards index for `@sdkwork/messaging-sdk-ports`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/messaging-sdk-ports` |
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/messaging/sdkwork-messaging-sdk-ports` |
| Domain | `messaging` |
