# SDKWork Agent Contracts Component Specs

This directory is the local standards index for `@sdkwork/agent-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/agent-contracts` |
| Type | `node-package` |
| Root | `sdkwork-appbase/packages/common/intelligence/sdkwork-agent-contracts` |
| Domain | `intelligence` |
...
- `pnpm --filter @sdkwork/agent-contracts typecheck`
