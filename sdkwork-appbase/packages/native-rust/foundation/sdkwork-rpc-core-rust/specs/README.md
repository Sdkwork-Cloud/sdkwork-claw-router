# SDKWork Rpc Core Component Specs

This directory is the local standards index for `sdkwork_rpc_core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_rpc_core` |
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/native-rust/foundation/sdkwork-rpc-core-rust` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/foundation/sdkwork-rpc-core-rust/Cargo.toml`
