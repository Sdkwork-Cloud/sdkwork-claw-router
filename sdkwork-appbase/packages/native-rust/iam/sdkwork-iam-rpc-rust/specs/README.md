# SDKWork Iam Rpc Component Specs

This directory is the local standards index for `sdkwork_iam_rpc`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_iam_rpc` |
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/native-rust/iam/sdkwork-iam-rpc-rust` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
