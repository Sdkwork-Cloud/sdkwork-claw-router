# SDKWork Iam Core Component Specs

This directory is the local standards index for `sdkwork_iam_core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_iam_core` |
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/native-rust/iam/sdkwork-iam-core-rust` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/iam/sdkwork-iam-core-rust/Cargo.toml`
