# SDKWork Iam Tauri Component Specs

This directory is the local standards index for `sdkwork_iam_tauri`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_iam_tauri` |
| Type | `tauri-host` |
| Root | `sdkwork-appbase/packages/native-rust/iam/sdkwork-iam-tauri-rust` |
| Domain | `device` |
| Capability | `app` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/iam/sdkwork-iam-tauri-rust/Cargo.toml`
