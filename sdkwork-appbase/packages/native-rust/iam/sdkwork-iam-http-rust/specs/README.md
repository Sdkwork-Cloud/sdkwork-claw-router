# SDKWork Iam Http Component Specs

This directory is the local standards index for `sdkwork_iam_http`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_iam_http` |
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/native-rust/iam/sdkwork-iam-http-rust` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/iam/sdkwork-iam-http-rust/Cargo.toml`
