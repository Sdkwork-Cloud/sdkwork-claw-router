...
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/native-rust/commerce/sdkwork-commerce-core-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/commerce/sdkwork-commerce-core-rust/Cargo.toml`
