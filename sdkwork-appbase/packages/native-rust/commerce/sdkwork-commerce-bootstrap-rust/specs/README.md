...
| Type | `tauri-host` |
| Root | `sdkwork-appbase/packages/native-rust/commerce/sdkwork-commerce-bootstrap-rust` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/commerce/sdkwork-commerce-bootstrap-rust/Cargo.toml`
