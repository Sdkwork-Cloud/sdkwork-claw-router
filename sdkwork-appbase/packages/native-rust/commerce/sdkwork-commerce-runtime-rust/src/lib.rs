...
pub fn first_slice_capability_manifest() -> Vec<&'static str> {
    vec![
        ...
        "commerce.promotion.coupon",
        "commerce.promotion.redemption",
...
pub fn operation_contracts() -> Vec<CommerceOperationContract> {
    vec![
        ...
        write(
            "coupons.redemptions.rollback",
            "commerce.promotion",
            "commerce.promotion.redemption",
        ),
        write(
            "coupons.redemptions.reversals.create",
            "commerce.promotion",
            "commerce.promotion.redemption",
        ),
        read(
