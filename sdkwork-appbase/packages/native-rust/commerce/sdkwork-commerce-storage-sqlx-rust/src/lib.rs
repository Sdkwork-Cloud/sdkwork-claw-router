...
pub fn commerce_business_repository_sql_catalogs() -> Vec<CommerceBusinessRepositorySqlCatalog> {
    vec![
        ...
        business_catalog(
            ...
            vec![
                read("promotion.find_template", "commerce_coupon_template"),
                write("promotion.create_template", "commerce_coupon_template"),
                read(
                    "promotion.list_issue_batches",
                    "commerce_coupon_issue_batch",
                ),
                write(
                    "promotion.create_issue_batch",
                    "commerce_coupon_issue_batch",
                ),
                read("promotion.find_coupon", "commerce_coupon"),
                write("promotion.claim_coupon", "commerce_coupon"),
                write("promotion.redeem_coupon", "commerce_coupon_redemption"),
                write(
                    "promotion.rollback_redemption",
                    "commerce_coupon_redemption",
                ),
                write("promotion.expire_coupon", "commerce_coupon"),
            ],
        ),
        business_catalog(
            "catalog",
        ...
        business_catalog(
            ...
            vec![
                read(
                    "membership.list_membership_plans",
                    "commerce_membership_plan",
                ),
                write(
                ...
                read(
                    "membership.list_membership_package_groups",
                    "commerce_membership_package_group",
                ),
                write(
                    "membership.upsert_membership_package_group",
                    "commerce_membership_package_group",
                ),
                read(
                    "membership.list_membership_packages",
                    "commerce_membership_package",
                ),
                read(
                    "membership.find_membership_package",
                    "commerce_membership_package",
                ),
                write(
                    "membership.upsert_membership_package",
                    "commerce_membership_package",
                ),
                read("membership.find_membership", "commerce_membership"),
                write("membership.activate_membership", "commerce_membership"),
                write(
                    "membership.grant_entitlement",
                    "commerce_membership_entitlement",
                ),
                write(
                    "membership.record_entitlement_usage",
                    "commerce_membership_entitlement_usage",
                ),
                write("membership.expire_membership", "commerce_membership"),
            ],
        ),
        business_catalog(
            "invoice",
