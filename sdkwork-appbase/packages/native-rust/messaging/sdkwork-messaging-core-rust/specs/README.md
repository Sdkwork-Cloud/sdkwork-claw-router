# SDKWork Messaging Core Component Specs

This directory is the local standards index for `sdkwork_messaging_core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_messaging_core` |
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/native-rust/messaging/sdkwork-messaging-core-rust` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/messaging/sdkwork-messaging-core-rust/Cargo.toml`
