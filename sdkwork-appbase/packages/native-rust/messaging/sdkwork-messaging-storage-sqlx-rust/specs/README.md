# SDKWork Messaging Storage Sqlx Component Specs

This directory is the local standards index for `sdkwork_messaging_storage_sqlx`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_messaging_storage_sqlx` |
| Type | `rust-crate` |
| Root | `sdkwork-appbase/packages/native-rust/messaging/sdkwork-messaging-storage-sqlx-rust` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-appbase/packages/native-rust/messaging/sdkwork-messaging-storage-sqlx-rust/Cargo.toml`
