# SDKWork Router Mobile React Component Specs

This directory is the local standards index for `@sdkwork/router-mobile-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/router-mobile-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/mobile-react/foundation/sdkwork-router-mobile-react` |
| Domain | `foundation` |
| Capability | `router` |
...
- `pnpm --filter @sdkwork/router-mobile-react typecheck`
