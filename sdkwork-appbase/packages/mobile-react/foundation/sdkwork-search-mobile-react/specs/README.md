# SDKWork Search Mobile React Component Specs

This directory is the local standards index for `@sdkwork/search-mobile-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/search-mobile-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/mobile-react/foundation/sdkwork-search-mobile-react` |
| Domain | `foundation` |
| Capability | `search` |
...
- `pnpm --filter @sdkwork/search-mobile-react typecheck`
