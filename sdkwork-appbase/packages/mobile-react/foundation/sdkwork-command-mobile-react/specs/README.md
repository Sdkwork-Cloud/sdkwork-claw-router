# SDKWork Command Mobile React Component Specs

This directory is the local standards index for `@sdkwork/command-mobile-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/command-mobile-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/mobile-react/foundation/sdkwork-command-mobile-react` |
| Domain | `foundation` |
| Capability | `command` |
...
- `pnpm --filter @sdkwork/command-mobile-react typecheck`
