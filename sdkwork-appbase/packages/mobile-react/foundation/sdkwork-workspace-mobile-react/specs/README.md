# SDKWork Workspace Mobile React Component Specs

This directory is the local standards index for `@sdkwork/workspace-mobile-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/workspace-mobile-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/mobile-react/foundation/sdkwork-workspace-mobile-react` |
| Domain | `foundation` |
...
- `pnpm --filter @sdkwork/workspace-mobile-react typecheck`
