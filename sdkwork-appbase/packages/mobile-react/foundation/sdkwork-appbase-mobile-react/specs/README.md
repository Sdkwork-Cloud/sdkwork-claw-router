# SDKWork Appbase Mobile React Component Specs

This directory is the local standards index for `@sdkwork/appbase-mobile-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/appbase-mobile-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/mobile-react/foundation/sdkwork-appbase-mobile-react` |
| Domain | `foundation` |
| Capability | `appbase` |
...
- `pnpm --filter @sdkwork/appbase-mobile-react typecheck`
