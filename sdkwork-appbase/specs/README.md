# SDKWork Appbase Workspace Component Specs

This directory is the local standards index for `@sdkwork/appbase-workspace`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/appbase-workspace` |
| Type | `react-package` |
| Root | `sdkwork-appbase` |
| Domain | `platform` |
...
- [appbase-capabilities.yaml](./appbase-capabilities.yaml) is the machine-readable capability building-block catalog.
...
- `pnpm --filter @sdkwork/appbase-workspace typecheck`
