...
const scannedRoots = [
  ...
  path.join(businessRoot, "spring-ai-plus-app-api", "src"),
  path.join(businessRoot, "spring-ai-plus-backend-api", "src"),
];
  ...
  assert.deepEqual(
    [
      ...findNonCanonicalSpringMappings({
        ...
        root: path.join(businessRoot, "spring-ai-plus-app-api", "src"),
        surfaceName: "app-api",
      }),
      ...findNonCanonicalSpringMappings({
        requiredPrefix: "/backend/v3/api",
        root: path.join(businessRoot, "spring-ai-plus-backend-api", "src"),
