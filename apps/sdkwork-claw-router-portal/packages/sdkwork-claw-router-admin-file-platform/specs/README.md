...
This directory is the local standards index for `sdkwork-claw-router-admin-file-platform`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-file-platform` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-file-platform` |
| Domain | `platform` |
| Capability | `router` |
