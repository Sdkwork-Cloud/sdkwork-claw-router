...
This directory is the local standards index for `sdkwork-claw-router-console-memberships`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-memberships` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-memberships` |
| Domain | `platform` |
| Capability | `router` |
