# SDKWork Claw Router I18n Component Specs

This directory is the local standards index for `sdkwork-claw-router-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-i18n` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-i18n` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-i18n typecheck`
