...
This directory is the local standards index for `sdkwork-claw-router-console-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-core` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-core` |
| Domain | `platform` |
| Capability | `router` |
