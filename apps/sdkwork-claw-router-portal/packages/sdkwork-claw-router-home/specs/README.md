...
This directory is the local standards index for `sdkwork-claw-router-home`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-home` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-home` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-home typecheck`
