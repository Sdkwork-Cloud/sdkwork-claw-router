# SDKWork Claw Router Admin Marketing Component Specs

This directory is the local standards index for `sdkwork-claw-router-admin-marketing`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-marketing` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-marketing` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-admin-marketing typecheck`
