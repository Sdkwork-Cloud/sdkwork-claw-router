...
This directory is the local standards index for `sdkwork-claw-router-console-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-gateway` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-gateway` |
| Domain | `platform` |
| Capability | `router` |
