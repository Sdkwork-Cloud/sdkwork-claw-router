...
This directory is the local standards index for `sdkwork-claw-router-admin-skill`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-skill` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-skill` |
| Domain | `intelligence` |
| Capability | `skill` |
...
- `pnpm --filter sdkwork-claw-router-admin-skill typecheck`
