...
This directory is the local standards index for `sdkwork-claw-router-console-checkout`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-checkout` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-checkout` |
| Domain | `commerce` |
| Capability | `router` |
