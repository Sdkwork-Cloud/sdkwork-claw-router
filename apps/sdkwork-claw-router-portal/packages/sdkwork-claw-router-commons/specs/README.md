...
This directory is the local standards index for `sdkwork-claw-router-commons`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-commons` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-commons` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-commons typecheck`
