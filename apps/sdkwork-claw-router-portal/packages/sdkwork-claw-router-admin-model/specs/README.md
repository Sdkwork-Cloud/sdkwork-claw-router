...
This directory is the local standards index for `sdkwork-claw-router-admin-model`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-model` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-model` |
| Domain | `intelligence` |
| Capability | `model` |
...
- `pnpm --filter sdkwork-claw-router-admin-model typecheck`
