...
This directory is the local standards index for `sdkwork-claw-router-admin-wechat-mini-program`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-wechat-mini-program` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-wechat-mini-program` |
