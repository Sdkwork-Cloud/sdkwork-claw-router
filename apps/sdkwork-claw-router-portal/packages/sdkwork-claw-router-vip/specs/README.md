...
This directory is the local standards index for `sdkwork-claw-router-vip`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-vip` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-vip` |
| Domain | `commerce` |
| Capability | `vip` |
