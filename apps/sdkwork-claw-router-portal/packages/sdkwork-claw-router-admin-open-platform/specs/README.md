...
This directory is the local standards index for `sdkwork-claw-router-admin-open-platform`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-open-platform` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-open-platform` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-admin-open-platform typecheck`
