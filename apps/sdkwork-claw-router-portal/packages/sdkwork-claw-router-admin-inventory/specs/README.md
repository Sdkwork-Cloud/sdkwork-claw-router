...
This directory is the local standards index for `sdkwork-claw-router-admin-inventory`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-inventory` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-inventory` |
| Domain | `platform` |
| Capability | `router` |
