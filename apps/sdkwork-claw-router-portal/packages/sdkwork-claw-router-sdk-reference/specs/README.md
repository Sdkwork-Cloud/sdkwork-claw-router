...
This directory is the local standards index for `sdkwork-claw-router-sdk-reference`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-sdk-reference` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-sdk-reference` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-sdk-reference typecheck`
