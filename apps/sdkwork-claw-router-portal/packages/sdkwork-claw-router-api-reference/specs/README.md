...
This directory is the local standards index for `sdkwork-claw-router-api-reference`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-api-reference` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-api-reference` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-api-reference typecheck`
