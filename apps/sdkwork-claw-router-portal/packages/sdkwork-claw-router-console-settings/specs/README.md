...
This directory is the local standards index for `sdkwork-claw-router-console-settings`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-settings` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-settings` |
| Domain | `platform` |
| Capability | `router` |
