...
This directory is the local standards index for `sdkwork-claw-router-admin-prompts`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-prompts` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-prompts` |
| Domain | `intelligence` |
| Capability | `prompt` |
