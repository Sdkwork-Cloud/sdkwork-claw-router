# SDKWork Claw Router Types Component Specs

This directory is the local standards index for `sdkwork-claw-router-types`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-types` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-types` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-types typecheck`
