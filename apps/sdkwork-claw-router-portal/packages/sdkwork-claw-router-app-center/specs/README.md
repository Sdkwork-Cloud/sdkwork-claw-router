...
This directory is the local standards index for `sdkwork-claw-router-app-center`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-app-center` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-app-center` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-app-center typecheck`
