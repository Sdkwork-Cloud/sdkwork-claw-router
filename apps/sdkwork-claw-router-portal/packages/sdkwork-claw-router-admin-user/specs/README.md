...
This directory is the local standards index for `sdkwork-claw-router-admin-user`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-user` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter sdkwork-claw-router-admin-user typecheck`
