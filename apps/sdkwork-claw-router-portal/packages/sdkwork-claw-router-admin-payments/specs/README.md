...
This directory is the local standards index for `sdkwork-claw-router-admin-payments`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-payments` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-payments` |
| Domain | `commerce` |
| Capability | `payment` |
