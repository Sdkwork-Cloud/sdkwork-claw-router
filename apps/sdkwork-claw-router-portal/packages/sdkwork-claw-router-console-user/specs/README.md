...
This directory is the local standards index for `sdkwork-claw-router-console-user`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-user` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter sdkwork-claw-router-console-user typecheck`
