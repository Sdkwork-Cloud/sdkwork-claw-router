...
This directory is the local standards index for `sdkwork-claw-router-console-messages`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-messages` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-messages` |
| Domain | `platform` |
| Capability | `router` |
