...
This directory is the local standards index for `sdkwork-claw-router-console-recharge`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-recharge` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-recharge` |
| Domain | `platform` |
| Capability | `router` |
