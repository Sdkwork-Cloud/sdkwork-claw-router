# SDKWork Claw Router Admin Runtime Region Component Specs

This directory is the local standards index for `sdkwork-claw-router-admin-runtime-region`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-runtime-region` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-runtime-region` |
...
- `pnpm --filter sdkwork-claw-router-admin-runtime-region typecheck`
