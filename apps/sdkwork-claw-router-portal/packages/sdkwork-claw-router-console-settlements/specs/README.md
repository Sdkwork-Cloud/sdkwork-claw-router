...
This directory is the local standards index for `sdkwork-claw-router-console-settlements`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-settlements` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-settlements` |
| Domain | `platform` |
| Capability | `router` |
