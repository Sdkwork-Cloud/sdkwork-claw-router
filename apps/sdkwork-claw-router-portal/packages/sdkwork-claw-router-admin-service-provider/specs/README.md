...
This directory is the local standards index for `sdkwork-claw-router-admin-service-provider`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-service-provider` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-service-provider` |
| Domain | `platform` |
| Capability | `router` |
