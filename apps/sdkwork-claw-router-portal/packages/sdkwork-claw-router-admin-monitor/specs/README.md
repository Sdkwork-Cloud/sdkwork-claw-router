...
This directory is the local standards index for `sdkwork-claw-router-admin-monitor`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-monitor` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-monitor` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-admin-monitor typecheck`
