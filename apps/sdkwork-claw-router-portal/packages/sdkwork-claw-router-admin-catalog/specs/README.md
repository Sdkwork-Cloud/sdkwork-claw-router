# SDKWork Claw Router Admin Catalog Component Specs

This directory is the local standards index for `sdkwork-claw-router-admin-catalog`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-catalog` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-catalog` |
| Domain | `platform` |
| Capability | `router` |
