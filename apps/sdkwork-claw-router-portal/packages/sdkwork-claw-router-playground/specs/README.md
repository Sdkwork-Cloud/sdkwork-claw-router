# SDKWork Claw Router Playground Component Specs

This directory is the local standards index for `sdkwork-claw-router-playground`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-playground` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-playground` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-playground typecheck`
