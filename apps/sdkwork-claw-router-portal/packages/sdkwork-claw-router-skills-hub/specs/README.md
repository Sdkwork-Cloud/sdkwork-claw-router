...
This directory is the local standards index for `sdkwork-claw-router-skills-hub`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-skills-hub` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-skills-hub` |
| Domain | `intelligence` |
| Capability | `skill` |
...
- `pnpm --filter sdkwork-claw-router-skills-hub typecheck`
