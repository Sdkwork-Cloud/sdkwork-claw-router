...
This directory is the local standards index for `sdkwork-claw-router-admin-mcp`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-mcp` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-mcp` |
| Domain | `intelligence` |
| Capability | `mcp` |
