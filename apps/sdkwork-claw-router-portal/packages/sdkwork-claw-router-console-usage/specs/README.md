...
This directory is the local standards index for `sdkwork-claw-router-console-usage`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-usage` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-usage` |
| Domain | `platform` |
| Capability | `router` |
