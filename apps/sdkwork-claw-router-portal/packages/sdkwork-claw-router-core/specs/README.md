# SDKWork Claw Router Core Component Specs

This directory is the local standards index for `sdkwork-claw-router-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-core` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-core` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-core typecheck`
