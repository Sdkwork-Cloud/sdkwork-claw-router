...
This directory is the local standards index for `sdkwork-claw-router-admin-messaging`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-messaging` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-messaging` |
| Domain | `platform` |
| Capability | `router` |
