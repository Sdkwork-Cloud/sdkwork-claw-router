...
This directory is the local standards index for `sdkwork-claw-router-admin-channel`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-channel` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-channel` |
...
- `pnpm --filter sdkwork-claw-router-admin-channel typecheck`
