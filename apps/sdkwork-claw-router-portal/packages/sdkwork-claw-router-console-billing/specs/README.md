# SDKWork Claw Router Console Billing Component Specs

This directory is the local standards index for `sdkwork-claw-router-console-billing`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-billing` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-billing` |
| Domain | `commerce` |
| Capability | `billing` |
