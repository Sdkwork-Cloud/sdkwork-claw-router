# SDKWork Claw Router Admin Site Component Specs

This directory is the local standards index for `sdkwork-claw-router-admin-site`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-site` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-site` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-admin-site typecheck`
