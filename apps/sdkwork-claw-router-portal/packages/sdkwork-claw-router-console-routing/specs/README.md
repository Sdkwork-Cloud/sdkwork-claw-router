# SDKWork Claw Router Console Routing Component Specs

This directory is the local standards index for `sdkwork-claw-router-console-routing`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-routing` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-routing` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-console-routing typecheck`
