# SDKWork Claw Router Console Providers Component Specs

This directory is the local standards index for `sdkwork-claw-router-console-providers`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-providers` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-providers` |
| Domain | `platform` |
| Capability | `router` |
