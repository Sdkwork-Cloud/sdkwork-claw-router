...
This directory is the local standards index for `sdkwork-claw-router-admin-service-nodes`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-service-nodes` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-service-nodes` |
| Domain | `platform` |
| Capability | `router` |
