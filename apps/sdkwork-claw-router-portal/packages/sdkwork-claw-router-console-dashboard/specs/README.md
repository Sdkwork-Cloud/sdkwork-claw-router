...
This directory is the local standards index for `sdkwork-claw-router-console-dashboard`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-dashboard` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-dashboard` |
| Domain | `platform` |
| Capability | `router` |
