...
This directory is the local standards index for `sdkwork-claw-router-console-api-keys`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-api-keys` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-api-keys` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-console-api-keys typecheck`
