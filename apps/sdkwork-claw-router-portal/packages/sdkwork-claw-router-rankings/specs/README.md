...
This directory is the local standards index for `sdkwork-claw-router-rankings`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-rankings` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-rankings` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-rankings typecheck`
