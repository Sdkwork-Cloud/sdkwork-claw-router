...
This directory is the local standards index for `sdkwork-claw-router-admin-agents`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-agents` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-agents` |
| Domain | `intelligence` |
| Capability | `agent` |
...
- `pnpm --filter sdkwork-claw-router-admin-agents typecheck`
