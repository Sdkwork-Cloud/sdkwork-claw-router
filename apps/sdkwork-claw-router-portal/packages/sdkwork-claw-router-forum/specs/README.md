...
This directory is the local standards index for `sdkwork-claw-router-forum`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-forum` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-forum` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-forum typecheck`
