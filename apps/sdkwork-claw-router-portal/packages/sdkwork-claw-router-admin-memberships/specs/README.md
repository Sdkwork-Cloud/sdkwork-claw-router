# SDKWork Claw Router Admin Memberships Component Specs

This directory is the local standards index for `sdkwork-claw-router-admin-memberships`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-memberships` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-memberships` |
| Domain | `platform` |
| Capability | `router` |
