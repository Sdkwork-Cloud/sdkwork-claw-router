...
This directory is the local standards index for `sdkwork-claw-router-admin-wallet`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-wallet` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-wallet` |
| Domain | `commerce` |
| Capability | `wallet` |
