...
This directory is the local standards index for `sdkwork-claw-router-admin-dashboard`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-dashboard` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-dashboard` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-admin-dashboard typecheck`
