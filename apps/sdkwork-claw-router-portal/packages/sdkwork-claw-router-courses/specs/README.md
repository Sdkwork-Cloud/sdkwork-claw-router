...
This directory is the local standards index for `sdkwork-claw-router-courses`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-courses` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-courses` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-courses typecheck`
