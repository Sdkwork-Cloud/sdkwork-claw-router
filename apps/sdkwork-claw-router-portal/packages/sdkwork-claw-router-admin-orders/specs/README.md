...
This directory is the local standards index for `sdkwork-claw-router-admin-orders`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-orders` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-orders` |
| Domain | `commerce` |
| Capability | `order` |
