...
This directory is the local standards index for `sdkwork-claw-router-console-wallet`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-console-wallet` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-console-wallet` |
| Domain | `commerce` |
| Capability | `wallet` |
