...
This directory is the local standards index for `sdkwork-claw-router-admin-wechat-official-account`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-admin-wechat-official-account` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-admin-wechat-official-account` |
