...
This directory is the local standards index for `sdkwork-claw-router-models`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-models` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-models` |
| Domain | `intelligence` |
| Capability | `model` |
...
- `pnpm --filter sdkwork-claw-router-models typecheck`
