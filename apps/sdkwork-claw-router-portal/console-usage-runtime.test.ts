...
const simplifiedConsolePageFiles = [
  "./packages/sdkwork-claw-router-console-dashboard/src/DashboardView.tsx",
  "./packages/sdkwork-claw-router-console-usage/src/UsageView.tsx",
  "./packages/sdkwork-claw-router-console-gateway/src/GatewayView.tsx",
  "./packages/sdkwork-claw-router-console-api-keys/src/ApiKeysView.tsx",
  "./packages/sdkwork-claw-router-console-user/src/UserView.tsx",
  ...
  "./packages/sdkwork-claw-router-console-settings/src/SettingsView.tsx",
  "./packages/sdkwork-claw-router-console-messages/src/MessagesView.tsx",
];

const removedConsolePageTitlePatterns = [
  {
    file: "./packages/sdkwork-claw-router-console-account/src/AccountView.tsx",
    pattern: /<h1[^>]*>\s*\{t\("console\.account\.accountview\.text\.jkt39d"/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-checkout/src/CheckoutView.tsx",
    pattern: /<h1[^>]*>\s*\{t\("console\.billing\.checkoutview\.text\.cxkxif"/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-gateway/src/GatewayView.tsx",
    pattern: /<h1[^>]*>\s*\{t\('console\.gateway\.title'/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-memberships/src/MembershipsView.tsx",
    pattern: /<h1[^>]*>\s*\{t\('console\.memberships\.title'/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-messages/src/MessagesView.tsx",
    pattern: /<h1[^>]*>\s*<Bell[^>]*>\s*\{t\('console\.messages\.title'/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-settlements/src/SettlementsView.tsx",
    pattern: /<h1[^>]*>\s*\{t\('console\.menu\.settlements'/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-settings/src/SettingsView.tsx",
    pattern: /<h1[^>]*>\s*\{t\("console\.settings\.settingsview\.text\.18giiv0"/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-usage/src/UsageView.tsx",
    pattern: /<h1[^>]*>\s*\{t\('console\.usage\.title'/,
  },
  {
    file: "./packages/sdkwork-claw-router-console-user/src/UserView.tsx",
...
test("console usage logs i18n resources include English and Chinese entries", () => {
  const resourceIndex = readPortalFile("./packages/sdkwork-claw-router-i18n/src/resources/index.ts");
  const source = readPortalFile("./packages/sdkwork-claw-router-i18n/src/resources/console/usage.ts");
...
test("console settlement page keeps menu copy in navigation without page title chrome", () => {
  ...
  const coreMessages = readPortalFile("./packages/sdkwork-claw-router-i18n/src/resources/console/core.ts");
...
test("console settings center constrains the settings panel to the available viewport height", () => {
  const source = readPortalFile("./packages/sdkwork-claw-router-console-settings/src/SettingsView.tsx");
...
test("console appearance preferences support system mode and theme colors", () => {
  const settingsSource = readPortalFile("./packages/sdkwork-claw-router-console-settings/src/SettingsView.tsx");
...
test("admin user management keeps search on the left and the primary action on the right", () => {
  const source = readPortalFile("./packages/sdkwork-claw-router-admin-user/src/index.tsx");
...
test("console API key management keeps search on the left and create action on the right", () => {
  const source = readPortalFile("./packages/sdkwork-claw-router-console-api-keys/src/ApiKeysView.tsx");
