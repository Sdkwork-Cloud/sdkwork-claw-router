# SDKWork Claw Router Portal Component Specs

This directory is the local standards index for `sdkwork-claw-router-portal`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-router-portal` |
| Type | `react-app` |
| Root | `sdkwork-claw-router/apps/sdkwork-claw-router-portal` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-claw-router-portal typecheck`
