...
const { ModelDetails } = require('./packages/sdkwork-claw-router-models/src/pages/ModelDetails.tsx');
const { Models } = require('./packages/sdkwork-claw-router-models/src/pages/Models.tsx');
