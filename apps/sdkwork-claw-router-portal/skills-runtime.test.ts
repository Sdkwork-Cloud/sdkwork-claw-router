...
} from "./packages/sdkwork-claw-router-skills-hub/src/skillRuntime.ts";
import { skillService } from "./packages/sdkwork-claw-router-skills-hub/src/services/skillService.ts";
...
test("skills hub page exposes installed skill state through generated app SDK data", () => {
  const source = readFileSync(
    new URL("./packages/sdkwork-claw-router-skills-hub/src/pages/SkillsHub.tsx", import.meta.url),
    "utf8",
  );
