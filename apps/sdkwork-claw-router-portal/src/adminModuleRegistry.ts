...
export const ADMIN_MODULES: AdminModuleDef[] = [
  ...
  moduleBlock({
    id: 'courseCenter',
    nameKey: 'admin.header.courseCenter',
    icon: GraduationCap,
    defaultPath: '/admin/courses/dashboard',
    pathPrefixes: ['/admin/courses'],
  }),
  moduleBlock({
    id: 'productCenter',
...
export const ADMIN_MODULE_MENUS: AdminModuleMenu[] = [
  ...
  {
    moduleId: 'courseCenter',
    groups: [
      groupBlock('admin.menu.courseCenter.overview', [
        itemBlock({ path: '/admin/courses/dashboard', labelKey: 'admin.menu.courseDashboard', icon: LayoutDashboard, iconColor: 'text-blue-500' }),
      ]),
      groupBlock('admin.menu.courseCenter.assets', [
        itemBlock({ path: '/admin/courses/catalog', labelKey: 'admin.menu.courseCatalog', icon: GraduationCap, iconColor: 'text-indigo-500' }),
        itemBlock({ path: '/admin/courses/sections', labelKey: 'admin.menu.courseSections', icon: Layers, iconColor: 'text-cyan-500' }),
        itemBlock({ path: '/admin/courses/lessons', labelKey: 'admin.menu.courseLessons', icon: PlaySquare, iconColor: 'text-emerald-500' }),
      ]),
      groupBlock('admin.menu.courseCenter.distribution', [
        itemBlock({ path: '/admin/courses/relations', labelKey: 'admin.menu.courseRelations', icon: Link2, iconColor: 'text-violet-500' }),
        itemBlock({ path: '/admin/courses/engagement', labelKey: 'admin.menu.courseEngagement', icon: BarChart3, iconColor: 'text-amber-500' }),
      ]),
      groupBlock('admin.menu.courseCenter.governance', [
        itemBlock({ path: '/admin/courses/applications', labelKey: 'admin.menu.courseApplications', icon: ClipboardList, iconColor: 'text-teal-500' }),
        itemBlock({ path: '/admin/courses/comments', labelKey: 'admin.menu.courseComments', icon: MessageCircle, iconColor: 'text-pink-500' }),
      ]),
    ],
  },
  {
