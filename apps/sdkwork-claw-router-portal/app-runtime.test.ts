...
} from "./packages/sdkwork-claw-router-app-center/src/appRuntime.ts";
import { appService } from "./packages/sdkwork-claw-router-app-center/src/services/appService.ts";
...
test("app detail page wires visible share control to canonical copy behavior", () => {
  const source = readFileSync(
    new URL("./packages/sdkwork-claw-router-app-center/src/pages/AppDetails.tsx", import.meta.url),
    "utf8",
  );
