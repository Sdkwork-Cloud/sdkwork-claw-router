...
SDKWork Claw Router Portal is the browser console for the Claw Router product. It is served by the Rust edge server in unified mode and keeps frontend business calls behind the portal service layer, generated SDKs, and Rust API services.
...
```powershell
pnpm.cmd --dir apps/sdkwork-claw-router-portal install
```
