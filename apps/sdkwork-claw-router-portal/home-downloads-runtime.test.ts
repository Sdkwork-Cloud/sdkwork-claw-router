...
} from "./packages/sdkwork-claw-router-home/src/downloads/clawRouterDownloads.ts";
...
test("home page mounts download components in both hero and deploy sections", () => {
  const homeSource = readFileSync(
    new URL("./packages/sdkwork-claw-router-home/src/pages/Home.tsx", import.meta.url),
    "utf8",
  );
  const heroSource = readFileSync(
    new URL("./packages/sdkwork-claw-router-home/src/components/Hero.tsx", import.meta.url),
    "utf8",
  );
  const downloadSectionSource = readFileSync(
    new URL("./packages/sdkwork-claw-router-home/src/components/DownloadSection.tsx", import.meta.url),
    "utf8",
  );
...
test("home bottom download panel also uses the shared flat borderless component", () => {
  const downloadSectionSource = readPortalSource("./packages/sdkwork-claw-router-home/src/components/DownloadSection.tsx");
