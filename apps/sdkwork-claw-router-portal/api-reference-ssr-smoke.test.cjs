...
function installSsrRequireHooks() {
  ...
  const shims = new Map([
    ...
    ['sdkwork-claw-router-commons', createCommonsShim()],
  ]);
...
const { ApiPlayground } = require('./packages/sdkwork-claw-router-api-reference/src/components/ApiPlayground.tsx');
const { ApiPlaygroundParamsTable } = require('./packages/sdkwork-claw-router-api-reference/src/components/ApiPlaygroundParamsTable.tsx');
const { createApiPlaygroundInitialState } = require('./packages/sdkwork-claw-router-api-reference/src/apiPlaygroundRows.ts');
