...
import {
  ...
  type ForumPost,
} from "./packages/sdkwork-clawrouter-pc-forum/src/forumCatalog.ts";
import { forumService } from "./packages/sdkwork-clawrouter-pc-forum/src/forumService.ts";
...
test("forum pages use the service boundary instead of raw app HTTP calls", () => {
  const serviceSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-forum/src/forumService.ts", import.meta.url),
    "utf8",
  );
  const forumViewSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-forum/src/components/ForumView.tsx", import.meta.url),
    "utf8",
  );
  const postViewSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-forum/src/components/ForumPostView.tsx", import.meta.url),
    "utf8",
  );
...
test("forum runtime pages do not use curated static data as live fallback", () => {
  const catalogSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-forum/src/forumCatalog.ts", import.meta.url),
    "utf8",
  );
  const forumViewSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-forum/src/components/ForumView.tsx", import.meta.url),
