...
import { AdminAgentService } from "./packages/sdkwork-clawrouter-pc-admin-agents/src/agentService.ts";

const adminAgentsSourcePath = new URL(
  "./packages/sdkwork-clawrouter-pc-admin-agents/src/index.tsx",
  import.meta.url,
);
...
const adminAgentsI18nSourcePath = new URL(
  "./packages/sdkwork-clawrouter-pc-i18n/src/resources/admin/agents.ts",
  import.meta.url,
);
const adminSkillI18nSourcePath = new URL(
  "./packages/sdkwork-clawrouter-pc-i18n/src/resources/admin/skill.ts",
  import.meta.url,
);
