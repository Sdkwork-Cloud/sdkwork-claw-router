...
import { createApiKeyInputFromForm, createApiKeyInputsFromForm } from "./packages/sdkwork-clawrouter-pc-console-api-keys/src/apiKeyForm.ts";
import { ApiKeyService } from "./packages/sdkwork-clawrouter-pc-console-api-keys/src/apiKeyService.ts";
import { DashboardService } from "./packages/sdkwork-clawrouter-pc-console-dashboard/src/dashboardService.ts";
import { SettingsService } from "./packages/sdkwork-clawrouter-pc-console-settings/src/settingsService.ts";
import {
  buildSettlementDisplayData,
  buildSettlementSummary,
  buildSettlementYearOptions,
  getDefaultSettlementYear,
} from "./packages/sdkwork-clawrouter-pc-console-settlements/src/settlementViewModel.ts";
import { UsageService } from "./packages/sdkwork-clawrouter-pc-console-usage/src/usageService.ts";
...
function readConsoleDashboardSource(): string {
  return readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-console-dashboard/src/DashboardView.tsx", import.meta.url),
    "utf8",
  );
}
