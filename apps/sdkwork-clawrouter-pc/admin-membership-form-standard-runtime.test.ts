...
test("admin membership drawer forms share standardized form controls", () => {
  const controlsSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/components/MembershipFormControls.tsx");
  const formFiles = [
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipMemberStatusDrawerForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipPackageDrawerForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipPackageGroupDrawerForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipPlanDrawerForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipRechargePackageDrawerForm.tsx",
  ];
...
test("admin membership package group form generates code on create and uses billing cycle options", () => {
  const groupFormSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipPackageGroupDrawerForm.tsx");
...
test("admin membership package form generates code and uses select-backed fixed options", () => {
  const packageFormSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipPackageDrawerForm.tsx");
...
test("admin membership plan form generates code on create", () => {
  const planFormSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/forms/MembershipPlanDrawerForm.tsx");
