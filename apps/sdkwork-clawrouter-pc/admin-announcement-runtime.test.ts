...
} from "./packages/sdkwork-clawrouter-pc-admin-announcement/src/announcementForm.ts";
import { AnnouncementService } from "./packages/sdkwork-clawrouter-pc-admin-announcement/src/announcementService.ts";
...
test("admin announcement page localizes page copy, form placeholders, and modal text", () => {
  const pageSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-announcement/src/index.tsx");
  const announcementI18nSource = readPortalFile("./packages/sdkwork-clawrouter-pc-i18n/src/resources/admin/announcement.ts");
  const commonI18nSource = readPortalFile("./packages/sdkwork-clawrouter-pc-i18n/src/resources/shared/common.ts");
