...
import type { ClawRouterAppSdkClient } from "./packages/sdkwork-clawrouter-pc-commons/src/sdk-clients.ts";
import {
  COURSE_CATALOG,
...
} from "./packages/sdkwork-clawrouter-pc-courses/src/courseCatalog.ts";
import {
...
} from "./packages/sdkwork-clawrouter-pc-courses/src/courseService.ts";
...
test("courses page requires login before opening course application actions", () => {
  const coursesViewSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-courses/src/components/CoursesView.tsx", import.meta.url),
    "utf8",
  );
  const courseDetailSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-courses/src/components/CourseDetailView.tsx", import.meta.url),
    "utf8",
  );
  const courseInfoSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-courses/src/components/course-detail/CourseInfo.tsx", import.meta.url),
    "utf8",
  );
  const dialogSource = readFileSync(
    new URL("./packages/sdkwork-clawrouter-pc-courses/src/components/CourseApplicationDialog.tsx", import.meta.url),
    "utf8",
  );
