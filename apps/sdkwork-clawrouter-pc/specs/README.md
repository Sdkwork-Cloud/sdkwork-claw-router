# SDKWork ClawRouter PC Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc` |
| Type | `react-app` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc` |
| Domain | `platform` |
| Capability | `router` |
