...
test("admin file platform is composed from storage and drive module blocks", () => {
  ...
  const fileAdminIndexSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-file-platform/src/index.tsx");
  const storageAdminSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-file-platform/src/storageAdmin.tsx");
  const storageDefinitionsSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-file-platform/src/storageSectionDefinitions.ts");
  const storageServiceSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-file-platform/src/storageService.ts");
  const storageShellSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-file-platform/src/components/StoragePageShell.tsx");
  const storagePageSource = [
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/pages/ProvidersPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/pages/BucketsPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/pages/DefaultBucketsPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/pages/QuotasPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/pages/UsagePage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/pages/ReconciliationPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/pages/GarbageCollectionPage.tsx",
  ].map(readPortalFile).join("\n");
  const storageFormSource = [
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/forms/StorageProviderForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/forms/StorageBucketForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/forms/DefaultBucketPolicyForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/forms/QuotaPolicyForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/forms/StorageReconciliationForm.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-file-platform/src/forms/StorageGarbageCollectionForm.tsx",
  ].map(readPortalFile).join("\n");
  const fileAdminPackage = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-file-platform/package.json");
  ...
  assert.match(appSource, /const StorageAdmin = lazyRoute<AdminSectionRouteProps>\(\(\) => import\('sdkwork-clawrouter-pc-admin-file-platform'\), 'StorageAdmin'\);/);
  assert.match(appSource, /const DriveAdmin = lazyRoute<AdminSectionRouteProps>\(\(\) => import\('sdkwork-clawrouter-pc-admin-file-platform'\), 'DriveAdmin'\);/);
  ...
  assert.match(fileAdminPackage, /"name":\s*"sdkwork-clawrouter-pc-admin-file-platform"/);
