...
test("admin membership pages share standardized table and action controls", () => {
  const controlsSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/components/MembershipPageControls.tsx");
  const shellSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/components/MembershipAdminPageShell.tsx");
  const entrySource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/index.tsx");
  const tablePages = [
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipPackagesPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipVipPackagesPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipPackageGroupsPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipPlansPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipMembersPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipEntitlementsPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipRechargePackagesPage.tsx",
  ];
  const mutationPages = [
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipPackagesPage.tsx",
    "./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipVipPackagesPage.tsx",
...
test("admin membership package sidebar exposes package group CRUD controls", () => {
  ...
  const dialogSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/components/MembershipDialog.tsx");
...
test("admin membership center exposes VIP package CRUD management", () => {
  ...
  const membershipsIndexSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/index.tsx");
  const vipPackagesPageSource = readPortalFile("./packages/sdkwork-clawrouter-pc-admin-memberships/src/pages/MembershipVipPackagesPage.tsx");
  const navigationMessagesSource = readPortalFile("./packages/sdkwork-clawrouter-pc-i18n/src/resources/admin/core-navigation.ts");
  const membershipMessagesSource = readPortalFile("./packages/sdkwork-clawrouter-pc-i18n/src/resources/admin-commerce/memberships.ts");
...
test("admin membership package groups are sort-weight ordered and movable", async () => {
  ...
  const membershipsService = await import("./packages/sdkwork-clawrouter-pc-admin-memberships/src/membershipsService.ts");
