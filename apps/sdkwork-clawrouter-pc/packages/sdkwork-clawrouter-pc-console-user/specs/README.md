# SDKWork Claw Router Console User Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-user`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-user` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter sdkwork-clawrouter-pc-console-user typecheck`
