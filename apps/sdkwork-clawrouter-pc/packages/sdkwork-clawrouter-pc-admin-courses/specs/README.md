# SDKWork Claw Router Admin Courses Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-courses`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-courses` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-courses` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-courses typecheck`
