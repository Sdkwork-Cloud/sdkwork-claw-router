# SDKWork Claw Router Forum Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-forum`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-forum` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-forum` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-forum typecheck`
