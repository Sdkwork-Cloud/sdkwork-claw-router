# SDKWork Claw Router Admin Prompts Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-prompts`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-prompts` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-prompts` |
| Domain | `intelligence` |
| Capability | `prompt` |
