# SDKWork Claw Router Admin Dashboard Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-dashboard`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-dashboard` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-dashboard` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-dashboard typecheck`
