# SDKWork Claw Router Admin Mcp Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-mcp`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-mcp` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-mcp` |
| Domain | `intelligence` |
| Capability | `mcp` |
