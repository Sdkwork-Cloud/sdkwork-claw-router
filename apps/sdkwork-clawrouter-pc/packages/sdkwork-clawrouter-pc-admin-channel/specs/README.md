# SDKWork Claw Router Admin Channel Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-channel`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-channel` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-channel` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-channel typecheck`
