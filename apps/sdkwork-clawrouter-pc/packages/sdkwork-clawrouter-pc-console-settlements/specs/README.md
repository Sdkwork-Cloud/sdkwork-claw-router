# SDKWork Claw Router Console Settlements Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-settlements`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-settlements` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-settlements` |
| Domain | `platform` |
| Capability | `router` |
