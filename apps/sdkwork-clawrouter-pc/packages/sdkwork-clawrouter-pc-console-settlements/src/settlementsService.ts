...
export async function appInvoicesList(params?: CommerceRequestParams) {
...
export async function appInvoicesCreate(body: CommerceRequestBody) {
  return getSdkworkCommerceService().invoices.create(body);
}

export async function appWalletLedgerEntriesList(params?: CommerceRequestParams) {
