# SDKWork Claw Router Console Core Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-core` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-core` |
| Domain | `platform` |
| Capability | `router` |
