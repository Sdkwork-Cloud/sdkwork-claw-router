...
import { getApiSystemDisplayName, type ApiCategorySidebarNode } from 'sdkwork-clawrouter-pc-api-reference/apiReferenceSchemaTabs';
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <main className="flex-1 min-w-0 flex flex-col">
          ...
          <div className="px-4 md:px-6 lg:px-8 py-8 md:py-12 pb-32">
            ...
            activeEndpoint && activeSdkConfig && (
              <SdkEndpointView
