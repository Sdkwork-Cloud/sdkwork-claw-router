...
import type { ClawRouterGeneratedSdkMetadata } from 'sdkwork-clawrouter-pc-commons/runtime';
...
const GITHUB_BASE_URL = 'https://github.com/sdkwork/claw-router/tree/main';
...
const OPEN_API_PACKAGES: LanguagePackageSet = {
  ts: SDK_SYSTEM_CONFIG['llm-open-api'].packageName,
  py: 'sdkwork-clawrouter-open-sdk',
  go: 'github.com/sdkwork/clawrouter-open-sdk',
  java: 'clawrouter-open-sdk-java',
  ruby: 'sdkwork-clawrouter-open-sdk',
  php: 'sdkwork/clawrouter-open-sdk-php',
  csharp: 'Sdkwork.ClawrouterOpenSdk',
...
const SYSTEM_CLASS_NAMES: Record<ApiSystem, string> = {
  'llm-open-api': SDK_SYSTEM_CONFIG['llm-open-api'].name,
  ...
  'app-api': SDK_SYSTEM_CONFIG['app-api'].name,
  'backend-api': SDK_SYSTEM_CONFIG['backend-api'].name,
};
...
const SYSTEM_EXAMPLES: Record<ApiSystem, LanguageExampleSet> = {
  ...
  'audio-open-api': exampleSet(
    ...
    voice: "alloy",
    input: "Welcome to SDKWork Claw Router.",
  });
  console.log(speech);`,
...
function packageSet(system: ApiSystem, stem: string, classStem: string): LanguagePackageSet {
  return {
    ts: SDK_SYSTEM_CONFIG[system].packageName,
    py: `sdkwork-clawrouter-${stem}-sdk`,
    go: `github.com/sdkwork/clawrouter-${stem}-sdk`,
    java: `clawrouter-${stem}-sdk-java`,
    ruby: `sdkwork-clawrouter-${stem}-sdk`,
    php: `sdkwork/clawrouter-${stem}-sdk-php`,
    csharp: `Sdkwork.Clawrouter${classStem}Sdk`,
    rust: `clawrouter-${stem}-sdk`,
    flutter: `clawrouter_${stem}_sdk`,
  };
}
