# SDKWork Claw Router SDK Reference Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-sdk-reference`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-sdk-reference` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-sdk-reference` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-sdk-reference typecheck`
