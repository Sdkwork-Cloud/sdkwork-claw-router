# SDKWork Claw Router Admin File Platform Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-file-platform`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-file-platform` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-file-platform` |
| Domain | `platform` |
| Capability | `router` |
