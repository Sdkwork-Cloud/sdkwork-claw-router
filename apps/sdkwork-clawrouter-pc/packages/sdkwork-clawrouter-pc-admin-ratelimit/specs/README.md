# SDKWork Claw Router Admin Ratelimit Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-ratelimit`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-ratelimit` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-ratelimit` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-ratelimit typecheck`
