# SDKWork Claw Router Console Memberships Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-memberships`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-memberships` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-memberships` |
| Domain | `platform` |
| Capability | `router` |
