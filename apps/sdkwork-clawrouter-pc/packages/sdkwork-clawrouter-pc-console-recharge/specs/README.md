# SDKWork Claw Router Console Recharge Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-recharge`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-recharge` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-recharge` |
| Domain | `platform` |
| Capability | `router` |
