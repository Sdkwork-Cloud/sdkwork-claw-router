...
This directory is the local standards index for `sdkwork-clawrouter-pc-admin-finance`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-finance` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-finance` |
| Domain | `platform` |
| Capability | `router` |
