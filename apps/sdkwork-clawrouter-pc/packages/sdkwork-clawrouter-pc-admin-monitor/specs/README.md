# SDKWork Claw Router Admin Monitor Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-monitor`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-monitor` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-monitor` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-monitor typecheck`
