# SDKWork Claw Router Console Usage Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-usage`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-usage` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-usage` |
| Domain | `platform` |
| Capability | `router` |
