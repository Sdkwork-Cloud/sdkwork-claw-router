# SDKWork Claw Router Admin User Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-user`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-user` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-user typecheck`
