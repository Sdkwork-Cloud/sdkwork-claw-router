# SDKWork Claw Router Vip Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-vip`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-vip` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-vip` |
| Domain | `commerce` |
| Capability | `vip` |
