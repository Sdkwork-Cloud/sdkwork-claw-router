# SDKWork Claw Router Console Account Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-account`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-account` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-account` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-console-account typecheck`
