...
This directory is the local standards index for `sdkwork-clawrouter-pc-admin-group`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-group` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-group` |
| Domain | `platform` |
| Capability | `router` |
