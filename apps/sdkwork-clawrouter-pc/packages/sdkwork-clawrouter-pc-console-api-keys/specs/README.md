# SDKWork Claw Router Console API Keys Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-api-keys`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-api-keys` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-api-keys` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-console-api-keys typecheck`
