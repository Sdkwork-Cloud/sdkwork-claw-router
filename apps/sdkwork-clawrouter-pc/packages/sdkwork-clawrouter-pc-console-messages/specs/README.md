# SDKWork Claw Router Console Messages Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-messages`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-messages` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-messages` |
| Domain | `platform` |
| Capability | `router` |
