# SDKWork Claw Router Admin Inventory Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-inventory`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-inventory` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-inventory` |
| Domain | `platform` |
| Capability | `router` |
