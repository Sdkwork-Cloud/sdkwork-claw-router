# SDKWork Claw Router Admin Wechat Official Account Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-wechat-official-account`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-wechat-official-account` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-wechat-official-account` |
