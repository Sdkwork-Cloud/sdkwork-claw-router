# SDKWork Claw Router Console Settings Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-settings`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-settings` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-settings` |
| Domain | `platform` |
| Capability | `router` |
