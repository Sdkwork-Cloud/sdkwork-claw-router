...
This directory is the local standards index for `sdkwork-clawrouter-pc-playground`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-playground` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-playground` |
| Domain | `platform` |
| Capability | `router` |
