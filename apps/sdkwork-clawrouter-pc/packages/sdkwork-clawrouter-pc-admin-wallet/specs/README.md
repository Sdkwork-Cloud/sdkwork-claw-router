# SDKWork Claw Router Admin Wallet Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-wallet`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-wallet` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-wallet` |
| Domain | `commerce` |
| Capability | `wallet` |
