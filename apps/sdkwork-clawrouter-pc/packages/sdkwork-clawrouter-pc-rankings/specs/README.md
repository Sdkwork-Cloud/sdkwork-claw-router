# SDKWork Claw Router Rankings Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-rankings`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-rankings` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-rankings` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-rankings typecheck`
