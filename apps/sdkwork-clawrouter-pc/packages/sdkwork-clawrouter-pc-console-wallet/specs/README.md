# SDKWork Claw Router Console Wallet Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-wallet`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-wallet` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-wallet` |
| Domain | `commerce` |
| Capability | `wallet` |
