# SDKWork Claw Router Commons Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-commons`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-commons` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-commons` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-commons typecheck`
