# SDKWork Claw Router Admin Skill Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-skill`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-skill` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-skill` |
| Domain | `intelligence` |
| Capability | `skill` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-skill typecheck`
