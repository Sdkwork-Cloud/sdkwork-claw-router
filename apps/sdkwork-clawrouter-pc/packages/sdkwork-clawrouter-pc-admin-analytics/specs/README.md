# SDKWork Claw Router Admin Analytics Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-analytics`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-analytics` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-analytics` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-analytics typecheck`
