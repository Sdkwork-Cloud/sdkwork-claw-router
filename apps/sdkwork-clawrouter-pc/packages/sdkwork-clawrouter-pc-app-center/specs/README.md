# SDKWork Claw Router App Center Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-app-center`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-app-center` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-app-center` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-app-center typecheck`
