# SDKWork Claw Router Skills Hub Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-skills-hub`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-skills-hub` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-skills-hub` |
| Domain | `intelligence` |
| Capability | `skill` |
...
- `pnpm --filter sdkwork-clawrouter-pc-skills-hub typecheck`
