# SDKWork Claw Router Admin Open Platform Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-open-platform`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-open-platform` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-open-platform` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-open-platform typecheck`
