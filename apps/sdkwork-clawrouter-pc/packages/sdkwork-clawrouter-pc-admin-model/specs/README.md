# SDKWork Claw Router Admin Model Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-model`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-model` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-model` |
| Domain | `intelligence` |
| Capability | `model` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-model typecheck`
