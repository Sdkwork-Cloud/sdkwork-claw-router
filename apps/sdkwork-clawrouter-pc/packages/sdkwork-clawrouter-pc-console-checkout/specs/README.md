# SDKWork Claw Router Console Checkout Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-checkout`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-checkout` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-checkout` |
| Domain | `commerce` |
| Capability | `router` |
