# SDKWork Claw Router Admin Record Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-record`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-record` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-record` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-record typecheck`
