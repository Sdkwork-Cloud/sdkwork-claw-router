# SDKWork Claw Router Admin Wechat Mini Program Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-wechat-mini-program`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-wechat-mini-program` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-wechat-mini-program` |
