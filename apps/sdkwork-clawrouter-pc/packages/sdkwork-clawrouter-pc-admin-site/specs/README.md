...
This directory is the local standards index for `sdkwork-clawrouter-pc-admin-site`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-site` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-site` |
| Domain | `platform` |
| Capability | `router` |
