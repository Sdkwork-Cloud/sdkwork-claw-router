# SDKWork Claw Router API Reference Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-api-reference`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-api-reference` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-api-reference` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-api-reference typecheck`
