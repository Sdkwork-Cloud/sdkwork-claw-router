# SDKWork Claw Router Admin Orders Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-orders`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-orders` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-orders` |
| Domain | `commerce` |
| Capability | `order` |
