# SDKWork Claw Router Admin Service Provider Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-service-provider`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-service-provider` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-service-provider` |
| Domain | `platform` |
| Capability | `router` |
