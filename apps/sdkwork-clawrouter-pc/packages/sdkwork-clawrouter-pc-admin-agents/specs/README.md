# SDKWork Claw Router Admin Agents Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-agents`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-agents` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-agents` |
| Domain | `intelligence` |
| Capability | `agent` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-agents typecheck`
