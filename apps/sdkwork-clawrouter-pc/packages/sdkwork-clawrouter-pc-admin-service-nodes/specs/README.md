# SDKWork Claw Router Admin Service Nodes Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-service-nodes`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-service-nodes` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-service-nodes` |
| Domain | `platform` |
| Capability | `router` |
