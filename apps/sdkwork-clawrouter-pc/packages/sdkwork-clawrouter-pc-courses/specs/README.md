# SDKWork Claw Router Courses Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-courses`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-courses` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-courses` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-courses typecheck`
