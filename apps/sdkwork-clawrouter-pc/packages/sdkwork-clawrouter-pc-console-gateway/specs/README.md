# SDKWork Claw Router Console Gateway Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-console-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-console-gateway` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-console-gateway` |
| Domain | `platform` |
| Capability | `router` |
