# SDKWork Claw Router Admin Messaging Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-messaging`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-messaging` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-messaging` |
| Domain | `platform` |
| Capability | `router` |
