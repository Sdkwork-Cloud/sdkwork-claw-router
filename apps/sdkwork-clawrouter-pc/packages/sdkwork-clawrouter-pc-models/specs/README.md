# SDKWork Claw Router Models Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-models`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-models` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-models` |
| Domain | `intelligence` |
| Capability | `model` |
...
- `pnpm --filter sdkwork-clawrouter-pc-models typecheck`
