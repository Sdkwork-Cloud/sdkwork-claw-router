# SDKWork Claw Router Admin Cache Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-cache`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-cache` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-cache` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-cache typecheck`
