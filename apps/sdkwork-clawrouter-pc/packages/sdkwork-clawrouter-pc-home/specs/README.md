# SDKWork Claw Router Home Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-home`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-home` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-home` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-home typecheck`
