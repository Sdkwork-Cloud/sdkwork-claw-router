# SDKWork Claw Router Admin Announcement Component Specs

This directory is the local standards index for `sdkwork-clawrouter-pc-admin-announcement`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-admin-announcement` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-admin-announcement` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-clawrouter-pc-admin-announcement typecheck`
