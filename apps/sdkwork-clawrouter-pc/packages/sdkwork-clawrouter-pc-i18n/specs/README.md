...
This directory is the local standards index for `sdkwork-clawrouter-pc-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-pc-i18n` |
| Type | `node-package` |
| Root | `sdkwork-claw-router/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawrouter-pc-i18n` |
| Domain | `platform` |
| Capability | `router` |
