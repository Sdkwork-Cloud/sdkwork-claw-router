-- Claw-router owned baseline generated from Schema Registry.
-- source: generated/schema/postgres/schema.sql
-- Regenerate: PYTHONPATH=. python -B -m tools.schema_compiler
