...
class RankingsRuntimeStandardTest(unittest.TestCase):
    ...
    def test_rankings_page_uses_testable_snapshot_catalog_module(self) -> None:
        ...
        runtime_test_path = ROOT / "apps" / "sdkwork-claw-router-portal" / "rankings-runtime.test.ts"
        ...
        self.assertIn("apps/sdkwork-claw-router-portal/rankings-runtime.test.ts", verifier_source)
    ...
    def test_rankings_route_classification_declares_sdk_backed_snapshot_delivery(self) -> None:
        ...
        self.assertIn(
            "apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-rankings/src/rankingCatalog.ts",
            route["evidence"],
        )
        self.assertIn(
            "apps/sdkwork-claw-router-portal/packages/sdkwork-claw-router-rankings/src/rankingService.ts",
            route["evidence"],
        )
